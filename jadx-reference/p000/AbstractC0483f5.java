...
public abstract class AbstractC0483f5 implements InterfaceC0910ne {

    /* renamed from: a0 */
    public final InterfaceC0911nf f56150a0;

    public AbstractC0483f5(InterfaceC0911nf interfaceC0911nf) {
        this.f56150a0 = interfaceC0911nf;
    }
    ...
    @Override // p000.InterfaceC0912ng
    /* renamed from: b4 */
    public InterfaceC0910ne mo212745b4(InterfaceC0911nf interfaceC0911nf) {
        t60.m214695b6(interfaceC0911nf, "key");
        if (t60.m214686a2(getKey(), interfaceC0911nf)) {
            return this;
        }
        return null;
    }
