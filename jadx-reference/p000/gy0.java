...
public class gy0 extends AbstractC1330va.a0 {

    /* renamed from: x */
    protected long[] f56590x;

    public gy0() {
        this.f56590x = sh0.create64();
    }

    @Override // p000.AbstractC1330va
    public AbstractC1330va add(AbstractC1330va abstractC1330va) {
        long[] jArrCreate64 = sh0.create64();
        fy0.add(this.f56590x, ((gy0) abstractC1330va).f56590x, jArrCreate64);
        return new gy0(jArrCreate64);
    }

    @Override // p000.AbstractC1330va
    public AbstractC1330va addOne() {
        long[] jArrCreate64 = sh0.create64();
        fy0.addOne(this.f56590x, jArrCreate64);
        return new gy0(jArrCreate64);
    }
    ...
    public boolean equals(Object obj) {
        ...
        if (obj instanceof gy0) {
            return sh0.eq64(this.f56590x, ((gy0) obj).f56590x);
        }
        return false;
    }
    ...
    public AbstractC1330va halfTrace() {
        long[] jArrCreate64 = sh0.create64();
        fy0.halfTrace(this.f56590x, jArrCreate64);
        return new gy0(jArrCreate64);
    }
    ...
    public int hashCode() {
        return C0133bg.hashCode(this.f56590x, 0, 4) ^ 2330074;
    }

    @Override // p000.AbstractC1330va
    public AbstractC1330va invert() {
        long[] jArrCreate64 = sh0.create64();
        fy0.invert(this.f56590x, jArrCreate64);
        return new gy0(jArrCreate64);
    }

    @Override // p000.AbstractC1330va
    public boolean isOne() {
        return sh0.isOne64(this.f56590x);
    }

    @Override // p000.AbstractC1330va
    public boolean isZero() {
        return sh0.isZero64(this.f56590x);
    }

    @Override // p000.AbstractC1330va
    public AbstractC1330va multiply(AbstractC1330va abstractC1330va) {
        long[] jArrCreate64 = sh0.create64();
        fy0.multiply(this.f56590x, ((gy0) abstractC1330va).f56590x, jArrCreate64);
        return new gy0(jArrCreate64);
    }
    ...
    public AbstractC1330va multiplyPlusProduct(AbstractC1330va abstractC1330va, AbstractC1330va abstractC1330va2, AbstractC1330va abstractC1330va3) {
        long[] jArr = this.f56590x;
        long[] jArr2 = ((gy0) abstractC1330va).f56590x;
        long[] jArr3 = ((gy0) abstractC1330va2).f56590x;
        long[] jArr4 = ((gy0) abstractC1330va3).f56590x;
        long[] jArrCreateExt64 = sh0.createExt64();
        fy0.multiplyAddToExt(jArr, jArr2, jArrCreateExt64);
        fy0.multiplyAddToExt(jArr3, jArr4, jArrCreateExt64);
        long[] jArrCreate64 = sh0.create64();
        fy0.reduce(jArrCreateExt64, jArrCreate64);
        return new gy0(jArrCreate64);
    }
    ...
    public AbstractC1330va sqrt() {
        long[] jArrCreate64 = sh0.create64();
        fy0.sqrt(this.f56590x, jArrCreate64);
        return new gy0(jArrCreate64);
    }
    ...
    public AbstractC1330va square() {
        long[] jArrCreate64 = sh0.create64();
        fy0.square(this.f56590x, jArrCreate64);
        return new gy0(jArrCreate64);
    }
    ...
    public AbstractC1330va squarePlusProduct(AbstractC1330va abstractC1330va, AbstractC1330va abstractC1330va2) {
        ...
        long[] jArr3 = ((gy0) abstractC1330va2).f56590x;
        long[] jArrCreateExt64 = sh0.createExt64();
        fy0.squareAddToExt(jArr, jArrCreateExt64);
        fy0.multiplyAddToExt(jArr2, jArr3, jArrCreateExt64);
        long[] jArrCreate64 = sh0.create64();
        fy0.reduce(jArrCreateExt64, jArrCreate64);
        return new gy0(jArrCreate64);
    }
    ...
    public AbstractC1330va squarePow(int i) {
        ...
        long[] jArrCreate64 = sh0.create64();
        fy0.squareN(this.f56590x, i, jArrCreate64);
        return new gy0(jArrCreate64);
    }
    ...
    public boolean testBitZero() {
        return (this.f56590x[0] & 1) != 0;
    }

    @Override // p000.AbstractC1330va
    public BigInteger toBigInteger() {
        return sh0.toBigInteger64(this.f56590x);
    }

    @Override // p000.AbstractC1330va.a0
    public int trace() {
        return fy0.trace(this.f56590x);
    }
    ...
    public gy0(BigInteger bigInteger) {
        ...
        this.f56590x = fy0.fromBigInteger(bigInteger);
    }

    public gy0(long[] jArr) {
        this.f56590x = jArr;
    }
