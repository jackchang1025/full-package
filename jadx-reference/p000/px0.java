...
public class px0 extends AbstractC1316ux.a1 {
    private static final AbstractC1330va[] SECT131R2_AFFINE_ZS = {new mx0(InterfaceC1315uw.ONE)};
    private static final int SECT131R2_DEFAULT_COORDS = 6;
    protected qx0 infinity;

    /* renamed from: px0$a0 */
    public class C1088a0 extends AbstractC0484f6 {
        final /* synthetic */ int val$len;
        final /* synthetic */ long[] val$table;

        public C1088a0(int i, long[] jArr) {
            this.val$len = i;
            this.val$table = jArr;
        }

        private AbstractC1341vl createPoint(long[] jArr, long[] jArr2) {
            return px0.this.createRawPoint(new mx0(jArr), new mx0(jArr2), px0.SECT131R2_AFFINE_ZS);
        }
    ...
    public px0() {
        super(131, 2, 3, 8);
        this.infinity = new qx0(this, null, null);
        this.f60524a = fromBigInteger(new BigInteger(1, c40.decodeStrict("03E5A88919D7CAFCBF415F07C2176573B2")));
        this.f60525b = fromBigInteger(new BigInteger(1, c40.decodeStrict("04B8266A46C55657AC734CE38F018F2192")));
        this.order = new BigInteger(1, c40.decodeStrict("0400000000000000016954A233049BA98F"));
    ...
    public AbstractC1341vl createRawPoint(AbstractC1330va abstractC1330va, AbstractC1330va abstractC1330va2, AbstractC1330va[] abstractC1330vaArr) {
        return new qx0(this, abstractC1330va, abstractC1330va2, abstractC1330vaArr);
    }
}
