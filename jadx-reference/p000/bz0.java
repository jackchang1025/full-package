...
public class bz0 {
    ...
    public static long[] fromBigInteger(BigInteger bigInteger) {
        return yh0.fromBigInteger64(571, bigInteger);
    }

    public static void halfTrace(long[] jArr, long[] jArr2) {
        long[] jArrCreateExt64 = xh0.createExt64();
        xh0.copy64(jArr, jArr2);
    ...
    public static void implMultiplyPrecomp(long[] jArr, long[] jArr2, long[] jArr3) {
        for (int i = 56; i >= 0; i -= 8) {
            ...
            yh0.shiftUpBits64(16, jArr3, 0, 8, 0L);
        }
        for (int i4 = 56; i4 >= 0; i4 -= 8) {
            ...
            if (i4 > 0) {
                yh0.shiftUpBits64(18, jArr3, 0, 8, 0L);
            }
        }
    }
    ...
    public static void implSquare(long[] jArr, long[] jArr2) {
        r60.expand64To128(jArr, 0, 9, jArr2, 0);
    }

    public static void invert(long[] jArr, long[] jArr2) {
        if (xh0.isZero64(jArr)) {
    ...
    public static long[] precompMultiplicand(long[] jArr) {
        ...
        while (i > 0) {
            int i3 = i2 + 18;
            yh0.shiftUpBit64(9, jArr2, i3 >>> 1, 0L, jArr2, i3);
            reduce5(jArr2, i3);
            long[] jArr3 = jArr2;
        ...
        yh0.shiftUpBits64(144, jArr2, 0, 4, 0L, jArr2, 144);
        return jArr2;
    }
    ...
    public static void sqrt(long[] jArr, long[] jArr2) {
        ...
        for (int i2 = 0; i2 < 4; i2++) {
            int i3 = i + 1;
            long jUnshuffle = r60.unshuffle(jArr[i]);
            i += 2;
            long jUnshuffle2 = r60.unshuffle(jArr[i3]);
            jArrCreate64[i2] = (4294967295L & jUnshuffle) | (jUnshuffle2 << 32);
            jArrCreate642[i2] = (jUnshuffle >>> 32) | ((-4294967296L) & jUnshuffle2);
        }
        long jUnshuffle3 = r60.unshuffle(jArr[i]);
