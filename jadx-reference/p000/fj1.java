...
public class fj1 {
    ...
    /* renamed from: fj1$a0 */
    public static class C0498a0 extends ObjectInputStream {
        ...
        public C0498a0(Class cls, InputStream inputStream) throws IOException {
            super(inputStream);
            this.found = false;
            this.mainClass = cls;
        }
    ...
    public static boolean areEqual(byte[][] bArr, byte[][] bArr2) {
        ...
        for (int i = 0; i < bArr.length; i++) {
            if (!C0133bg.areEqual(bArr[i], bArr2[i])) {
                return false;
            }
        }
        return true;
    ...
    public static Object deserialize(byte[] bArr, Class cls) throws ClassNotFoundException, IOException {
        C0498a0 c0498a0 = new C0498a0(cls, new ByteArrayInputStream(bArr));
        Object object = c0498a0.readObject();
        if (c0498a0.available() != 0) {
    ...
    public static void dumpByteArray(byte[][] bArr) {
        ...
        for (byte[] bArr2 : bArr) {
            System.out.println(c40.toHexString(bArr2));
        }
    }
    ...
    public static int getDigestSize(InterfaceC1236sv interfaceC1236sv) {
        if (interfaceC1236sv == null) {
            throw new NullPointerException("digest == null");
        }
        String algorithmName = interfaceC1236sv.getAlgorithmName();
        if (algorithmName.equals(ki1.SHAKE128)) {
            return 32;
        }
        if (algorithmName.equals(ki1.SHAKE256)) {
            return 64;
        }
        return interfaceC1236sv.getDigestSize();
    }
