...
public final class wi1 extends oi1 implements ej1, InterfaceC1394wy {
    ...
    /* renamed from: wi1$a0 */
    public static class C1378a0 {
        private final qi1 params;
        private byte[] root = null;
        private byte[] publicSeed = null;
        private byte[] publicKey = null;

        public C1378a0(qi1 qi1Var) {
            this.params = qi1Var;
        }
        ...
        public C1378a0 withPublicKey(byte[] bArr) {
            this.publicKey = fj1.cloneArray(bArr);
            return this;
        }

        public C1378a0 withPublicSeed(byte[] bArr) {
            this.publicSeed = fj1.cloneArray(bArr);
            return this;
        }

        public C1378a0 withRoot(byte[] bArr) {
            this.root = fj1.cloneArray(bArr);
            return this;
        }
    }

    private wi1(C1378a0 c1378a0) {
        super(false, c1378a0.params.getTreeDigest());
        qi1 qi1Var = c1378a0.params;
        this.params = qi1Var;
        if (qi1Var == null) {
            throw new NullPointerException("params == null");
        }
        int treeDigestSize = qi1Var.getTreeDigestSize();
        byte[] bArr = c1378a0.publicKey;
        if (bArr != null) {
        ...
        if (qi1Var.getOid() != null) {
            this.oid = qi1Var.getOid().getOid();
        } else {
            this.oid = 0;
        }
        byte[] bArr2 = c1378a0.root;
        if (bArr2 == null) {
