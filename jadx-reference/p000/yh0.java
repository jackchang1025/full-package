...
public abstract class yh0 {
    ...
    /* renamed from: M */
    private static final long f61321M = 4294967295L;

    public static int add(int i, int[] iArr, int[] iArr2, int[] iArr3) {
        long j = 0;
        for (int i2 = 0; i2 < i; i2++) {
            long j2 = (iArr[i2] & f61321M) + (f61321M & iArr2[i2]) + j;
            iArr3[i2] = (int) j2;
            j = j2 >>> 32;
        }
        return (int) j;
    ...
    public static int add33At(int i, int i2, int[] iArr, int i3) {
        long j = (iArr[i3] & f61321M) + (i2 & f61321M);
        iArr[i3] = (int) j;
        long j2 = (f61321M & iArr[r4]) + 1 + (j >>> 32);
        iArr[i3 + 1] = (int) j2;
        if ((j2 >>> 32) == 0) {
            return 0;
        }
    ...
    public static int add33To(int i, int i2, int[] iArr) {
        long j = (iArr[0] & f61321M) + (i2 & f61321M);
        iArr[0] = (int) j;
        long j2 = (f61321M & iArr[1]) + 1 + (j >>> 32);
        iArr[1] = (int) j2;
        if ((j2 >>> 32) == 0) {
            return 0;
        }
    ...
    public static int addBothTo(int i, int[] iArr, int i2, int[] iArr2, int i3, int[] iArr3, int i4) {
        ...
        for (int i5 = 0; i5 < i; i5++) {
            long j2 = (iArr[i2 + i5] & f61321M) + (iArr2[i3 + i5] & f61321M) + (f61321M & iArr3[r7]) + j;
            iArr3[i4 + i5] = (int) j2;
            j = j2 >>> 32;
        }
        return (int) j;
    ...
    public static int addDWordAt(int i, long j, int[] iArr, int i2) {
        long j2 = (iArr[i2] & f61321M) + (j & f61321M);
        iArr[i2] = (int) j2;
        long j3 = (f61321M & iArr[r5]) + (j >>> 32) + (j2 >>> 32);
        iArr[i2 + 1] = (int) j3;
        if ((j3 >>> 32) == 0) {
            return 0;
        }
    ...
    public static int addDWordTo(int i, long j, int[] iArr) {
        long j2 = (iArr[0] & f61321M) + (j & f61321M);
        iArr[0] = (int) j2;
        long j3 = (f61321M & iArr[1]) + (j >>> 32) + (j2 >>> 32);
        iArr[1] = (int) j3;
        if ((j3 >>> 32) == 0) {
            return 0;
        }
    ...
    public static int addTo(int i, int[] iArr, int i2, int[] iArr2, int i3) {
        ...
        for (int i4 = 0; i4 < i; i4++) {
            long j2 = (iArr[i2 + i4] & f61321M) + (f61321M & iArr2[r7]) + j;
            iArr2[i3 + i4] = (int) j2;
            j = j2 >>> 32;
        }
        return (int) j;
    ...
    public static int addToEachOther(int i, int[] iArr, int i2, int[] iArr2, int i3) {
        long j = 0;
        for (int i4 = 0; i4 < i; i4++) {
            long j2 = (iArr[r3] & f61321M) + (f61321M & iArr2[r8]) + j;
            int i5 = (int) j2;
            iArr[i2 + i4] = i5;
            iArr2[i3 + i4] = i5;
            j = j2 >>> 32;
    ...
    public static int addWordAt(int i, int i2, int[] iArr, int i3) {
        long j = (i2 & f61321M) + (f61321M & iArr[i3]);
        iArr[i3] = (int) j;
        if ((j >>> 32) == 0) {
            return 0;
        }
    ...
    public static int addWordTo(int i, int i2, int[] iArr) {
        long j = (i2 & f61321M) + (f61321M & iArr[0]);
        iArr[0] = (int) j;
        if ((j >>> 32) == 0) {
            return 0;
        }
    ...
    public static int cadd(int i, int i2, int[] iArr, int[] iArr2, int[] iArr3) {
        ...
        for (int i3 = 0; i3 < i; i3++) {
            long j3 = (iArr[i3] & f61321M) + (iArr2[i3] & j) + j2;
            iArr3[i3] = (int) j3;
            j2 = j3 >>> 32;
        }
        return (int) j2;
    ...
    public static int csub(int i, int i2, int[] iArr, int i3, int[] iArr2, int i4, int[] iArr3, int i5) {
        ...
        long j2 = 0;
        for (int i6 = 0; i6 < i; i6++) {
            long j3 = ((iArr[i3 + i6] & f61321M) - (iArr2[i4 + i6] & j)) + j2;
            iArr3[i5 + i6] = (int) j3;
            j2 = j3 >> 32;
        }
        return (int) j2;
    ...
    /* renamed from: eq */
    public static boolean m215288eq(int i, int[] iArr, int[] iArr2) {
    ...
    public static int lessThan(int i, int[] iArr, int i2, int[] iArr2, int i3) {
        long j = 0;
        for (int i4 = 0; i4 < i; i4++) {
            j = (((iArr[i2 + i4] & f61321M) - (f61321M & iArr2[i3 + i4])) + j) >> 32;
        }
        return (int) j;
    }
    ...
    public static int mul31BothAdd(int i, int i2, int[] iArr, int i3, int[] iArr2, int[] iArr3, int i4) {
        ...
        int i5 = 0;
        do {
            long j4 = ((iArr2[i5] & f61321M) * j2) + ((iArr[i5] & f61321M) * j) + (iArr3[r9] & f61321M) + j3;
            iArr3[i4 + i5] = (int) j4;
            j3 = j4 >>> 32;
            i5++;
        } while (i5 < i);
    ...
    public static int mulAddTo(int i, int[] iArr, int i2, int[] iArr2, int i3, int[] iArr3, int i4) {
        ...
        while (i5 < i) {
            int i7 = i;
            int[] iArr4 = iArr3;
            long jMulWordAddTo = j + (mulWordAddTo(i7, iArr[i2 + i5], r5, r6, iArr4, i6) & f61321M) + (iArr4[r9] & f61321M);
    ...
    public static int mulWord(int i, int i2, int[] iArr, int i3, int[] iArr2, int i4) {
        ...
        int i5 = 0;
        do {
            long j3 = ((iArr[i3 + i5] & f61321M) * j) + j2;
            iArr2[i4 + i5] = (int) j3;
            j2 = j3 >>> 32;
            i5++;
        } while (i5 < i);
    ...
    public static int mulWordAddTo(int i, int i2, int[] iArr, int i3, int[] iArr2, int i4) {
        ...
        int i5 = 0;
        do {
            long j3 = ((iArr[i3 + i5] & f61321M) * j) + (iArr2[r8] & f61321M) + j2;
            iArr2[i4 + i5] = (int) j3;
            j2 = j3 >>> 32;
            i5++;
        } while (i5 < i);
    ...
    public static int mulWordDwordAddAt(int i, int i2, long j, int[] iArr, int i3) {
        long j2 = i2 & f61321M;
        long j3 = ((j & f61321M) * j2) + (iArr[i3] & f61321M);
        iArr[i3] = (int) j3;
        long j4 = j2 * (j >>> 32);
        long j5 = j4 + (iArr[r10] & f61321M) + (j3 >>> 32);
        iArr[i3 + 1] = (int) j5;
        long j6 = j5 >>> 32;
        long j7 = j6 + (iArr[r0] & f61321M);
        iArr[i3 + 2] = (int) j7;
        if ((j7 >>> 32) == 0) {
            return 0;
        }
    ...
    public static void square(int i, int[] iArr, int i2, int[] iArr2, int i3) {
        ...
        long j3 = 0;
        for (i4 = 1; i4 < i; i4++) {
            long jSquareWordAddTo = j3 + (squareWordAddTo(iArr, i2, i4, iArr2, i3) & f61321M) + (iArr2[i9] & f61321M);
            int i10 = i9 + 1;
            iArr2[i9] = (int) jSquareWordAddTo;
            long j4 = (jSquareWordAddTo >>> 32) + (iArr2[i10] & f61321M);
            i9 += 2;
            iArr2[i10] = (int) j4;
            j3 = j4 >>> 32;
        }
    ...
    public static int squareWordAddTo(int[] iArr, int i, int i2, int[] iArr2, int i3) {
        long j = iArr[i + i2] & f61321M;
        int i4 = 0;
        long j2 = 0;
        int i5 = i3;
        do {
            long j3 = ((iArr[i + i4] & f61321M) * j) + (iArr2[r11] & f61321M) + j2;
            iArr2[i2 + i5] = (int) j3;
            j2 = j3 >>> 32;
            i5++;
            i4++;
    ...
    public static int sub(int i, int[] iArr, int i2, int[] iArr2, int i3, int[] iArr3, int i4) {
        long j = 0;
        for (int i5 = 0; i5 < i; i5++) {
            long j2 = ((iArr[i2 + i5] & f61321M) - (f61321M & iArr2[i3 + i5])) + j;
            iArr3[i4 + i5] = (int) j2;
            j = j2 >> 32;
        }
        return (int) j;
    ...
    public static int subBothFrom(int i, int[] iArr, int i2, int[] iArr2, int i3, int[] iArr3, int i4) {
        long j = 0;
        for (int i5 = 0; i5 < i; i5++) {
            long j2 = (((iArr3[r3] & f61321M) - (iArr[i2 + i5] & f61321M)) - (f61321M & iArr2[i3 + i5])) + j;
            iArr3[i4 + i5] = (int) j2;
            j = j2 >> 32;
        }
        return (int) j;
    ...
    public static int subFrom(int i, int[] iArr, int i2, int[] iArr2, int i3) {
        long j = 0;
        for (int i4 = 0; i4 < i; i4++) {
            long j2 = ((iArr2[r3] & f61321M) - (f61321M & iArr[i2 + i4])) + j;
            iArr2[i3 + i4] = (int) j2;
            j = j2 >> 32;
        }
        return (int) j;
    ...
    public static int subWordAt(int i, int i2, int[] iArr, int i3) {
        long j = (iArr[i3] & f61321M) - (f61321M & i2);
        iArr[i3] = (int) j;
        if ((j >> 32) == 0) {
            return 0;
        }
    ...
    public static int subWordFrom(int i, int i2, int[] iArr) {
        long j = (iArr[0] & f61321M) - (f61321M & i2);
        iArr[0] = (int) j;
        if ((j >> 32) == 0) {
            return 0;
        }
    ...
    public static BigInteger toBigInteger(int i, int[] iArr) {
        ...
        for (int i2 = 0; i2 < i; i2++) {
            int i3 = iArr[i2];
            if (i3 != 0) {
                wl0.intToBigEndian(i3, bArr, ((i - 1) - i2) << 2);
            }
        }
    ...
    public static int add33At(int i, int i2, int[] iArr, int i3, int i4) {
        int i5 = i3 + i4;
        long j = (iArr[i5] & f61321M) + (i2 & f61321M);
        iArr[i5] = (int) j;
        long j2 = (f61321M & iArr[r0]) + 1 + (j >>> 32);
        iArr[i5 + 1] = (int) j2;
        if ((j2 >>> 32) == 0) {
            return 0;
        }
    ...
    public static int addBothTo(int i, int[] iArr, int[] iArr2, int[] iArr3) {
        long j = 0;
        for (int i2 = 0; i2 < i; i2++) {
            long j2 = (iArr[i2] & f61321M) + (iArr2[i2] & f61321M) + (f61321M & iArr3[i2]) + j;
            iArr3[i2] = (int) j2;
            j = j2 >>> 32;
        }
        return (int) j;
    ...
    public static int addDWordAt(int i, long j, int[] iArr, int i2, int i3) {
        int i4 = i2 + i3;
        long j2 = (iArr[i4] & f61321M) + (j & f61321M);
        iArr[i4] = (int) j2;
        long j3 = (f61321M & iArr[r0]) + (j >>> 32) + (j2 >>> 32);
        iArr[i4 + 1] = (int) j3;
        if ((j3 >>> 32) == 0) {
            return 0;
        }
    ...
    public static int addTo(int i, int[] iArr, int i2, int[] iArr2, int i3, int i4) {
        long j = i4 & f61321M;
        for (int i5 = 0; i5 < i; i5++) {
            long j2 = (iArr[i2 + i5] & f61321M) + (iArr2[r6] & f61321M) + j;
            iArr2[i3 + i5] = (int) j2;
            j = j2 >>> 32;
        }
        return (int) j;
    ...
    public static int lessThan(int i, int[] iArr, int[] iArr2) {
        long j = 0;
        for (int i2 = 0; i2 < i; i2++) {
            j = (((iArr[i2] & f61321M) - (f61321M & iArr2[i2])) + j) >> 32;
        }
        return (int) j;
    }
    ...
    public static int mulAddTo(int i, int[] iArr, int[] iArr2, int[] iArr3) {
        ...
        while (i2 < i) {
            int i3 = i;
            int[] iArr4 = iArr3;
            long jMulWordAddTo = j + (mulWordAddTo(i3, iArr[i2], r4, 0, iArr4, i2) & f61321M) + (iArr4[r10] & f61321M);
    ...
    public static void square(int i, int[] iArr, int[] iArr2) {
        ...
        int i8 = 2;
        for (i2 = 1; i2 < i; i2++) {
            long jSquareWordAddTo = j3 + (squareWordAddTo(iArr, i2, iArr2) & f61321M) + (iArr2[i8] & f61321M);
            int i9 = i8 + 1;
            iArr2[i8] = (int) jSquareWordAddTo;
            long j4 = (jSquareWordAddTo >>> 32) + (iArr2[i9] & f61321M);
            i8 += 2;
            iArr2[i9] = (int) j4;
            j3 = j4 >>> 32;
        }
    ...
    public static int squareWordAddTo(int[] iArr, int i, int[] iArr2) {
        long j = iArr[i] & f61321M;
        long j2 = 0;
        int i2 = 0;
        do {
            long j3 = ((iArr[i2] & f61321M) * j) + (iArr2[r9] & f61321M) + j2;
            iArr2[i + i2] = (int) j3;
            j2 = j3 >>> 32;
            i2++;
        } while (i2 < i);
    ...
    public static int subBothFrom(int i, int[] iArr, int[] iArr2, int[] iArr3) {
        long j = 0;
        for (int i2 = 0; i2 < i; i2++) {
            long j2 = (((iArr3[i2] & f61321M) - (iArr[i2] & f61321M)) - (f61321M & iArr2[i2])) + j;
            iArr3[i2] = (int) j2;
            j = j2 >> 32;
        }
        return (int) j;
    ...
    public static int subFrom(int i, int[] iArr, int[] iArr2) {
        long j = 0;
        for (int i2 = 0; i2 < i; i2++) {
            long j2 = ((iArr2[i2] & f61321M) - (f61321M & iArr[i2])) + j;
            iArr2[i2] = (int) j2;
            j = j2 >> 32;
        }
        return (int) j;
    ...
    public static int subWordAt(int i, int i2, int[] iArr, int i3, int i4) {
        long j = (iArr[r0] & f61321M) - (f61321M & i2);
        iArr[i3 + i4] = (int) j;
        if ((j >> 32) == 0) {
            return 0;
        }
