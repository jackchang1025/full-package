...
public class bj1 extends AbstractC0158c3 {
    private final byte[] publicSeed;
    private final byte[] root;

    private bj1(AbstractC0400d2 abstractC0400d2) {
    ...
    public static bj1 getInstance(Object obj) {
        if (obj instanceof bj1) {
            return (bj1) obj;
        }
        if (obj != null) {
            return new bj1(AbstractC0400d2.getInstance(obj));
        }
        return null;
    }
    ...
    public bj1(byte[] bArr, byte[] bArr2) {
