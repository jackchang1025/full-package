...
public class C1190rr extends pa0 {
    private static final byte[] EMPTY_BYTES = new byte[0];
    private final int _originalLength;
    private int _remaining;

    public C1190rr(InputStream inputStream, int i, int i2) {
    ...
    public void readAllIntoByteArray(byte[] bArr) throws IOException {
        ...
        int fully = i2 - i21.readFully(this._in, bArr, 0, bArr.length);
    ...
    public byte[] toByteArray() throws IOException {
        ...
        int fully = i - i21.readFully(this._in, bArr, 0, i);
        this._remaining = fully;
        if (fully == 0) {
            setParentEofDetect(true);
            return bArr;
