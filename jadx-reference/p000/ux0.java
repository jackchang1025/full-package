...
public class ux0 extends AbstractC1341vl.a1 {
    public ux0(AbstractC1316ux abstractC1316ux, AbstractC1330va abstractC1330va, AbstractC1330va abstractC1330va2) {
    ...
    public AbstractC1341vl add(AbstractC1341vl abstractC1341vl) {
        ...
        AbstractC1330va abstractC1330vaAddOne;
        ...
        AbstractC1330va abstractC1330vaAdd2 = abstractC1330vaMultiply3.add(abstractC1330vaMultiply2);
        AbstractC1330va abstractC1330vaAdd3 = abstractC1330vaMultiply4.add(abstractC1330vaMultiply);
        if (abstractC1330vaAdd3.isZero()) {
            return abstractC1330vaAdd2.isZero() ? twice() : curve.getInfinity();
        }
        if (rawXCoord.isZero()) {
            ...
            abstractC1330vaAddOne = abstractC1330vaDivide.square().add(abstractC1330vaDivide).add(xCoord).addOne();
            if (abstractC1330vaAddOne.isZero()) {
                return new ux0(curve, abstractC1330vaAddOne, curve.getB());
            }
            abstractC1330vaAdd = abstractC1330vaDivide.multiply(xCoord.add(abstractC1330vaAddOne)).add(abstractC1330vaAddOne).add(yCoord).divide(abstractC1330vaAddOne).add(abstractC1330vaAddOne);
            abstractC1330vaFromBigInteger = curve.fromBigInteger(InterfaceC1315uw.ONE);
        } else {
            AbstractC1330va abstractC1330vaSquare = abstractC1330vaAdd3.square();
            AbstractC1330va abstractC1330vaMultiply5 = abstractC1330vaAdd2.multiply(abstractC1330vaMultiply4);
            AbstractC1330va abstractC1330vaMultiply6 = abstractC1330vaAdd2.multiply(abstractC1330vaMultiply);
            ...
            if (abstractC1330vaMultiply7.isZero()) {
                return new ux0(curve, abstractC1330vaMultiply7, curve.getB());
            }
            AbstractC1330va abstractC1330vaMultiply8 = abstractC1330vaAdd2.multiply(abstractC1330vaSquare);
            ...
            abstractC1330vaAddOne = abstractC1330vaMultiply7;
            abstractC1330vaFromBigInteger = abstractC1330vaMultiply9;
            abstractC1330vaAdd = abstractC1330vaSquarePlusProduct;
        }
        return new ux0(curve, abstractC1330vaAddOne, abstractC1330vaAdd, new AbstractC1330va[]{abstractC1330vaFromBigInteger});
    }

    @Override // p000.AbstractC1341vl
    public AbstractC1341vl detach() {
        return new ux0(null, getAffineXCoord(), getAffineYCoord());
    }
    ...
    public AbstractC1341vl negate() {
        if (!isInfinity()) {
            ...
            if (!abstractC1330va.isZero()) {
                AbstractC1330va abstractC1330va2 = this.f60654y;
                AbstractC1330va abstractC1330va3 = this.f60655zs[0];
                return new ux0(this.curve, abstractC1330va, abstractC1330va2.add(abstractC1330va3), new AbstractC1330va[]{abstractC1330va3});
            }
        }
        return this;
    }
    ...
    public AbstractC1341vl twice() {
        ...
        AbstractC1330va abstractC1330vaMultiply = zIsOne ? abstractC1330va2 : abstractC1330va2.multiply(abstractC1330vaSquare);
        if (!zIsOne) {
            abstractC1330vaSquare = abstractC1330vaSquare.square();
        }
        AbstractC1330va abstractC1330vaM23a4 = AbstractC0003a2.m23a4(abstractC1330va2, abstractC1330vaMultiply, abstractC1330vaSquare);
        if (abstractC1330vaM23a4.isZero()) {
            return new ux0(curve, abstractC1330vaM23a4, curve.getB());
        }
        AbstractC1330va abstractC1330vaSquare2 = abstractC1330vaM23a4.square();
        AbstractC1330va abstractC1330vaMultiply2 = zIsOne ? abstractC1330vaM23a4 : abstractC1330vaM23a4.multiply(abstractC1330vaSquare);
        AbstractC1330va abstractC1330vaSquare3 = abstractC1330va2.add(abstractC1330va).square();
        return new ux0(curve, abstractC1330vaSquare2, abstractC1330vaSquare3.add(abstractC1330vaM23a4).add(abstractC1330vaSquare).multiply(abstractC1330vaSquare3).add(abstractC1330vaSquare2), new AbstractC1330va[]{abstractC1330vaMultiply2});
    }
    ...
    public AbstractC1341vl twicePlus(AbstractC1341vl abstractC1341vl) {
        ...
        AbstractC1330va abstractC1330vaAdd = abstractC1330vaSquare3.add(abstractC1330vaSquare2).add(abstractC1330va2.multiply(abstractC1330va3));
        AbstractC1330va abstractC1330vaMultiplyPlusProduct = rawYCoord.multiply(abstractC1330vaSquare3).add(abstractC1330vaSquare2).multiplyPlusProduct(abstractC1330vaAdd, abstractC1330vaSquare, abstractC1330vaSquare3);
        ...
        if (abstractC1330vaMultiplyPlusProduct.isZero()) {
            return new ux0(curve, abstractC1330vaMultiplyPlusProduct, curve.getB());
        }
        ...
        return new ux0(curve, abstractC1330vaMultiply2, abstractC1330vaMultiplyPlusProduct.add(abstractC1330vaSquare4).square().multiplyPlusProduct(abstractC1330vaAdd, rawYCoord.addOne(), abstractC1330vaMultiply3), new AbstractC1330va[]{abstractC1330vaMultiply3});
    }

    public ux0(AbstractC1316ux abstractC1316ux, AbstractC1330va abstractC1330va, AbstractC1330va abstractC1330va2, AbstractC1330va[] abstractC1330vaArr) {
