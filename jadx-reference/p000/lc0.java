...
public class lc0 implements Cloneable {
    ...
    private void addShiftedByBitsSafe(lc0 lc0Var, int i, int i2) {
        int i3 = (i + 63) >>> 6;
        int i4 = i2 >>> 6;
        int i5 = i2 & 63;
        if (i5 == 0) {
            add(this.m_ints, i4, lc0Var.m_ints, 0, i3);
            return;
        }
        long jAddShiftedUp = addShiftedUp(this.m_ints, i4, lc0Var.m_ints, 0, i3, i5);
        if (jAddShiftedUp != 0) {
    ...
    private static int bitLength(long j) {
        ...
        if (i4 == 0) {
            ...
            int i6 = i3 >>> 24;
            i = i6 == 0 ? bitLengths[i4] + w61.POW_2_WIDTH : bitLengths[i6] + 24;
        }
        return i2 + i;
    }
    ...
    private static long interleave2_32to64(int i) {
        ...
        return ((sArr[i & v10.MASK] | (sArr[(i >>> 8) & v10.MASK] << 16)) & 4294967295L) | ((((sArr[i >>> 24] << 16) | sArr[(i >>> 16) & v10.MASK]) & 4294967295L) << 32);
    }
    ...
    private static long interleave4_16to64(int i) {
        return (INTERLEAVE4_TABLE[i & v10.MASK] & 4294967295L) | ((r0[i >>> 8] & 4294967295L) << 32);
    }
    ...
    private static lc0 reduceResult(long[] jArr, int i, int i2, int i3, int[] iArr) {
        return new lc0(jArr, i, reduceInPlace(jArr, i, i2, i3, iArr));
    }
    ...
    public lc0 addOne() {
        if (this.m_ints.length == 0) {
            return new lc0(new long[]{1});
        }
        long[] jArrResizedInts = resizedInts(Math.max(1, getUsedLength()));
        jArrResizedInts[0] = jArrResizedInts[0] ^ 1;
        return new lc0(jArrResizedInts);
    }

    public void addShiftedByWords(lc0 lc0Var, int i) {
        int usedLength = lc0Var.getUsedLength();
        if (usedLength == 0) {
            return;
        }
        int i2 = usedLength + i;
        ...
        add(this.m_ints, i, lc0Var.m_ints, 0, usedLength);
    }

    public Object clone() {
        return new lc0(C0133bg.clone(this.m_ints));
    }
    ...
    public boolean equals(Object obj) {
        ...
        if (lc0Var.getUsedLength() != usedLength) {
            return false;
        }
        for (int i = 0; i < usedLength; i++) {
            if (this.m_ints[i] != lc0Var.m_ints[i]) {
                return false;
            }
        }
        return true;
    ...
    public lc0 modInverse(int i, int[] iArr) {
        int iDegree = degree();
        if (iDegree == 0) {
        ...
        lc0 lc0Var = (lc0) clone();
        int i3 = (i + 63) >>> 6;
        lc0 lc0Var2 = new lc0(i3);
        int iDegreeFrom = 0;
        reduceBit(lc0Var2.m_ints, 0, i, i, iArr);
        lc0 lc0Var3 = new lc0(i3);
        lc0Var3.m_ints[0] = 1;
        lc0 lc0Var4 = new lc0(i3);
        int[] iArr2 = new int[2];
        iArr2[0] = iDegree;
        iArr2[1] = i + 1;
        lc0[] lc0VarArr = {lc0Var, lc0Var2};
        int[] iArr3 = new int[2];
        iArr3[0] = 1;
        iArr3[1] = 0;
        lc0[] lc0VarArr2 = {lc0Var3, lc0Var4};
        int i4 = iArr2[1];
        int i5 = i4 - iArr2[0];
        while (true) {
            if (i5 < 0) {
            ...
            int i6 = 1 - i2;
            lc0VarArr[i2].addShiftedByBitsSafe(lc0VarArr[i6], iArr2[i6], i5);
            int iDegreeFrom2 = lc0VarArr[i2].degreeFrom(i4);
            if (iDegreeFrom2 == 0) {
                return lc0VarArr2[i6];
            }
            int i7 = iArr3[i6];
            lc0VarArr2[i2].addShiftedByBitsSafe(lc0VarArr2[i6], i7, i5);
            int i8 = i7 + i5;
            if (i8 > iDegreeFrom) {
                iDegreeFrom = i8;
            } else if (i8 == iDegreeFrom) {
                iDegreeFrom = lc0VarArr2[i2].degreeFrom(iDegreeFrom);
            }
            i5 += iDegreeFrom2 - i4;
            i4 = iDegreeFrom2;
        }
    ...
    public lc0 modMultiply(lc0 lc0Var, int i, int[] iArr) {
        int i2;
        int i3;
        lc0 lc0Var2;
        lc0 lc0Var3;
        ...
        int i6 = ((i2 + i3) + 62) >>> 6;
        if (i4 == 1) {
            long j = lc0Var2.m_ints[0];
            if (j == 1) {
                return lc0Var3;
            }
            long[] jArr3 = new long[i6];
            multiplyWord(j, lc0Var3.m_ints, i5, jArr3, 0);
        ...
        iArr2[1] = i7;
        System.arraycopy(lc0Var3.m_ints, 0, jArr4, i7, i5);
        int i9 = 2;
        int i10 = i7;
        while (i9 < 16) {
            int i11 = i10 + i7;
    ...
    public lc0 modMultiplyAlt(lc0 lc0Var, int i, int[] iArr) {
        int i2;
        int i3;
        lc0 lc0Var2;
        lc0 lc0Var3;
        ...
        if (i9 == 1) {
            ...
            multiplyWord(j, lc0Var3.m_ints, i10, jArr3, 0);
        ...
        interleave(lc0Var2.m_ints, 0, jArr4, 0, i18, 4);
        System.arraycopy(lc0Var3.m_ints, 0, jArr4, i18, i10);
        int i19 = i18;
        int i20 = 1;
        while (i20 < 8) {
            int i21 = i19 + i14;
    ...
    public lc0 modMultiplyLD(lc0 lc0Var, int i, int[] iArr) {
        int i2;
        int i3;
        lc0 lc0Var2;
        lc0 lc0Var3;
        ...
        if (i4 == 1) {
            ...
            multiplyWord(j, lc0Var3.m_ints, i5, jArr2, 0);
        ...
        iArr2[1] = i8;
        System.arraycopy(lc0Var3.m_ints, 0, jArr3, i8, i5);
        int i10 = 2;
        int i11 = i8;
        while (i10 < 16) {
            int i12 = i11 + i8;
    ...
    public lc0 modReduce(int i, int[] iArr) {
        long[] jArrClone = C0133bg.clone(this.m_ints);
        return new lc0(jArrClone, 0, reduceInPlace(jArrClone, 0, jArrClone.length, i, iArr));
    }

    public lc0 modSquare(int i, int[] iArr) {
        int usedLength = getUsedLength();
        if (usedLength == 0) {
            return this;
        }
        ...
        return new lc0(jArr, 0, reduceInPlace(jArr, 0, i2, i, iArr));
    }

    public lc0 modSquareN(int i, int i2, int[] iArr) {
        int usedLength = getUsedLength();
        if (usedLength == 0) {
            return this;
        }
        ...
        while (true) {
            i--;
            if (i < 0) {
                return new lc0(jArr, 0, usedLength);
            }
    ...
    public lc0 multiply(lc0 lc0Var, int i, int[] iArr) {
        int i2;
        int i3;
        lc0 lc0Var2;
        lc0 lc0Var3;
        ...
        if (i6 == 1) {
            ...
            multiplyWord(j, lc0Var3.m_ints, i7, jArr, 0);
            return new lc0(jArr, 0, i8);
        }
        int i9 = (i3 + 70) >>> 6;
        int[] iArr2 = new int[16];
        int i10 = i9 << 4;
        ...
        iArr2[1] = i9;
        System.arraycopy(lc0Var3.m_ints, 0, jArr2, i9, i7);
        int i11 = 2;
        int i12 = i9;
        while (i11 < 16) {
            int i13 = i12 + i9;
    ...
    public lc0 square(int i, int[] iArr) {
        int usedLength = getUsedLength();
        if (usedLength == 0) {
            return this;
        }
    ...
    public lc0(BigInteger bigInteger) {
    ...
    public lc0(long[] jArr) {
        this.m_ints = jArr;
    }

    public lc0(long[] jArr, int i, int i2) {
