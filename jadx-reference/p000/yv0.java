...
public class yv0 extends AbstractC1341vl.a2 {
    public yv0(AbstractC1316ux abstractC1316ux, AbstractC1330va abstractC1330va, AbstractC1330va abstractC1330va2) {
    ...
    public AbstractC1341vl add(AbstractC1341vl abstractC1341vl) {
        ...
        return new yv0(curve, xv0Var7, xv0Var8, new AbstractC1330va[]{xv0Var9});
    }

    @Override // p000.AbstractC1341vl
    public AbstractC1341vl detach() {
        return new yv0(null, getAffineXCoord(), getAffineYCoord());
    }

    @Override // p000.AbstractC1341vl
    public AbstractC1341vl negate() {
        return isInfinity() ? this : new yv0(this.curve, this.f60653x, this.f60654y.negate(), this.f60655zs);
    }
    ...
    public AbstractC1341vl twice() {
        ...
        int[] iArrCreate2 = ph0.create();
        int[] iArrCreate3 = ph0.create();
        wv0.square(xv0Var.f61197x, iArrCreate3);
        int[] iArrCreate4 = ph0.create();
        wv0.square(iArrCreate3, iArrCreate4);
        boolean zIsOne = xv0Var3.isOne();
        int[] iArr = xv0Var3.f61197x;
        if (!zIsOne) {
            wv0.square(iArr, iArrCreate2);
            iArr = iArrCreate2;
        }
        wv0.subtract(xv0Var2.f61197x, iArr, iArrCreate);
        wv0.add(xv0Var2.f61197x, iArr, iArrCreate2);
        wv0.multiply(iArrCreate2, iArrCreate, iArrCreate2);
        wv0.reduce32(ph0.addBothTo(iArrCreate2, iArrCreate2, iArrCreate2), iArrCreate2);
        wv0.multiply(iArrCreate3, xv0Var2.f61197x, iArrCreate3);
        wv0.reduce32(yh0.shiftUpBits(5, iArrCreate3, 2, 0), iArrCreate3);
        wv0.reduce32(yh0.shiftUpBits(5, iArrCreate4, 3, 0, iArrCreate), iArrCreate);
        xv0 xv0Var4 = new xv0(iArrCreate4);
        wv0.square(iArrCreate2, xv0Var4.f61197x);
        int[] iArr2 = xv0Var4.f61197x;
        wv0.subtract(iArr2, iArrCreate3, iArr2);
        int[] iArr3 = xv0Var4.f61197x;
        wv0.subtract(iArr3, iArrCreate3, iArr3);
        xv0 xv0Var5 = new xv0(iArrCreate3);
        wv0.subtract(iArrCreate3, xv0Var4.f61197x, xv0Var5.f61197x);
        int[] iArr4 = xv0Var5.f61197x;
        wv0.multiply(iArr4, iArrCreate2, iArr4);
        int[] iArr5 = xv0Var5.f61197x;
        wv0.subtract(iArr5, iArrCreate, iArr5);
        xv0 xv0Var6 = new xv0(iArrCreate2);
        wv0.twice(xv0Var.f61197x, xv0Var6.f61197x);
        if (!zIsOne) {
            int[] iArr6 = xv0Var6.f61197x;
            wv0.multiply(iArr6, xv0Var3.f61197x, iArr6);
        }
        return new yv0(curve, xv0Var4, xv0Var5, new AbstractC1330va[]{xv0Var6});
    }
    ...
    public yv0(AbstractC1316ux abstractC1316ux, AbstractC1330va abstractC1330va, AbstractC1330va abstractC1330va2, AbstractC1330va[] abstractC1330vaArr) {
