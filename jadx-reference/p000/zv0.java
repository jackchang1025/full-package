...
public class zv0 extends AbstractC1316ux.a2 {
    private static final int SECP192K1_DEFAULT_COORDS = 2;
    protected cw0 infinity;

    /* renamed from: q */
    public static final BigInteger f61591q = bw0.f46009Q;
    private static final AbstractC1330va[] SECP192K1_AFFINE_ZS = {new bw0(InterfaceC1315uw.ONE)};

    /* renamed from: zv0$a0 */
    public class C1532a0 extends AbstractC0484f6 {
        final /* synthetic */ int val$len;
        final /* synthetic */ int[] val$table;

        public C1532a0(int i, int[] iArr) {
            this.val$len = i;
            this.val$table = iArr;
        }

        private AbstractC1341vl createPoint(int[] iArr, int[] iArr2) {
            return zv0.this.createRawPoint(new bw0(iArr), new bw0(iArr2), zv0.SECP192K1_AFFINE_ZS);
        }
    ...
    public zv0() {
        super(f61591q);
        this.infinity = new cw0(this, null, null);
        this.f60524a = fromBigInteger(InterfaceC1315uw.ZERO);
        this.f60525b = fromBigInteger(BigInteger.valueOf(3L));
        this.order = new BigInteger(1, c40.decodeStrict("FFFFFFFFFFFFFFFFFFFFFFFE26F2FC170F69466A74DEFD8D"));
    ...
    public InterfaceC1334ve createCacheSafeLookupTable(AbstractC1341vl[] abstractC1341vlArr, int i, int i2) {
        ...
        for (int i4 = 0; i4 < i2; i4++) {
            ...
            qh0.copy(((bw0) abstractC1341vl.getRawXCoord()).f46010x, 0, iArr, i3);
            qh0.copy(((bw0) abstractC1341vl.getRawYCoord()).f46010x, 0, iArr, i3 + 6);
            i3 += 12;
        }
        return new C1532a0(i2, iArr);
    }

    @Override // p000.AbstractC1316ux
    public AbstractC1341vl createRawPoint(AbstractC1330va abstractC1330va, AbstractC1330va abstractC1330va2) {
        return new cw0(this, abstractC1330va, abstractC1330va2);
    }

    @Override // p000.AbstractC1316ux
    public AbstractC1330va fromBigInteger(BigInteger bigInteger) {
        return new bw0(bigInteger);
    }

    @Override // p000.AbstractC1316ux
    public int getFieldSize() {
        return f61591q.bitLength();
    }
    ...
    public AbstractC1330va randomFieldElement(SecureRandom secureRandom) {
        int[] iArrCreate = qh0.create();
        aw0.random(secureRandom, iArrCreate);
    ...
    public AbstractC1330va randomFieldElementMult(SecureRandom secureRandom) {
        int[] iArrCreate = qh0.create();
        aw0.randomMult(secureRandom, iArrCreate);
        return new bw0(iArrCreate);
    }
    ...
    public AbstractC1341vl createRawPoint(AbstractC1330va abstractC1330va, AbstractC1330va abstractC1330va2, AbstractC1330va[] abstractC1330vaArr) {
        return new cw0(this, abstractC1330va, abstractC1330va2, abstractC1330vaArr);
    }
}
