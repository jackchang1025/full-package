...
public class qx0 extends AbstractC1341vl.a1 {
    public qx0(AbstractC1316ux abstractC1316ux, AbstractC1330va abstractC1330va, AbstractC1330va abstractC1330va2) {
    ...
    public AbstractC1341vl add(AbstractC1341vl abstractC1341vl) {
        ...
        if (rawXCoord.isZero()) {
            ...
            if (abstractC1330vaAdd.isZero()) {
                return new qx0(curve, abstractC1330vaAdd, curve.getB().sqrt());
            }
            ...
            if (abstractC1330vaMultiply7.isZero()) {
                return new qx0(curve, abstractC1330vaMultiply7, curve.getB().sqrt());
            }
        ...
        return new qx0(curve, abstractC1330vaAdd, abstractC1330vaAdd2, new AbstractC1330va[]{abstractC1330vaFromBigInteger});
    }

    @Override // p000.AbstractC1341vl
    public AbstractC1341vl detach() {
        return new qx0(null, getAffineXCoord(), getAffineYCoord());
    }
    ...
    public AbstractC1341vl negate() {
        if (!isInfinity()) {
            ...
            if (!abstractC1330va.isZero()) {
                AbstractC1330va abstractC1330va2 = this.f60654y;
                AbstractC1330va abstractC1330va3 = this.f60655zs[0];
                return new qx0(this.curve, abstractC1330va, abstractC1330va2.add(abstractC1330va3), new AbstractC1330va[]{abstractC1330va3});
            }
        }
        return this;
    }
    ...
    public AbstractC1341vl twice() {
        ...
        if (abstractC1330vaM23a4.isZero()) {
            return new qx0(curve, abstractC1330vaM23a4, curve.getB().sqrt());
        }
        ...
        return new qx0(curve, abstractC1330vaSquare2, abstractC1330vaMultiply.squarePlusProduct(abstractC1330vaM23a4, abstractC1330vaMultiply2).add(abstractC1330vaSquare2).add(abstractC1330vaMultiply3), new AbstractC1330va[]{abstractC1330vaMultiply3});
    }
    ...
    public AbstractC1341vl twicePlus(AbstractC1341vl abstractC1341vl) {
        ...
        if (abstractC1330vaMultiplyPlusProduct.isZero()) {
            return new qx0(curve, abstractC1330vaMultiplyPlusProduct, curve.getB().sqrt());
        }
        ...
        return new qx0(curve, abstractC1330vaMultiply2, abstractC1330vaMultiplyPlusProduct.add(abstractC1330vaSquare4).square().multiplyPlusProduct(abstractC1330vaAdd, abstractC1330vaAddOne, abstractC1330vaMultiply3), new AbstractC1330va[]{abstractC1330vaMultiply3});
    }

    public qx0(AbstractC1316ux abstractC1316ux, AbstractC1330va abstractC1330va, AbstractC1330va abstractC1330va2, AbstractC1330va[] abstractC1330vaArr) {
