...
public class vy0 {
    ...
    public static long[] fromBigInteger(BigInteger bigInteger) {
        return yh0.fromBigInteger64(409, bigInteger);
    }

    public static void halfTrace(long[] jArr, long[] jArr2) {
        long[] jArrCreate64 = yh0.create64(13);
        vh0.copy64(jArr, jArr2);
    ...
    public static void implSquare(long[] jArr, long[] jArr2) {
        r60.expand64To128(jArr, 0, 6, jArr2, 0);
        jArr2[12] = r60.expand32to64((int) jArr[6]);
    }

    public static void invert(long[] jArr, long[] jArr2) {
        if (vh0.isZero64(jArr)) {
            throw new IllegalStateException();
        }
        long[] jArrCreate64 = vh0.create64();
        long[] jArrCreate642 = vh0.create64();
        long[] jArrCreate643 = vh0.create64();
    ...
    public static void multiply(long[] jArr, long[] jArr2, long[] jArr3) {
        long[] jArrCreateExt64 = vh0.createExt64();
    ...
    public static void sqrt(long[] jArr, long[] jArr2) {
        long jUnshuffle = r60.unshuffle(jArr[0]);
        long jUnshuffle2 = r60.unshuffle(jArr[1]);
        long j = (jUnshuffle & 4294967295L) | (jUnshuffle2 << 32);
        long j2 = (jUnshuffle >>> 32) | (jUnshuffle2 & (-4294967296L));
        long jUnshuffle3 = r60.unshuffle(jArr[2]);
        long jUnshuffle4 = r60.unshuffle(jArr[3]);
        long j3 = (jUnshuffle3 & 4294967295L) | (jUnshuffle4 << 32);
        long j4 = (jUnshuffle3 >>> 32) | (jUnshuffle4 & (-4294967296L));
        long jUnshuffle5 = r60.unshuffle(jArr[4]);
        long jUnshuffle6 = r60.unshuffle(jArr[5]);
        long j5 = (jUnshuffle5 >>> 32) | (jUnshuffle6 & (-4294967296L));
        long jUnshuffle7 = r60.unshuffle(jArr[6]);
