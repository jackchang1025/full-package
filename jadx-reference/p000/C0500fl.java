...
public final class C0500fl {
    ...
    public static String toHexString(byte[] bArr) {
        ...
        for (int i = 0; i < bArr.length; i++) {
            ...
            char[] cArr = HEX_CHARS;
            sbM37b8.append(cArr[(bArr[i] >>> 4) & 15]);
            StringBuilder sbM37b82 = AbstractC0003a2.m37b8(sbM37b8.toString());
            sbM37b82.append(cArr[bArr[i] & 15]);
    ...
    public static String toHexString(byte[] bArr, String str, String str2) {
        ...
        for (int i = 0; i < bArr.length; i++) {
            StringBuilder sbM37b8 = AbstractC0003a2.m37b8(str3);
            char[] cArr = HEX_CHARS;
            sbM37b8.append(cArr[(bArr[i] >>> 4) & 15]);
            StringBuilder sbM37b82 = AbstractC0003a2.m37b8(sbM37b8.toString());
            sbM37b82.append(cArr[bArr[i] & 15]);
            str3 = sbM37b82.toString();
            if (i < bArr.length - 1) {
                str3 = AbstractC0003a2.m32b3(str3, str2);
            }
        }
        return str3;
    }
