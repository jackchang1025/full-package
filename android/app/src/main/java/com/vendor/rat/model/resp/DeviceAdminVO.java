...
public class DeviceAdminVO extends MessageBodyVO {
    ...
    public void setIsAdminActive(Integer num) { this.isAdminActive = num; }
    public void setIsDeviceOwner(Integer num) { this.isDeviceOwner = num; }
    public void setIsProfileOwner(Integer num) { this.isProfileOwner = num; }
