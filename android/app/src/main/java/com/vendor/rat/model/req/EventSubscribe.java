...
// ADAPT: com.guard.wallet.condition.TargetActionCondition -> com.vendor.rat.auto.condition.TargetActionCondition
...
// ADAPT: k.a (selector) -> Object (obfuscated type)

import android.util.Log;
import androidx.annotation.NonNull;
import com.vendor.rat.auto.condition.CombineFilter;
import com.vendor.rat.auto.condition.TargetActionCondition;
import java.util.HashSet;
import java.util.Iterator;
import java.util.List;

public class EventSubscribe implements Comparable<EventSubscribe> {
    private static final String TAG = "com.vendor.rat.model.req.EventSubscribe";
    ...
    private Object selector; // ADAPT: was obfuscated k.a in vendor
    ...
    public Object getSelector() {
        // ADAPT: vendor used combineFilter.toGlobalSelector(null) -> obfuscated k.a
        // TODO: VENDOR_VERIFY - selector logic depends on obfuscated types
        ...
        try {
            ...
            Log.e(TAG, "getSelector error", e2);
        }
    ...
    public void setEventGap(Integer num) { this.eventGap = num; }
    public void setEventTimestamp(Long l2) { this.eventTimestamp = l2; }
    public void setEventTypes(HashSet<Integer> hashSet) { this.eventTypes = hashSet; }
    public void setHelperProp(String str) { this.helperProp = str; }
    public void setId(String str) { this.id = str; }
    public void setListenHelper(boolean z2) { this.listenHelper = z2; }
    public void setListenId(String str) { this.listenId = str; }
    public void setListenProps(List<String> list) { this.listenProps = list; }
    public void setListenType(Integer num) { this.listenType = num; }
    public void setNeedReply(boolean z2) { this.needReply = z2; }
    public void setOrderNo(Integer num) { this.orderNo = num; }
    public void setReplyActions(List<TargetActionCondition> list) { this.replyActions = list; }
    public void setReplySubscribes(List<String> list) { this.replySubscribes = list; }
    public void setSourceRule(Integer num) { this.sourceRule = num; }
