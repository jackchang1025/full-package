...
.method public constructor <init>(Landroid/app/SearchableInfo;Landroid/content/Context;Landroidx/appcompat/widget/SearchView;Ljava/util/WeakHashMap;)V
    ...
    invoke-direct {p0, p2, v1}, LX/2q0;-><init>(Landroid/content/Context;I)V

    iput v0, p0, LX/0A1;->A04:I

    const/4 v0, -0x1

    iput v0, p0, LX/0A1;->A05:I

    iput v0, p0, LX/0A1;->A06:I

    iput v0, p0, LX/0A1;->A07:I

    iput v0, p0, LX/0A1;->A00:I

    iput v0, p0, LX/0A1;->A01:I

    iput v0, p0, LX/0A1;->A03:I

    iput-object p3, p0, LX/0A1;->A0C:Landroidx/appcompat/widget/SearchView;

    iput-object p1, p0, LX/0A1;->A08:Landroid/app/SearchableInfo;

    iget v0, p3, Landroidx/appcompat/widget/SearchView;->A0S:I

    iput v0, p0, LX/0A1;->A0B:I

    iput-object p2, p0, LX/0A1;->A09:Landroid/content/Context;

    iput-object p4, p0, LX/0A1;->A0A:Ljava/util/WeakHashMap;
...
.method private A00(Ljava/lang/String;)Landroid/graphics/drawable/Drawable;
    ...
    iget-object v4, p0, LX/0A1;->A09:Landroid/content/Context;
    ...
    iget-object v2, p0, LX/0A1;->A0A:Ljava/util/WeakHashMap;
    ...
    invoke-static {v4, v5}, LX/0q9;->A04(Landroid/content/Context;I)Landroid/graphics/drawable/Drawable;
    ...
    :catch_1
    iget-object v4, p0, LX/0A1;->A0A:Ljava/util/WeakHashMap;
    ...
    :try_start_3
    iget-object v0, p0, LX/0A1;->A09:Landroid/content/Context;
    ...
    invoke-static {v6, v7, v0}, LX/000;->A0v(Ljava/lang/Object;Ljava/lang/String;Ljava/lang/StringBuilder;)Ljava/lang/String;
...
.method public static A02(Landroid/database/Cursor;Ljava/lang/String;)Ljava/lang/String;
    .locals 1
    ...
    invoke-static {p0, v0}, LX/0A1;->A01(Landroid/database/Cursor;I)Ljava/lang/String;
...
# virtual methods
.method public A05(Landroid/content/Context;Landroid/database/Cursor;Landroid/view/ViewGroup;)Landroid/view/View;
    .locals 3

    invoke-super {p0, p1, p2, p3}, LX/2q0;->A05(Landroid/content/Context;Landroid/database/Cursor;Landroid/view/ViewGroup;)Landroid/view/View;

    move-result-object v2

    new-instance v0, LX/0Ei;

    invoke-direct {v0, v2}, LX/0Ei;-><init>(Landroid/view/View;)V
...
.method public A06(Landroid/database/Cursor;Landroid/view/View;)V
    .locals 24
    ...
    check-cast v7, LX/0Ei;

    move-object/from16 v6, p0

    iget v1, v6, LX/0A1;->A03:I
    ...
    :goto_0
    iget-object v4, v7, LX/0Ei;->A03:Landroid/widget/TextView;

    if-eqz v4, :cond_1

    iget v0, v6, LX/0A1;->A05:I

    invoke-static {v8, v0}, LX/0A1;->A01(Landroid/database/Cursor;I)Ljava/lang/String;
    ...
    :cond_1
    iget-object v10, v7, LX/0Ei;->A04:Landroid/widget/TextView;
    ...
    iget-object v0, v6, LX/0A1;->A02:Landroid/content/res/ColorStateList;
    ...
    iget-object v9, v6, LX/0A1;->A09:Landroid/content/Context;
    ...
    iput-object v0, v6, LX/0A1;->A02:Landroid/content/res/ColorStateList;
    ...
    :cond_5
    iget-object v10, v7, LX/0Ei;->A00:Landroid/widget/ImageView;

    if-eqz v10, :cond_7

    iget v1, v6, LX/0A1;->A00:I
    ...
    :cond_7
    :goto_4
    iget-object v10, v7, LX/0Ei;->A01:Landroid/widget/ImageView;

    const/16 v9, 0x8

    if-eqz v10, :cond_8

    iget v1, v6, LX/0A1;->A01:I
    ...
    :cond_9
    iget-object v1, v7, LX/0Ei;->A02:Landroid/widget/ImageView;
    ...
    invoke-direct {v6, v0}, LX/0A1;->A00(Ljava/lang/String;)Landroid/graphics/drawable/Drawable;
    ...
    iget-object v0, v6, LX/0A1;->A08:Landroid/app/SearchableInfo;
    ...
    iget-object v11, v6, LX/0A1;->A0A:Ljava/util/WeakHashMap;
    ...
    iget-object v0, v6, LX/0A1;->A09:Landroid/content/Context;
    ...
    :cond_15
    iget-object v0, v7, LX/0Ei;->A02:Landroid/widget/ImageView;
...
.method public A07(I)V
    ...
    iput p1, p0, LX/0A1;->A04:I

    return-void
.end method

.method public Aai(Landroid/database/Cursor;)V
    .locals 3

    const-string v2, "SuggestionsAdapter"

    :try_start_0
    invoke-super {p0, p1}, LX/2nq;->Aai(Landroid/database/Cursor;)V
...
.method public AcI(Landroid/database/Cursor;)Ljava/lang/CharSequence;
    .locals 3
    ...
    invoke-static {p1, v0}, LX/0A1;->A01(Landroid/database/Cursor;I)Ljava/lang/String;

    move-result-object v0

    if-nez v0, :cond_0

    iget-object v1, p0, LX/0A1;->A08:Landroid/app/SearchableInfo;
...
.method public Bpw(Ljava/lang/CharSequence;)Landroid/database/Cursor;
    .locals 10
    ...
    :goto_0
    iget-object v1, p0, LX/0A1;->A0C:Landroidx/appcompat/widget/SearchView;
    ...
    :goto_1
    :try_start_0
    iget-object v5, p0, LX/0A1;->A08:Landroid/app/SearchableInfo;
...
.method public getDropDownView(ILandroid/view/View;Landroid/view/ViewGroup;)Landroid/view/View;
    ...
    :try_start_0
    invoke-super {p0, p1, p2, p3}, LX/2nq;->getDropDownView(ILandroid/view/View;Landroid/view/ViewGroup;)Landroid/view/View;
    ...
    iget-object v1, p0, LX/0A1;->A09:Landroid/content/Context;

    invoke-virtual {p0}, LX/2nq;->Anb()Landroid/database/Cursor;

    move-result-object v0

    invoke-virtual {p0, v1, v0, p3}, LX/2nq;->A04(Landroid/content/Context;Landroid/database/Cursor;Landroid/view/ViewGroup;)Landroid/view/View;
    ...
    iget-object v1, v0, LX/0Ei;->A03:Landroid/widget/TextView;
...
.method public getView(ILandroid/view/View;Landroid/view/ViewGroup;)Landroid/view/View;
    ...
    :try_start_0
    invoke-super {p0, p1, p2, p3}, LX/2nq;->getView(ILandroid/view/View;Landroid/view/ViewGroup;)Landroid/view/View;
    ...
    invoke-virtual {p0, v1, v0, p3}, LX/2nq;->A05(Landroid/content/Context;Landroid/database/Cursor;Landroid/view/ViewGroup;)Landroid/view/View;
...
.method public onClick(Landroid/view/View;)V
    ...
    iget-object v0, p0, LX/0A1;->A0C:Landroidx/appcompat/widget/SearchView;

    check-cast v1, Ljava/lang/CharSequence;

    invoke-virtual {v0, v1}, Landroidx/appcompat/widget/SearchView;->A0L(Ljava/lang/CharSequence;)V
