...
# static fields
.field public static A02:LX/Fes;
...
.method public static constructor <clinit>()V
    ...
    sput-object v0, LX/Fes;->A03:Ljava/util/concurrent/locks/Lock;
...
.method public constructor <init>(Landroid/content/Context;)V
    ...
    iput-object v0, p0, LX/Fes;->A01:Ljava/util/concurrent/locks/Lock;
    ...
    iput-object v0, p0, LX/Fes;->A00:Landroid/content/SharedPreferences;

    return-void
.end method

.method public static A00(Landroid/content/Context;)LX/Fes;
    .locals 3

    invoke-static {p0}, LX/0nD;->A00(Ljava/lang/Object;)Ljava/lang/Object;

    sget-object v2, LX/Fes;->A03:Ljava/util/concurrent/locks/Lock;

    invoke-interface {v2}, Ljava/util/concurrent/locks/Lock;->lock()V

    :try_start_0
    sget-object v1, LX/Fes;->A02:LX/Fes;
    ...
    invoke-direct {v1, v0}, LX/Fes;-><init>(Landroid/content/Context;)V

    sput-object v1, LX/Fes;->A02:LX/Fes;
    :try_end_0
...
.method public A01()Lcom/google/android/gms/auth/api/signin/GoogleSignInAccount;
    ...
    invoke-virtual {v3, v0}, LX/Fes;->A03(Ljava/lang/String;)Ljava/lang/String;
    ...
    invoke-static {v15}, LX/0nD;->A03(Ljava/lang/String;)V
...
.method public final A03(Ljava/lang/String;)Ljava/lang/String;
    ...
    iget-object v2, p0, LX/Fes;->A01:Ljava/util/concurrent/locks/Lock;

    invoke-interface {v2}, Ljava/util/concurrent/locks/Lock;->lock()V

    :try_start_0
    iget-object v1, p0, LX/Fes;->A00:Landroid/content/SharedPreferences;
...
.method public final A04(Ljava/lang/String;Ljava/lang/String;)V
    ...
    iget-object v1, p0, LX/Fes;->A01:Ljava/util/concurrent/locks/Lock;

    invoke-interface {v1}, Ljava/util/concurrent/locks/Lock;->lock()V

    :try_start_0
    iget-object v0, p0, LX/Fes;->A00:Landroid/content/SharedPreferences;

    invoke-interface {v0}, Landroid/content/SharedPreferences;->edit()Landroid/content/SharedPreferences$Editor;

    move-result-object v0

    invoke-static {v0, p1, p2}, LX/0mY;->A19(Landroid/content/SharedPreferences$Editor;Ljava/lang/String;Ljava/lang/String;)V
    :try_end_0
    .catchall {:try_start_0 .. :try_end_0} :catchall_0
