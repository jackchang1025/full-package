.class public final Lmyobfuscated/Rb/a;
.super Ljava/lang/Object;


# static fields
.field public static final a:Lmyobfuscated/Rb/a;
...
.method static constructor <clinit>()V
    ...
    new-instance v0, Lmyobfuscated/Rb/a;

    invoke-direct {v0}, Lmyobfuscated/Rb/a;-><init>()V

    sput-object v0, Lmyobfuscated/Rb/a;->a:Lmyobfuscated/Rb/a;

    const-class v0, Lmyobfuscated/Rb/a;

    invoke-virtual {v0}, Ljava/lang/Class;->getCanonicalName()Ljava/lang/String;

    move-result-object v0

    sput-object v0, Lmyobfuscated/Rb/a;->b:Ljava/lang/String;

    new-instance v0, Ljava/util/HashMap;

    invoke-direct {v0}, Ljava/util/HashMap;-><init>()V

    sput-object v0, Lmyobfuscated/Rb/a;->c:Ljava/util/HashMap;
...
.method public static final a(Ljava/lang/String;)V
    ...
    :cond_0
    :try_start_0
    sget-object v1, Lmyobfuscated/Rb/a;->a:Lmyobfuscated/Rb/a;

    invoke-virtual {v1, p0}, Lmyobfuscated/Rb/a;->b(Ljava/lang/String;)V
    :try_end_0
...
.method public static final c()Z
    ...
    invoke-static {v1}, Lcom/facebook/internal/FetchedAppSettingsManager;->b(Ljava/lang/String;)Lcom/facebook/internal/s;

    move-result-object v1

    if-eqz v1, :cond_1

    iget-object v1, v1, Lcom/facebook/internal/s;->c:Ljava/util/EnumSet;
...
.method public final b(Ljava/lang/String;)V
    ...
    :cond_0
    sget-object v0, Lmyobfuscated/Rb/a;->c:Ljava/util/HashMap;
    ...
    :try_start_2
    sget-object v2, Lmyobfuscated/Rb/a;->b:Ljava/lang/String;

    invoke-static {v1, v2}, Lcom/facebook/internal/J;->E(Ljava/lang/Exception;Ljava/lang/String;)V
...
.method public final d(Ljava/lang/String;)Z
    ...
    :cond_0
    :try_start_0
    sget-object v2, Lmyobfuscated/Rb/a;->c:Ljava/util/HashMap;
    ...
    const-string v4, "18.0.2"

    const/16 v6, 0x2e

    const/16 v7, 0x7c

    invoke-static {v4, v6, v7}, Lkotlin/text/c;->n(Ljava/lang/String;CC)Ljava/lang/String;
    ...
    new-instance v6, Lmyobfuscated/Rb/a$a;

    invoke-direct {v6, v0, p1}, Lmyobfuscated/Rb/a$a;-><init>(Ljava/lang/String;Ljava/lang/String;)V
