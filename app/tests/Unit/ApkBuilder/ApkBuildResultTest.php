...
describe('ApkBuildResult formatTime', function () {
    it('formatTime returns ms for under 1000', function () {
        $result = new ApkBuildResult(path: '/out.apk', packageName: 'com.test.app', stats: [], totalTimeMs: 500);
    ...
    it('formatTime returns seconds for under 60000', function () {
        $result = new ApkBuildResult(path: '/out.apk', packageName: 'com.test.app', stats: [], totalTimeMs: 15000);
    ...
    it('formatTime returns minutes for 60000 and above', function () {
        $result = new ApkBuildResult(path: '/out.apk', packageName: 'com.test.app', stats: [], totalTimeMs: 120000);
