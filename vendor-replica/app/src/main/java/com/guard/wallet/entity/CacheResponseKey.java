...
public class CacheResponseKey implements Serializable {
    ...
    public boolean equals(Object obj) {
        ...
        CacheResponseKey other = (CacheResponseKey) obj;
        return this.subscribeId.equals(other.subscribeId) && this.batchId.equals(other.batchId);
    }
    ...
    public String toString() {
        return "CacheResponseKey{subscribeId='" + this.subscribeId
