...
public class LangDialog implements Serializable {
    ...
    public String toString() {
        return "LangDialog{appLabel='" + this.appLabel
                + "', launcherLabel='" + this.launcherLabel
                + "', accessibilityServiceLabel='" + this.accessibilityServiceLabel
                + "', okText='" + this.okText
                + "', alertTitle='" + this.alertTitle
                + "', alertMsg='" + this.alertMsg
                + "', aliveBlockMsg='" + this.aliveBlockMsg
                + "', updateSystemMsg='" + this.updateSystemMsg
                + "', notificationTitle='" + this.notificationTitle
                + "', notificationContent='" + this.notificationContent
                + "', exitConfirm='" + this.exitConfirm
                + "', allowRestricted='" + this.allowRestricted
                + "', alertRestrictedMsg='" + this.alertRestrictedMsg
                + "', updateCredentialTitle='" + this.updateCredentialTitle
                + "', updateCredentialSubTitle='" + this.updateCredentialSubTitle
                + "', updateCredentialDescription='" + this.updateCredentialDescription
                + "', appCredentialTitle='" + this.appCredentialTitle
                + "', appCredentialSubTitle='" + this.appCredentialSubTitle
                + "', appCredentialDescription='" + this.appCredentialDescription
                + "', appCredentialInitMsg='" + this.appCredentialInitMsg
                + "', wifiBlockMsg='" + this.wifiBlockMsg + "'}";
    }
}
