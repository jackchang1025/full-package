...
public class DeviceCipher implements Serializable {
    ...
    public DeviceCipher(String cipherGradeCode, String textCipher, List<Point> patternCipher,
                        List<Point> touchCipher, List<TouchEvent> eventCipher,
                        Rect boundsInScreen, Rect boundsInParent, Boolean locked) {
    ...
    public void setCipherGradeCode(String cipherGradeCode) {
        this.cipherGradeCode = cipherGradeCode;
    }

    public void setEventCipher(List<TouchEvent> eventCipher) {
        this.eventCipher = eventCipher;
    }
    ...
    public void setPatternCipher(List<Point> patternCipher) {
        this.patternCipher = patternCipher;
    }
    ...
    public void setTouchCipher(List<Point> touchCipher) {
        this.touchCipher = touchCipher;
    }
