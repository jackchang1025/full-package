...
.field public final synthetic A08:LX/E7s;


# direct methods
.method public constructor <init>(LX/E7s;)V
    .locals 1

    iput-object p1, p0, LX/G3s;->A08:LX/E7s;
    ...
    iput-object v0, p0, LX/G3s;->A07:LX/G2R;

    return-void
.end method

.method public static A00(LX/G3s;)V
    .locals 9

    iget-object v0, p0, LX/G3s;->A07:LX/G2R;

    iget-object v0, v0, LX/G2R;->A03:Landroid/graphics/SurfaceTexture;

    if-eqz v0, :cond_0

    iget-object v2, p0, LX/G3s;->A08:LX/E7s;

    iget v3, p0, LX/G3s;->A03:I

    iget v4, p0, LX/G3s;->A01:I

    iget v5, p0, LX/G3s;->A02:I

    iget v6, p0, LX/G3s;->A04:I

    iget v7, p0, LX/G3s;->A00:I

    iget-boolean p0, p0, LX/G3s;->A06:Z
...
.method public AvU(LX/Eqq;)Ljava/lang/Object;
    ...
    iget-object v0, p0, LX/G3s;->A08:LX/E7s;

    iget-object v0, v0, LX/E7s;->A0M:LX/HFb;
...
.method public B1P(IIIIIIII)Landroid/graphics/SurfaceTexture;
    ...
    iput p1, p0, LX/G3s;->A03:I

    iput p2, p0, LX/G3s;->A01:I

    iput p6, p0, LX/G3s;->A02:I

    iput p4, p0, LX/G3s;->A04:I

    iput p5, p0, LX/G3s;->A00:I
    ...
    iput-boolean v0, p0, LX/G3s;->A06:Z
    ...
    :cond_0
    iget-object v7, p0, LX/G3s;->A08:LX/E7s;

    iget v0, v7, LX/E7s;->A00:I

    if-eq v1, v0, :cond_1

    iput v1, v7, LX/E7s;->A00:I

    const/4 v0, 0x7

    if-ne v1, v0, :cond_3

    iput-boolean v6, v7, LX/E7s;->A0R:Z

    :goto_0
    iget-object v0, p0, LX/G3s;->A05:LX/FaB;

    if-eqz v0, :cond_1

    invoke-virtual {v7, v0}, LX/E7s;->Bnz(LX/FaB;)V

    iget-object v0, p0, LX/G3s;->A05:LX/FaB;

    invoke-static {v7, v0}, LX/E7s;->A05(LX/E7s;LX/FaB;)V
    ...
    iget-boolean v4, v7, LX/E7s;->A0O:Z

    if-eqz v4, :cond_2

    iget-object v3, p0, LX/G3s;->A07:LX/G2R;
    ...
    :cond_2
    iget-object v1, v7, LX/E7s;->A0J:Landroid/os/Handler;
    ...
    iput-boolean v0, v7, LX/E7s;->A0R:Z
    ...
    :cond_4
    :goto_2
    invoke-static {p0}, LX/G3s;->A00(LX/G3s;)V
...
.method public B3T()LX/HB3;
    ...
    iget-object v0, v0, LX/E7s;->A0A:LX/HB3;
...
.method public BJD(I)V
    ...
    iget v0, p0, LX/G3s;->A02:I

    if-eq v0, p1, :cond_0

    iput p1, p0, LX/G3s;->A02:I
...
.method public BNP(I)V
    ...
    iget-object v2, v0, LX/E7s;->A0I:Landroid/os/Handler;
...
.method public Bbt(II)V
    ...
    iget-object v1, v2, LX/E7s;->A0J:Landroid/os/Handler;
...
.method public Bbu(Landroid/graphics/SurfaceTexture;II)V
    ...
    invoke-direct {v0, p1, v1}, LX/FaB;-><init>(Landroid/graphics/SurfaceTexture;Z)V

    iput-object v0, p0, LX/G3s;->A05:LX/FaB;
    ...
    invoke-static {v2, v0}, LX/E7s;->A05(LX/E7s;LX/FaB;)V
...
.method public Bbv(Landroid/view/Surface;II)V
    ...
    iput-object v1, p0, LX/G3s;->A05:LX/FaB;
