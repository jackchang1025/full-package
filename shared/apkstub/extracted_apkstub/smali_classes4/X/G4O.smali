...
.method public constructor <init>(Lcom/facebook/profilo/writer/NativeTraceWriterCallbacks;Z)V
    ...
    iput-boolean p2, p0, LX/G4O;->A07:Z

    iput-object p1, p0, LX/G4O;->A06:Lcom/facebook/profilo/writer/NativeTraceWriterCallbacks;
...
.method public A00()V
    ...
    iget-boolean v0, p0, LX/G4O;->A07:Z

    if-eqz v0, :cond_0

    iget-boolean v0, p0, LX/G4O;->A05:Z

    if-eqz v0, :cond_1

    iget-object v3, p0, LX/G4O;->A06:Lcom/facebook/profilo/writer/NativeTraceWriterCallbacks;

    iget-wide v1, p0, LX/G4O;->A01:J

    iget-object v0, p0, LX/G4O;->A02:Ljava/lang/Throwable;
    ...
    :cond_1
    iget-boolean v0, p0, LX/G4O;->A04:Z

    if-eqz v0, :cond_2

    iget-object v2, p0, LX/G4O;->A06:Lcom/facebook/profilo/writer/NativeTraceWriterCallbacks;

    iget-wide v0, p0, LX/G4O;->A01:J
    ...
    :cond_2
    iget-boolean v0, p0, LX/G4O;->A03:Z
...
.method public onTraceWriteAbort(JI)V
    ...
    iput-boolean v0, p0, LX/G4O;->A03:Z

    iput p3, p0, LX/G4O;->A00:I

    iput-wide p1, p0, LX/G4O;->A01:J

    return-void

    :cond_0
    iget-object v0, p0, LX/G4O;->A06:Lcom/facebook/profilo/writer/NativeTraceWriterCallbacks;
...
.method public onTraceWriteEnd(J)V
    ...
    iput-boolean v0, p0, LX/G4O;->A04:Z
...
.method public onTraceWriteException(JLjava/lang/Throwable;)V
    ...
    iput-boolean v0, p0, LX/G4O;->A05:Z

    iput-object p3, p0, LX/G4O;->A02:Ljava/lang/Throwable;
