...
.method public constructor <init>(Landroid/widget/CompoundButton;)V
    ...
    iput-object v0, p0, LX/0FZ;->A00:Landroid/content/res/ColorStateList;

    iput-object v0, p0, LX/0FZ;->A01:Landroid/graphics/PorterDuff$Mode;

    const/4 v0, 0x0

    iput-boolean v0, p0, LX/0FZ;->A02:Z

    iput-boolean v0, p0, LX/0FZ;->A03:Z

    iput-object p1, p0, LX/0FZ;->A05:Landroid/widget/CompoundButton;
...
.method public A00()V
    ...
    iget-object v2, p0, LX/0FZ;->A05:Landroid/widget/CompoundButton;

    invoke-static {v2}, LX/6Z6;->A00(Landroid/widget/CompoundButton;)Landroid/graphics/drawable/Drawable;

    move-result-object v1

    if-eqz v1, :cond_4

    iget-boolean v0, p0, LX/0FZ;->A02:Z

    if-nez v0, :cond_0

    iget-boolean v0, p0, LX/0FZ;->A03:Z
    ...
    iget-object v0, p0, LX/0FZ;->A00:Landroid/content/res/ColorStateList;
    ...
    iget-object v0, p0, LX/0FZ;->A01:Landroid/graphics/PorterDuff$Mode;
...
.method public A01(Landroid/util/AttributeSet;I)V
    ...
    iget-object v6, p0, LX/0FZ;->A05:Landroid/widget/CompoundButton;

    invoke-virtual {v6}, Landroid/view/View;->getContext()Landroid/content/Context;

    move-result-object v0

    sget-object v7, LX/026;->A0C:[I
    ...
    invoke-static {v0, p1, v7, p2, v1}, LX/01v;->A00(Landroid/content/Context;Landroid/util/AttributeSet;[III)LX/01v;
    ...
    invoke-static {v0, v6}, LX/6Z6;->A01(Landroid/content/res/ColorStateList;Landroid/widget/CompoundButton;)V
    ...
    invoke-static {v0, v6}, LX/6Z6;->A03(Landroid/graphics/PorterDuff$Mode;Landroid/widget/CompoundButton;)V
    :try_end_2
