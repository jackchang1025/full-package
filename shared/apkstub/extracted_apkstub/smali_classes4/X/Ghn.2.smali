...
.method public constructor <init>(LX/Fk6;LX/Ef9;Ljava/util/UUID;LX/1A0;)V
    ...
    iput-object p1, p0, LX/Ghn;->this$0:LX/Fk6;

    iput-object p3, p0, LX/Ghn;->$serviceUUID:Ljava/util/UUID;

    iput-object p2, p0, LX/Ghn;->$transportType:LX/Ef9;

    iput-object p4, p0, LX/Ghn;->$failure:LX/1A0;
...
.method public bridge synthetic invoke()Ljava/lang/Object;
    ...
    iget-object v5, p0, LX/Ghn;->this$0:LX/Fk6;

    iget-object v4, p0, LX/Ghn;->$serviceUUID:Ljava/util/UUID;

    iget-object v3, p0, LX/Ghn;->$transportType:LX/Ef9;

    iget-object v2, p0, LX/Ghn;->$failure:LX/1A0;

    new-instance v1, LX/Gsk;

    invoke-direct {v1, v5, v4, v2}, LX/Gsk;-><init>(LX/Fk6;Ljava/util/UUID;LX/1A0;)V

    new-instance v0, LX/Gmt;

    invoke-direct {v0, v2}, LX/Gmt;-><init>(LX/1A0;)V
