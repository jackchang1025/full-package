.class public final Lmyobfuscated/pf/v;
...
.method static constructor <clinit>()V
    ...
    sput-object v0, Lmyobfuscated/pf/v;->a:Ljava/util/concurrent/atomic/AtomicReference;
...
.method public static a(J)J
    ...
    invoke-static {v0}, Lmyobfuscated/pf/v;->d(Ljava/util/Calendar;)Ljava/util/Calendar;
...
.method public static c(Ljava/lang/String;Ljava/util/Locale;)Landroid/icu/text/DateFormat;
    ...
    invoke-static {p0, p1}, Lmyobfuscated/H0/B;->b(Ljava/lang/String;Ljava/util/Locale;)Landroid/icu/text/DateFormat;

    move-result-object p0

    invoke-static {}, Lio/sentry/android/core/i0;->c()Landroid/icu/util/TimeZone;

    move-result-object p1

    invoke-static {p0, p1}, Lmyobfuscated/H0/C;->d(Landroid/icu/text/DateFormat;Landroid/icu/util/TimeZone;)V

    invoke-static {}, Lio/sentry/android/core/internal/util/r;->b()Landroid/icu/text/DisplayContext;

    move-result-object p1

    invoke-static {p0, p1}, Lio/sentry/android/core/internal/util/s;->f(Landroid/icu/text/DateFormat;Landroid/icu/text/DisplayContext;)V
...
.method public static d(Ljava/util/Calendar;)Ljava/util/Calendar;
    ...
    invoke-static {p0}, Lmyobfuscated/pf/v;->i(Ljava/util/Calendar;)Ljava/util/Calendar;
...
.method public static h()Ljava/util/Calendar;
    ...
    sget-object v0, Lmyobfuscated/pf/v;->a:Ljava/util/concurrent/atomic/AtomicReference;

    invoke-virtual {v0}, Ljava/util/concurrent/atomic/AtomicReference;->get()Ljava/lang/Object;

    move-result-object v0

    check-cast v0, Lmyobfuscated/pf/u;
