...
# direct methods
.method public constructor <init>(LX/0kH;LX/0lU;JZ)V
    .locals 1

    iput-wide p3, p0, LX/0gE;->$minTouchTargetSize:J

    iput-boolean p5, p0, LX/0gE;->$isLeft:Z

    iput-object p2, p0, LX/0gE;->$semanticsModifier:LX/0lU;

    iput-object p1, p0, LX/0gE;->$offsetProvider:LX/0kH;
...
.method public final A00(LX/0lW;I)V
    ...
    :cond_0
    iget-wide v3, p0, LX/0gE;->$minTouchTargetSize:J
    ...
    iget-boolean v4, p0, LX/0gE;->$isLeft:Z

    if-eqz v4, :cond_6

    sget-object v7, LX/0Di;->A01:LX/0ki;

    :goto_0
    iget-object v3, p0, LX/0gE;->$semanticsModifier:LX/0lU;

    iget-wide v0, p0, LX/0gE;->$minTouchTargetSize:J
    ...
    invoke-static {v3, v2, v1, v0, v0}, LX/0M7;->A0G(LX/0lU;FFFF)LX/0lU;

    move-result-object v1

    iget-object v5, p0, LX/0gE;->$offsetProvider:LX/0kH;

    sget-object v0, LX/0IP;->A05:LX/0kT;

    invoke-static {v7, p1, v0, v6}, LX/0Jb;->A01(LX/0ki;LX/0lW;LX/0kT;I)LX/HBu;
    ...
    invoke-interface {p1, v5}, LX/0lW;->Aaq(Ljava/lang/Object;)Z
    ...
    invoke-direct {v1, v5}, LX/0YY;-><init>(LX/0kH;)V
    ...
    invoke-static {p1, v2, v1, v0, v4}, LX/0Kt;->A04(LX/0lW;LX/0lU;LX/0mz;IZ)V
    ...
    :cond_6
    sget-object v7, LX/0Di;->A00:LX/0ki;
    ...
    iget-object v0, p0, LX/0gE;->$offsetProvider:LX/0kH;

    invoke-interface {p1, v0}, LX/0lW;->Aaq(Ljava/lang/Object;)Z

    move-result v0

    iget-object v2, p0, LX/0gE;->$offsetProvider:LX/0kH;
    ...
    invoke-direct {v1, v2}, LX/0YZ;-><init>(LX/0kH;)V
    ...
    iget-boolean v0, p0, LX/0gE;->$isLeft:Z

    invoke-static {p1, v3, v1, v6, v0}, LX/0Kt;->A04(LX/0lW;LX/0lU;LX/0mz;IZ)V
...
.method public bridge synthetic invoke(Ljava/lang/Object;Ljava/lang/Object;)Ljava/lang/Object;
    ...
    invoke-virtual {p0, p1, v0}, LX/0gE;->A00(LX/0lW;I)V
