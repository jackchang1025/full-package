...
.method public constructor <init>(Landroid/widget/ProgressBar;)V
    ...
    iput-object p1, p0, LX/0Ir;->A01:Landroid/widget/ProgressBar;
...
.method public A01(Landroid/graphics/drawable/Drawable;Z)Landroid/graphics/drawable/Drawable;
    ...
    invoke-interface {v1}, LX/Dn2;->B46()Landroid/graphics/drawable/Drawable;

    move-result-object v0

    if-eqz v0, :cond_0

    invoke-virtual {p0, v0, p2}, LX/0Ir;->A01(Landroid/graphics/drawable/Drawable;Z)Landroid/graphics/drawable/Drawable;

    move-result-object v0

    invoke-interface {v1, v0}, LX/Dn2;->Bw7(Landroid/graphics/drawable/Drawable;)V
    ...
    :cond_3
    invoke-virtual {p0, v2, v0}, LX/0Ir;->A01(Landroid/graphics/drawable/Drawable;Z)Landroid/graphics/drawable/Drawable;
    ...
    iget-object v0, p0, LX/0Ir;->A00:Landroid/graphics/Bitmap;

    if-nez v0, :cond_5

    iput-object v5, p0, LX/0Ir;->A00:Landroid/graphics/Bitmap;
    ...
    invoke-static {p1, v2, v5}, LX/0BB;->A00(Landroid/graphics/drawable/LayerDrawable;Landroid/graphics/drawable/LayerDrawable;I)V
...
.method public A02(Landroid/util/AttributeSet;I)V
    ...
    iget-object v6, p0, LX/0Ir;->A01:Landroid/widget/ProgressBar;

    invoke-virtual {v6}, Landroid/view/View;->getContext()Landroid/content/Context;

    move-result-object v1

    sget-object v0, LX/0Ir;->A02:[I

    const/4 v7, 0x0

    invoke-static {v1, p1, v0, p2, v7}, LX/01v;->A00(Landroid/content/Context;Landroid/util/AttributeSet;[III)LX/01v;

    move-result-object v8

    invoke-virtual {v8, v7}, LX/01v;->A04(I)Landroid/graphics/drawable/Drawable;
    ...
    invoke-virtual {p0, v1, v0}, LX/0Ir;->A01(Landroid/graphics/drawable/Drawable;Z)Landroid/graphics/drawable/Drawable;
    ...
    invoke-virtual {v8, v0}, LX/01v;->A04(I)Landroid/graphics/drawable/Drawable;

    move-result-object v0

    if-eqz v0, :cond_3

    invoke-virtual {p0, v0, v7}, LX/0Ir;->A01(Landroid/graphics/drawable/Drawable;Z)Landroid/graphics/drawable/Drawable;
    ...
    :cond_3
    iget-object v0, v8, LX/01v;->A02:Landroid/content/res/TypedArray;
