...
$config = [
    ...
    // 服务器配置
    'UserHost'       => '192.168.31.35:8080',      // WebSocket 主机地址（只需主机:端口，APK 会自动拼接 /api/ws/）
    'appurl'         => 'http://baidu.com',        // 完整 URL（用于其他用途，与 WebSocket 协议无关）
    'useWss'         => false,                     // WebSocket 协议: true = wss://, false = ws://
