...
final class SSLUtils {
    ...
    public static String[] decodeProtocols(byte[] bArr) {
        ...
        while (i3 < bArr.length) {
            ...
            if (b < 0 || b > bArr.length - i3) {
                ...
                sb.append(i3);
                sb.append("): ");
                sb.append(bArr.length < 50 ? Arrays.toString(bArr) : AbstractC0000a.m17m(new StringBuilder(), bArr.length, " byte array"));
        ...
        while (i2 < bArr.length) {
            byte b2 = bArr[i2];
            int i6 = i5 + 1;
            strArr[i5] = b2 > 0 ? new String(bArr, i2 + 1, b2, US_ASCII) : BuildConfig.FLAVOR;
            i2 += b2 + 1;
            i5 = i6;
        }
        return strArr;
    ...
    public static byte[] encodeProtocols(String[] strArr) {
        ...
        for (int i3 = 0; i3 < strArr.length; i3++) {
            ...
            if (str == null) {
                throw new IllegalArgumentException(AbstractC0000a.m12h("protocol[", i3, "] is null"));
            }
