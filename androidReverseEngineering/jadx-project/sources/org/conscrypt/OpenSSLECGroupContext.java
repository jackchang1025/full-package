...
final class OpenSSLECGroupContext {
    ...
    public static OpenSSLECGroupContext getInstance(ECParameterSpec eCParameterSpec) {
        ...
        try {
            long EC_GROUP_new_arbitrary = NativeCrypto.EC_GROUP_new_arbitrary(p2.toByteArray(), a2.toByteArray(), b.toByteArray(), affineX.toByteArray(), affineY.toByteArray(), order.toByteArray(), eCParameterSpec.getCofactor());
