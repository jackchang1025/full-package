...
final class NativeSsl {
    ...
    private void setCertificateValidation() {
        ...
        if (!z2 || (acceptedIssuers = this.parameters.getX509TrustManager().getAcceptedIssuers()) == null || acceptedIssuers.length == 0) {
            return;
        }
        try {
    ...
    private void verifyWithSniMatchers(String str) {
        if (AddressUtils.isValidSniHostname(str) && !Platform.serverNamePermitted(this.parameters, str)) {
            throw new SSLHandshakeException(AbstractC0000a.m15k("SNI match failed: ", str));
        }
    }
    ...
    public void initialize(String str, OpenSSLKey openSSLKey) {
        ...
        boolean z2 = this.parameters.useSessionTickets;
        long j3 = this.ssl;
        if (z2) {
            NativeCrypto.SSL_clear_options(j3, this, 16384L);
        } else {
            NativeCrypto.SSL_set_options(j3, this, NativeCrypto.SSL_get_options(this.ssl, this) | 16384);
        }
