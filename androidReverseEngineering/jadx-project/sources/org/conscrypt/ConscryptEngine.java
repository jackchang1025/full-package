...
final class ConscryptEngine extends AbstractConscryptEngine implements NativeCrypto.SSLHandshakeCallbacks, SSLParametersImpl.AliasChooser, SSLParametersImpl.PSKCallbacks {
    ...
    private static long calcSrcsLength(ByteBuffer[] byteBufferArr, int i2, int i3) {
        ...
        while (i2 < i3) {
            if (byteBufferArr[i2] == null) {
                throw new IllegalArgumentException(AbstractC0000a.m12h("srcs[", i2, "] is null"));
            }
            j2 += r2.remaining();
            i2++;
        }
    ...
    public boolean isInboundDone() {
        ...
        synchronized (this.ssl) {
            int i2 = this.state;
            z2 = (i2 == 8 || i2 == 6 || this.ssl.wasShutdownReceived()) && pendingInboundCleartextBytes() == 0;
        }
        return z2;
    }
    ...
    public boolean isOutboundDone() {
        ...
        synchronized (this.ssl) {
            int i2 = this.state;
            z2 = (i2 == 8 || i2 == 7 || this.ssl.wasShutdownSent()) && pendingOutboundEncryptedBytes() == 0;
        }
        return z2;
    }
    ...
    public SSLEngineResult wrap(ByteBuffer[] byteBufferArr, int i2, int i3, ByteBuffer byteBuffer) {
        ...
        synchronized (this.ssl) {
            ...
            if (min > 0) {
                ...
                SSLEngineResult readPendingBytesFromBIO6 = readPendingBytesFromBIO(byteBuffer, i5, 0, handshakeStatus);
                if (readPendingBytesFromBIO6 == null) {
                    ...
                    i4 = readPendingBytesFromBIO6.bytesProduced();
                }
            } else {
                i4 = 0;
                i5 = 0;
