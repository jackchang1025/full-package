...
public final class OpenSSLECKeyPairGenerator extends KeyPairGenerator {
    ...
    static {
        ...
        hashMap.put(Integer.valueOf(BERTags.FLAGS), "secp224r1");
    ...
    public KeyPair generateKeyPair() {
        if (this.group == null) {
            ...
            if (curveByName == null) {
                throw new RuntimeException(AbstractC0000a.m15k("Curve not recognized: ", str));
            }
        }
    ...
    public void initialize(int i2, SecureRandom secureRandom) {
        ...
        if (str == null) {
            throw new InvalidParameterException(AbstractC0000a.m11g("unknown key size ", i2));
        }
        OpenSSLECGroupContext curveByName = OpenSSLECGroupContext.getCurveByName(str);
        if (curveByName == null) {
    ...
    public void initialize(AlgorithmParameterSpec algorithmParameterSpec, SecureRandom secureRandom) {
        ...
        if (curveByName == null) {
            throw new InvalidAlgorithmParameterException(AbstractC0000a.m15k("unknown curve name: ", name));
        }
        this.group = curveByName;
    }
}
