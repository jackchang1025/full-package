    ...
    public X509CertSelector doConversion(X500Name x500Name, BigInteger bigInteger, byte[] bArr) {
        ...
        if (x500Name != null) {
            try {
                ...
                throw new IllegalArgumentException(AbstractC0000a.m8d(e2, new StringBuilder("unable to convert issuer: ")));
            }
        }
        if (bigInteger != null) {
        ...
        if (bArr != null) {
            try {
                ...
                throw new IllegalArgumentException(AbstractC0000a.m8d(e3, new StringBuilder("unable to convert issuer: ")));
            }
        }
