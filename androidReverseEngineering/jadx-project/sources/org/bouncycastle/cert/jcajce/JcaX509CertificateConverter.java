...
public class JcaX509CertificateConverter {
    ...
    public X509Certificate getCertificate(X509CertificateHolder x509CertificateHolder) {
        try {
            ...
            throw new ExCertificateParsingException(AbstractC0000a.m8d(e2, new StringBuilder("exception parsing certificate: ")), e2);
        } catch (NoSuchProviderException e3) {
            throw new ExCertificateException("cannot find required provider:" + e3.getMessage(), e3);
        }
    }
