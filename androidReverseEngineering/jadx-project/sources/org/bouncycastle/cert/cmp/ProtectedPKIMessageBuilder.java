...
public class ProtectedPKIMessageBuilder {
    ...
    public ProtectedPKIMessage build(ContentSigner contentSigner) {
        ...
        try {
            ...
            throw new CMPException(AbstractC0000a.m8d(e2, new StringBuilder("unable to encode signature input: ")), e2);
        }
    }
    ...
    public ProtectedPKIMessage build(MacCalculator macCalculator) {
        ...
        try {
            ...
            throw new CMPException(AbstractC0000a.m8d(e2, new StringBuilder("unable to encode MAC input: ")), e2);
        }
    }
}
