...
public class JceSymmetricKeyWrapper extends SymmetricKeyWrapper {
    ...
    public static AlgorithmIdentifier determineKeyEncAlg(String str, int i2) {
    ...
    public byte[] generateWrappedKey(GenericKey genericKey) {
        ...
        try {
            ...
            throw new OperatorException(AbstractC0000a.m19o(e2, new StringBuilder("cannot wrap key: ")), e2);
        }
    }
