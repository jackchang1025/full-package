...
public class DSTU4145Params extends ASN1Object {
    private static final byte[] DEFAULT_DKE = {-87, -42, -21, 69, -15, 60, 112, -126, DerValue.TAG_CONTEXT, -60, -106, 123, 35, 31, 94, -83, -10, 88, -21, -92, DerValue.TAG_PRIVATE, 55, 41, 29, 56, -39, 107, -16, 37, -54, 78, DerValue.tag_UtcTime, -8, -23, 114, 13, -58, 21, -76, 58, 40, -105, 95, 11, -63, -34, -93, 100, 56, -75, 100, -22, 44, DerValue.tag_UtcTime, -97, -48, 18, 62, 109, -72, -6, -59, 121, 4};
    private byte[] dke;
    ...
    public static DSTU4145Params getInstance(Object obj) {
        ...
        if (aSN1Sequence.size() == 2) {
            byte[] m1006D = AbstractC0413b.m1006D(aSN1Sequence, 1);
            dSTU4145Params.dke = m1006D;
            if (m1006D.length != DEFAULT_DKE.length) {
                throw new IllegalArgumentException("object parse error");
            }
        }
