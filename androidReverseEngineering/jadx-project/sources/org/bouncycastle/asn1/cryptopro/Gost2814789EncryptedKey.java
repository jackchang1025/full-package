...
public class Gost2814789EncryptedKey extends ASN1Object {
    ...
    private Gost2814789EncryptedKey(ASN1Sequence aSN1Sequence) {
        if (aSN1Sequence.size() == 2) {
            this.encryptedKey = AbstractC0413b.m1004B(aSN1Sequence, 0);
            this.macKey = AbstractC0413b.m1004B(aSN1Sequence, 1);
            this.maskKey = null;
        } else {
            if (aSN1Sequence.size() != 3) {
                throw new IllegalArgumentException(AbstractC0413b.m1012f(aSN1Sequence, new StringBuilder("unknown sequence length: ")));
            }
            this.encryptedKey = AbstractC0413b.m1004B(aSN1Sequence, 0);
            ...
            this.macKey = AbstractC0413b.m1004B(aSN1Sequence, 2);
        }
    }
