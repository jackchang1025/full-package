...
public class BEROctetString extends ASN1OctetString {
    ...
    public static byte[] flattenOctetStrings(ASN1OctetString[] aSN1OctetStringArr) {
        ...
        for (ASN1OctetString aSN1OctetString : aSN1OctetStringArr) {
            i2 += aSN1OctetString.string.length;
        }
    ...
    public int encodedLength(boolean z2) {
        ...
        if (this.elements == null) {
            ...
            int i4 = length / i3;
            int encodedLength = i2 + (DEROctetString.encodedLength(true, i3) * i4);
        ...
        while (true) {
            ...
            i2 += aSN1OctetStringArr[i5].encodedLength(true);
            i5++;
        }
    }
    ...
    public BEROctetString(ASN1OctetString[] aSN1OctetStringArr, int i2) {
        this(flattenOctetStrings(aSN1OctetStringArr), aSN1OctetStringArr, i2);
    }
}
