...
public class X9Curve extends ASN1Object implements X9ObjectIdentifiers {
    ...
    public X9Curve(X9FieldID x9FieldID, BigInteger bigInteger, BigInteger bigInteger2, ASN1Sequence aSN1Sequence) {
        ...
        if (identifier.equals((ASN1Primitive) X9ObjectIdentifiers.prime_field)) {
            f2m = new ECCurve.Fp(((ASN1Integer) x9FieldID.getParameters()).getValue(), new BigInteger(1, AbstractC0413b.m1006D(aSN1Sequence, 0)), new BigInteger(1, AbstractC0413b.m1006D(aSN1Sequence, 1)), bigInteger, bigInteger2);
        } else {
            ...
            f2m = new ECCurve.F2m(intValueExact2, i2, i3, intValueExact, new BigInteger(1, AbstractC0413b.m1006D(aSN1Sequence, 0)), new BigInteger(1, AbstractC0413b.m1006D(aSN1Sequence, 1)), bigInteger, bigInteger2);
        }
        this.curve = f2m;
