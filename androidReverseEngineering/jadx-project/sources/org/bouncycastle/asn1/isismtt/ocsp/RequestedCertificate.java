...
public class RequestedCertificate extends ASN1Object implements ASN1Choice {
    ...
    public byte[] getCertificateBytes() {
        ...
        try {
            ...
            throw new IllegalStateException(AbstractC0000a.m13i("can't decode certificate: ", e2));
        }
    }
    ...
    private RequestedCertificate(ASN1TaggedObject aSN1TaggedObject) {
        if (aSN1TaggedObject.getTagNo() == 0) {
            ...
            if (aSN1TaggedObject.getTagNo() != 1) {
                throw new IllegalArgumentException(AbstractC0413b.m1013g(aSN1TaggedObject, new StringBuilder("unknown tag number: ")));
            }
