...
public class X509Name extends ASN1Object {
    ...
    /* renamed from: C */
    public static final ASN1ObjectIdentifier f1099C;
    ...
    /* renamed from: E */
    public static final ASN1ObjectIdentifier f1100E;
    ...
    /* renamed from: L */
    public static final ASN1ObjectIdentifier f1101L;
    public static final ASN1ObjectIdentifier NAME;
    public static final ASN1ObjectIdentifier NAME_AT_BIRTH;

    /* renamed from: O */
    public static final ASN1ObjectIdentifier f1102O;
    ...
    /* renamed from: T */
    public static final ASN1ObjectIdentifier f1103T;
    ...
    private ASN1ObjectIdentifier decodeOID(String str, Hashtable hashtable) {
        ...
        throw new IllegalArgumentException(AbstractC0000a.m16l("Unknown object id - ", trim, " - passed to distinguished name"));
    }
        ...
        try {
            ...
            while (i2 != i3) {
                ...
                while (true) {
                    ...
                    if (!zArr[i5] && aSN1ObjectIdentifier.equals((ASN1Primitive) x509Name.ordering.elementAt(i5)) && equivalentStrings(str, (String) x509Name.values.elementAt(i5))) {
                        zArr[i5] = true;
                        z2 = true;
                        break;
                    }
    ...
    public boolean equals(Object obj, boolean z2) {
        ...
        try {
            ...
            for (int i2 = 0; i2 < size; i2++) {
                if (!((ASN1ObjectIdentifier) this.ordering.elementAt(i2)).equals((ASN1Primitive) x509Name.ordering.elementAt(i2)) || !equivalentStrings((String) this.values.elementAt(i2), (String) x509Name.values.elementAt(i2))) {
                    return false;
                }
            }
            return true;
