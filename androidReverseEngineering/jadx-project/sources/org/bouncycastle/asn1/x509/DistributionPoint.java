...
import android.sun.security.x509.IssuingDistributionPointExtension;
...
public class DistributionPoint extends ASN1Object {
    ...
    public DistributionPoint(ASN1Sequence aSN1Sequence) {
        for (int i2 = 0; i2 != aSN1Sequence.size(); i2++) {
            ...
            if (tagNo == 0) {
                ...
                if (tagNo != 2) {
                    throw new IllegalArgumentException(AbstractC0413b.m1013g(aSN1TaggedObject, new StringBuilder("Unknown tag encountered in structure: ")));
                }
    ...
    public static DistributionPoint getInstance(Object obj) {
        ...
        throw new IllegalArgumentException(AbstractC0000a.m10f(obj, "Invalid DistributionPoint: "));
    }
    ...
    public String toString() {
        ...
        ReasonFlags reasonFlags = this.reasons;
        if (reasonFlags != null) {
            appendObject(stringBuffer, lineSeparator, IssuingDistributionPointExtension.REASONS, reasonFlags.toString());
        }
        GeneralNames generalNames = this.cRLIssuer;
        if (generalNames != null) {
