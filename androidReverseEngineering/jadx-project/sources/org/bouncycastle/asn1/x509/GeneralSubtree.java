        ...
        if (size != 1) {
            if (size == 2) {
                ...
                if (tagNo == 0) {
                    ...
                    throw new IllegalArgumentException(AbstractC0413b.m1013g(aSN1TaggedObject, new StringBuilder("Bad tag number: ")));
                }
            } else {
                if (size != 3) {
                ...
                if (aSN1TaggedObject2.getTagNo() != 0) {
                    throw new IllegalArgumentException(AbstractC0413b.m1013g(aSN1TaggedObject2, new StringBuilder("Bad tag number for 'minimum': ")));
                }
                ...
                if (aSN1TaggedObject.getTagNo() != 1) {
                    throw new IllegalArgumentException(AbstractC0413b.m1013g(aSN1TaggedObject, new StringBuilder("Bad tag number for 'maximum': ")));
                }
            }
