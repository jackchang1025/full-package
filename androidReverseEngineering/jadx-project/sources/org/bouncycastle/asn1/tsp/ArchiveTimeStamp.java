...
public class ArchiveTimeStamp extends ASN1Object {
    ...
    private ArchiveTimeStamp(ASN1Sequence aSN1Sequence) {
        if (aSN1Sequence.size() < 1 || aSN1Sequence.size() > 4) {
            throw new IllegalArgumentException(AbstractC0413b.m1012f(aSN1Sequence, new StringBuilder("wrong sequence size in constructor: ")));
        }
        ...
        for (int i2 = 0; i2 < aSN1Sequence.size() - 1; i2++) {
            ...
            if (objectAt instanceof ASN1TaggedObject) {
                ...
                if (tagNo == 0) {
                    ...
                    if (tagNo != 2) {
                        throw new IllegalArgumentException(AbstractC0413b.m1013g(aSN1TaggedObject, new StringBuilder("invalid tag no in constructor: ")));
                    }
