...
public final class DERMacData {
    ...
    public static final class Builder {
        ...
        public DERMacData build() {
            int i2 = C05801.$SwitchMap$org$bouncycastle$crypto$util$DERMacData$Type[this.type.ordinal()];
            C05801 c05801 = null;
            if (i2 == 1 || i2 == 2) {
                return new DERMacData(concatenate(this.type.getHeader(), DerUtil.toByteArray(this.idU), DerUtil.toByteArray(this.idV), DerUtil.toByteArray(this.ephemDataU), DerUtil.toByteArray(this.ephemDataV), this.text), c05801);
            }
            if (i2 == 3 || i2 == 4) {
                return new DERMacData(concatenate(this.type.getHeader(), DerUtil.toByteArray(this.idV), DerUtil.toByteArray(this.idU), DerUtil.toByteArray(this.ephemDataV), DerUtil.toByteArray(this.ephemDataU), this.text), c05801);
            }
    ...
    public /* synthetic */ DERMacData(byte[] bArr, C05801 c05801) {
        this(bArr);
    }
}
