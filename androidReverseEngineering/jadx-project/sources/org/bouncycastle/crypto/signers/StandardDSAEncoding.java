...
public class StandardDSAEncoding implements DSAEncoding {
    ...
    public BigInteger decodeValue(BigInteger bigInteger, ASN1Sequence aSN1Sequence, int i2) {
        return checkValue(bigInteger, ((ASN1Integer) aSN1Sequence.getObjectAt(i2)).getValue());
    }
