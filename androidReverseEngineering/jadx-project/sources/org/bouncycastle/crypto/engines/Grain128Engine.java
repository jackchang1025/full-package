...
public class Grain128Engine implements StreamCipher {
    ...
    private void setKey(byte[] bArr, byte[] bArr2) {
        ...
        while (true) {
            ...
            int i5 = i3 + 2;
            int i6 = i3 + 1;
            iArr[i2] = (bArr3[i3] & 255) | (bArr3[i4] << DerValue.tag_GeneralizedTime) | ((bArr3[i5] << Tnaf.POW_2_WIDTH) & 16711680) | ((bArr3[i6] << 8) & MotionEventCompat.ACTION_POINTER_INDEX_MASK);
            int[] iArr2 = this.lfsr;
            byte[] bArr4 = this.workingIV;
            iArr2[i2] = (bArr4[i3] & 255) | (bArr4[i4] << DerValue.tag_GeneralizedTime) | ((bArr4[i5] << Tnaf.POW_2_WIDTH) & 16711680) | ((bArr4[i6] << 8) & MotionEventCompat.ACTION_POINTER_INDEX_MASK);
            i3 += 4;
            i2++;
        }
    }
