...
public class SkipjackEngine implements BlockCipher {
    ...
    /* renamed from: g */
    private int m1219g(int i2, int i3) {
        int i4 = (i3 >> 8) & 255;
        int i5 = i3 & 255;
        short[] sArr = ftable;
    ...
    /* renamed from: h */
    private int m1220h(int i2, int i3) {
        int i4 = i3 & 255;
        int i5 = (i3 >> 8) & 255;
        short[] sArr = ftable;
    ...
    public int decryptBlock(byte[] bArr, int i2, byte[] bArr2, int i3) {
        ...
        for (int i9 = 0; i9 < 2; i9++) {
            int i10 = 0;
            while (i10 < 8) {
                int m1220h = m1220h(i8, i5);
                int i11 = (i6 ^ m1220h) ^ (i8 + 1);
                i8--;
                i10++;
                int i12 = i7;
                i7 = i4;
    ...
    public void init(boolean z2, CipherParameters cipherParameters) {
        if (!(cipherParameters instanceof KeyParameter)) {
            throw new IllegalArgumentException(AbstractC0413b.m1014h(cipherParameters, "invalid parameter passed to SKIPJACK init - "));
        }
