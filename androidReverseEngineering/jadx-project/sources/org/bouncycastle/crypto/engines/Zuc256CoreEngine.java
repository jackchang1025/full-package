...
public class Zuc256CoreEngine extends Zuc128CoreEngine {
    private byte[] theD;
    private static final byte[] EK_d = {34, 47, 36, 42, 109, DerValue.TAG_APPLICATION, DerValue.TAG_APPLICATION, DerValue.TAG_APPLICATION, DerValue.TAG_APPLICATION, DerValue.TAG_APPLICATION, DerValue.TAG_APPLICATION, DerValue.TAG_APPLICATION, DerValue.TAG_APPLICATION, 82, Tnaf.POW_2_WIDTH, 48};
    private static final byte[] EK_d32 = {34, 47, 37, 42, 109, DerValue.TAG_APPLICATION, DerValue.TAG_APPLICATION, DerValue.TAG_APPLICATION, DerValue.TAG_APPLICATION, DerValue.TAG_APPLICATION, DerValue.TAG_APPLICATION, DerValue.TAG_APPLICATION, DerValue.TAG_APPLICATION, 82, Tnaf.POW_2_WIDTH, 48};
    private static final byte[] EK_d64 = {35, 47, 36, 42, 109, DerValue.TAG_APPLICATION, DerValue.TAG_APPLICATION, DerValue.TAG_APPLICATION, DerValue.TAG_APPLICATION, DerValue.TAG_APPLICATION, DerValue.TAG_APPLICATION, DerValue.TAG_APPLICATION, DerValue.TAG_APPLICATION, 82, Tnaf.POW_2_WIDTH, 48};
    private static final byte[] EK_d128 = {35, 47, 37, 42, 109, DerValue.TAG_APPLICATION, DerValue.TAG_APPLICATION, DerValue.TAG_APPLICATION, DerValue.TAG_APPLICATION, DerValue.TAG_APPLICATION, DerValue.TAG_APPLICATION, DerValue.TAG_APPLICATION, DerValue.TAG_APPLICATION, 82, Tnaf.POW_2_WIDTH, 48};
    ...
    public Zuc256CoreEngine(int i2) {
        if (i2 == 32) {
            ...
            if (i2 != 128) {
                throw new IllegalArgumentException(AbstractC0000a.m11g("Unsupported length: ", i2));
            }
            this.theD = EK_d128;
        }
    }
