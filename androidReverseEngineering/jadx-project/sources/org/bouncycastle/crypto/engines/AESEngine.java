...
public class AESEngine implements BlockCipher {
    ...
    private static final int f2336m1 = -2139062144;
    ...
    private static int FFmulX(int i2) {
        return (((i2 & f2336m1) >>> 7) * 27) ^ ((m2 & i2) << 1);
    }
    ...
    private void decryptBlock(byte[] bArr, int i2, byte[] bArr2, int i3, int[][] iArr) {
        ...
        for (int i10 = 1; i8 > i10; i10 = 1) {
            ...
            int shift7 = (((iArr3[shift3 & 255] ^ shift(iArr3[(shift2 >> 8) & 255], 24)) ^ shift(iArr3[(shift >> 16) & 255], 16)) ^ shift(iArr3[(i12 >> 24) & 255], 8)) ^ iArr[i11][2];
            int i13 = i11 - 1;
        ...
        int[] iArr4 = Tinv0;
        int shift8 = (((iArr4[i5 & 255] ^ shift(iArr4[(i9 >> 8) & 255], 24)) ^ shift(iArr4[(i7 >> 16) & 255], 16)) ^ shift(iArr4[(i6 >> 24) & 255], 8)) ^ iArr[i8][0];
        int shift9 = (((iArr4[i6 & 255] ^ shift(iArr4[(i5 >> 8) & 255], 24)) ^ shift(iArr4[(i9 >> 16) & 255], 16)) ^ shift(iArr4[(i7 >> 24) & 255], 8)) ^ iArr[i8][1];
        int shift10 = (((iArr4[i7 & 255] ^ shift(iArr4[(i6 >> 8) & 255], 24)) ^ shift(iArr4[(i5 >> 16) & 255], 16)) ^ shift(iArr4[(i9 >> 24) & 255], 8)) ^ iArr[i8][2];
        int shift11 = (((iArr4[i9 & 255] ^ shift(iArr4[(i7 >> 8) & 255], 24)) ^ shift(iArr4[(i6 >> 16) & 255], 16)) ^ shift(iArr4[(i5 >> 24) & 255], 8)) ^ iArr[i8][3];
        byte[] bArr3 = Si;
        int i14 = bArr3[shift8 & 255] & 255;
        byte[] bArr4 = this.f1201s;
        int i15 = ((i14 ^ ((bArr4[(shift11 >> 8) & 255] & 255) << 8)) ^ ((bArr4[(shift10 >> 16) & 255] & 255) << 16)) ^ (bArr3[(shift9 >> 24) & 255] << DerValue.tag_GeneralizedTime);
        int[] iArr5 = iArr[0];
        int i16 = i15 ^ iArr5[0];
        int i17 = ((((bArr4[shift9 & 255] & 255) ^ ((bArr4[(shift8 >> 8) & 255] & 255) << 8)) ^ ((bArr3[(shift11 >> 16) & 255] & 255) << 16)) ^ (bArr4[(shift10 >> 24) & 255] << DerValue.tag_GeneralizedTime)) ^ iArr5[1];
        int i18 = (((((bArr3[(shift9 >> 8) & 255] & 255) << 8) ^ (bArr4[shift10 & 255] & 255)) ^ ((bArr3[(shift8 >> 16) & 255] & 255) << 16)) ^ (bArr4[(shift11 >> 24) & 255] << DerValue.tag_GeneralizedTime)) ^ iArr5[2];
        int i19 = ((((bArr3[shift11 & 255] & 255) ^ ((bArr4[(shift10 >> 8) & 255] & 255) << 8)) ^ ((bArr4[(shift9 >> 16) & 255] & 255) << 16)) ^ (bArr4[(shift8 >> 24) & 255] << DerValue.tag_GeneralizedTime)) ^ iArr5[3];
        Pack.intToLittleEndian(i16, bArr2, i3 + 0);
        Pack.intToLittleEndian(i17, bArr2, i3 + 4);
        Pack.intToLittleEndian(i18, bArr2, i3 + 8);
    ...
    private void encryptBlock(byte[] bArr, int i2, byte[] bArr2, int i3, int[][] iArr) {
        ...
        while (i9 < this.ROUNDS - i5) {
            int[] iArr3 = T0;
            int shift = (((shift(iArr3[(i6 >> 8) & 255], 24) ^ iArr3[i4 & 255]) ^ shift(iArr3[(i7 >> 16) & 255], 16)) ^ shift(iArr3[(i8 >> 24) & 255], 8)) ^ iArr[i9][c];
            int shift2 = (((shift(iArr3[(i7 >> 8) & 255], 24) ^ iArr3[i6 & 255]) ^ shift(iArr3[(i8 >> 16) & 255], 16)) ^ shift(iArr3[(i4 >> 24) & 255], 8)) ^ iArr[i9][i5];
            int shift3 = (((shift(iArr3[(i8 >> 8) & 255], 24) ^ iArr3[i7 & 255]) ^ shift(iArr3[(i4 >> 16) & 255], 16)) ^ shift(iArr3[(i6 >> 24) & 255], 8)) ^ iArr[i9][2];
            int shift4 = ((iArr3[i8 & 255] ^ shift(iArr3[(i4 >> 8) & 255], 24)) ^ shift(iArr3[(i6 >> 16) & 255], 16)) ^ shift(iArr3[(i7 >> 24) & 255], 8);
            int i10 = i9 + 1;
            ...
            int shift7 = (((iArr3[shift3 & 255] ^ shift(iArr3[(i11 >> 8) & 255], 24)) ^ shift(iArr3[(shift >> 16) & 255], 16)) ^ shift(iArr3[(shift2 >> 24) & 255], 8)) ^ iArr[i10][2];
            int shift8 = ((iArr3[i11 & 255] ^ shift(iArr3[(shift >> 8) & 255], 24)) ^ shift(iArr3[(shift2 >> 16) & 255], 16)) ^ shift(iArr3[(shift3 >> 24) & 255], 8);
            int i12 = i10 + 1;
            i8 = shift8 ^ iArr[i10][3];
            i4 = shift5;
            i6 = shift6;
            i7 = shift7;
            i5 = 1;
        ...
        int[] iArr4 = T0;
        int shift9 = (((iArr4[i4 & 255] ^ shift(iArr4[(i6 >> 8) & 255], 24)) ^ shift(iArr4[(i7 >> 16) & 255], 16)) ^ shift(iArr4[(i8 >> 24) & 255], 8)) ^ iArr[i9][0];
        int shift10 = (((iArr4[i6 & 255] ^ shift(iArr4[(i7 >> 8) & 255], 24)) ^ shift(iArr4[(i8 >> 16) & 255], 16)) ^ shift(iArr4[(i4 >> 24) & 255], 8)) ^ iArr[i9][1];
        int shift11 = (((iArr4[i7 & 255] ^ shift(iArr4[(i8 >> 8) & 255], 24)) ^ shift(iArr4[(i4 >> 16) & 255], 16)) ^ shift(iArr4[(i6 >> 24) & 255], 8)) ^ iArr[i9][2];
        int shift12 = (((iArr4[i8 & 255] ^ shift(iArr4[(i4 >> 8) & 255], 24)) ^ shift(iArr4[(i6 >> 16) & 255], 16)) ^ shift(iArr4[(i7 >> 24) & 255], 8)) ^ iArr[i9][3];
        byte[] bArr3 = f1200S;
        int i13 = (bArr3[shift9 & 255] & 255) ^ ((bArr3[(shift10 >> 8) & 255] & 255) << 8);
        byte[] bArr4 = this.f1201s;
        int i14 = (i13 ^ ((bArr4[(shift11 >> 16) & 255] & 255) << 16)) ^ (bArr4[(shift12 >> 24) & 255] << DerValue.tag_GeneralizedTime);
        int[] iArr5 = iArr[i9 + 1];
        int i15 = i14 ^ iArr5[0];
        int i16 = ((((bArr4[shift10 & 255] & 255) ^ ((bArr3[(shift11 >> 8) & 255] & 255) << 8)) ^ ((bArr3[(shift12 >> 16) & 255] & 255) << 16)) ^ (bArr4[(shift9 >> 24) & 255] << DerValue.tag_GeneralizedTime)) ^ iArr5[1];
        int i17 = (((((bArr3[(shift12 >> 8) & 255] & 255) << 8) ^ (bArr4[shift11 & 255] & 255)) ^ ((bArr3[(shift9 >> 16) & 255] & 255) << 16)) ^ (bArr3[(shift10 >> 24) & 255] << DerValue.tag_GeneralizedTime)) ^ iArr5[2];
        int i18 = ((((bArr4[shift12 & 255] & 255) ^ ((bArr4[(shift9 >> 8) & 255] & 255) << 8)) ^ ((bArr4[(shift10 >> 16) & 255] & 255) << 16)) ^ (bArr3[(shift11 >> 24) & 255] << DerValue.tag_GeneralizedTime)) ^ iArr5[3];
        Pack.intToLittleEndian(i15, bArr2, i3 + 0);
        Pack.intToLittleEndian(i16, bArr2, i3 + 4);
        Pack.intToLittleEndian(i17, bArr2, i3 + 8);
        Pack.intToLittleEndian(i18, bArr2, i3 + 12);
    }
    ...
    public void init(boolean z2, CipherParameters cipherParameters) {
        ...
        if (z2) {
            this.f1201s = Arrays.clone(f1200S);
        } else {
            this.f1201s = Arrays.clone(Si);
        }
    }
