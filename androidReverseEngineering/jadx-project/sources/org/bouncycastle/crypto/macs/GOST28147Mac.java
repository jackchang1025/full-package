...
public class GOST28147Mac implements Mac {
    ...
    private void gost28147MacFunc(int[] iArr, byte[] bArr, int i2, byte[] bArr2, int i3) {
        ...
        for (int i4 = 0; i4 < 2; i4++) {
            int i5 = 0;
            while (i5 < 8) {
                int gost28147_mainStep = bytesToint2 ^ gost28147_mainStep(bytesToint, iArr[i5]);
                i5++;
                int i6 = bytesToint;
    ...
    private void recursiveInit(CipherParameters cipherParameters) {
        ...
        if (cipherParameters instanceof ParametersWithSBox) {
            ...
            System.arraycopy(parametersWithSBox.getSBox(), 0, this.f1251S, 0, parametersWithSBox.getSBox().length);
    ...
    public int doFinal(byte[] bArr, int i2) {
        ...
        int i4 = this.macSize;
        System.arraycopy(bArr4, length - i4, bArr, i2, i4);
        reset();
        return this.macSize;
    }
