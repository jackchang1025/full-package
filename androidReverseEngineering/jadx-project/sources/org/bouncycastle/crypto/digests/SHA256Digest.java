...
public class SHA256Digest extends GeneralDigest implements EncodableDigest {
    ...
    private void copyIn(SHA256Digest sHA256Digest) {
        ...
        int[] iArr = sHA256Digest.f1189X;
        System.arraycopy(iArr, 0, this.f1189X, 0, iArr.length);
    ...
    public byte[] getEncodedState() {
        ...
        for (int i2 = 0; i2 != this.xOff; i2++) {
            Pack.intToBigEndian(this.f1189X[i2], bArr, (i2 * 4) + 52);
        }
        return bArr;
    }
    ...
    public void processBlock() {
        for (int i2 = 16; i2 <= 63; i2++) {
            int[] iArr = this.f1189X;
            int Theta1 = Theta1(iArr[i2 - 2]);
            int[] iArr2 = this.f1189X;
            iArr[i2] = Theta1 + iArr2[i2 - 7] + Theta0(iArr2[i2 - 15]) + this.f1189X[i2 - 16];
        }
        int i3 = this.H1;
        int i4 = this.H2;
        int i5 = this.H3;
        ...
        for (int i12 = 0; i12 < 8; i12++) {
            ...
            int[] iArr3 = f1188K;
            int i13 = Sum1 + iArr3[i11] + this.f1189X[i11] + i10;
            int i14 = i6 + i13;
            int Sum0 = Sum0(i3) + Maj(i3, i4, i5) + i13;
            int i15 = i11 + 1;
            int Sum12 = Sum1(i14) + Ch(i14, i7, i8) + iArr3[i15] + this.f1189X[i15] + i9;
            int i16 = i5 + Sum12;
            int Sum02 = Sum0(Sum0) + Maj(Sum0, i3, i4) + Sum12;
            int i17 = i15 + 1;
            int Sum13 = Sum1(i16) + Ch(i16, i14, i7) + iArr3[i17] + this.f1189X[i17] + i8;
            int i18 = i4 + Sum13;
            int Sum03 = Sum0(Sum02) + Maj(Sum02, Sum0, i3) + Sum13;
            int i19 = i17 + 1;
            int Sum14 = Sum1(i18) + Ch(i18, i16, i14) + iArr3[i19] + this.f1189X[i19] + i7;
            int i20 = i3 + Sum14;
            int Sum04 = Sum0(Sum03) + Maj(Sum03, Sum02, Sum0) + Sum14;
            int i21 = i19 + 1;
            int Sum15 = Sum1(i20) + Ch(i20, i18, i16) + iArr3[i21] + this.f1189X[i21] + i14;
            i10 = Sum0 + Sum15;
            i6 = Sum0(Sum04) + Maj(Sum04, Sum03, Sum02) + Sum15;
            int i22 = i21 + 1;
            int Sum16 = Sum1(i10) + Ch(i10, i20, i18) + iArr3[i22] + this.f1189X[i22] + i16;
            i9 = Sum02 + Sum16;
            i5 = Sum0(i6) + Maj(i6, Sum04, Sum03) + Sum16;
            int i23 = i22 + 1;
            int Sum17 = Sum1(i9) + Ch(i9, i10, i20) + iArr3[i23] + this.f1189X[i23] + i18;
            i8 = Sum03 + Sum17;
            i4 = Sum0(i5) + Maj(i5, i6, Sum04) + Sum17;
            int i24 = i23 + 1;
            int Sum18 = Sum1(i8) + Ch(i8, i9, i10) + iArr3[i24] + this.f1189X[i24] + i20;
            i7 = Sum04 + Sum18;
    ...
    public SHA256Digest(byte[] bArr) {
        ...
        for (int i2 = 0; i2 != this.xOff; i2++) {
            this.f1189X[i2] = Pack.bigEndianToInt(bArr, (i2 * 4) + 52);
        }
    }
}
