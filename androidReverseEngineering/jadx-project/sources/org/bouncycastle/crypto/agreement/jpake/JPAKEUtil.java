...
public class JPAKEUtil {
    ...
    public static void validateParticipantIdsDiffer(String str, String str2) {
        if (str.equals(str2)) {
            throw new CryptoException(AbstractC0000a.m16l("Both participants are using the same participantId (", str, "). This is not allowed. Each participant must use a unique participantId."));
        }
    }
