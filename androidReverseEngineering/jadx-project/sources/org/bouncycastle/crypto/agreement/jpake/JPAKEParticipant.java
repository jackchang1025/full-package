...
public class JPAKEParticipant {
    ...
    /* renamed from: b */
    private BigInteger f1124b;
    private final Digest digest;

    /* renamed from: g */
    private final BigInteger f1125g;
    ...
    /* renamed from: p */
    private final BigInteger f1126p;
    private final String participantId;
    private String partnerParticipantId;
    private char[] password;

    /* renamed from: q */
    private final BigInteger f1127q;
    ...
    public BigInteger calculateKeyingMaterial() {
        ...
        this.password = null;
        BigInteger calculateKeyingMaterial = JPAKEUtil.calculateKeyingMaterial(this.f1126p, this.f1127q, this.gx4, this.x2, calculateS, this.f1124b);
        this.x1 = null;
        this.x2 = null;
        this.f1124b = null;
        this.state = 50;
    ...
    public JPAKERound1Payload createRound1PayloadToSend() {
        ...
        this.x1 = JPAKEUtil.generateX1(this.f1127q, this.random);
        this.x2 = JPAKEUtil.generateX2(this.f1127q, this.random);
        this.gx1 = JPAKEUtil.calculateGx(this.f1126p, this.f1125g, this.x1);
        this.gx2 = JPAKEUtil.calculateGx(this.f1126p, this.f1125g, this.x2);
        BigInteger[] calculateZeroKnowledgeProof = JPAKEUtil.calculateZeroKnowledgeProof(this.f1126p, this.f1127q, this.f1125g, this.gx1, this.x1, this.participantId, this.digest, this.random);
        BigInteger[] calculateZeroKnowledgeProof2 = JPAKEUtil.calculateZeroKnowledgeProof(this.f1126p, this.f1127q, this.f1125g, this.gx2, this.x2, this.participantId, this.digest, this.random);
        this.state = 10;
    ...
    public JPAKERound2Payload createRound2PayloadToSend() {
        ...
        BigInteger calculateGA = JPAKEUtil.calculateGA(this.f1126p, this.gx1, this.gx3, this.gx4);
        BigInteger calculateX2s = JPAKEUtil.calculateX2s(this.f1127q, this.x2, JPAKEUtil.calculateS(this.password));
        BigInteger calculateA = JPAKEUtil.calculateA(this.f1126p, this.f1127q, calculateGA, calculateX2s);
        BigInteger[] calculateZeroKnowledgeProof = JPAKEUtil.calculateZeroKnowledgeProof(this.f1126p, this.f1127q, calculateGA, calculateA, calculateX2s, this.participantId, this.digest, this.random);
        this.state = 30;
    ...
    public void validateRound1PayloadReceived(JPAKERound1Payload jPAKERound1Payload) {
        ...
        JPAKEUtil.validateZeroKnowledgeProof(this.f1126p, this.f1127q, this.f1125g, this.gx3, knowledgeProofForX1, jPAKERound1Payload.getParticipantId(), this.digest);
        JPAKEUtil.validateZeroKnowledgeProof(this.f1126p, this.f1127q, this.f1125g, this.gx4, knowledgeProofForX2, jPAKERound1Payload.getParticipantId(), this.digest);
        this.state = 20;
    }
    ...
    public void validateRound2PayloadReceived(JPAKERound2Payload jPAKERound2Payload) {
        ...
        BigInteger calculateGA = JPAKEUtil.calculateGA(this.f1126p, this.gx3, this.gx1, this.gx2);
        this.f1124b = jPAKERound2Payload.getA();
        ...
        JPAKEUtil.validateZeroKnowledgeProof(this.f1126p, this.f1127q, calculateGA, this.f1124b, knowledgeProofForX2s, jPAKERound2Payload.getParticipantId(), this.digest);
        this.state = 40;
    }
    ...
    public JPAKEParticipant(String str, char[] cArr, JPAKEPrimeOrderGroup jPAKEPrimeOrderGroup, Digest digest, SecureRandom secureRandom) {
        ...
        this.f1126p = jPAKEPrimeOrderGroup.getP();
        this.f1127q = jPAKEPrimeOrderGroup.getQ();
        this.f1125g = jPAKEPrimeOrderGroup.getG();
        this.digest = digest;
