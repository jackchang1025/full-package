...
public class Zuc {
    ...
    public static class Mappings extends SymmetricAlgorithmProvider {
        ...
        public void configure(ConfigurableProvider configurableProvider) {
            ...
            String str = PREFIX;
            AbstractC0413b.m1030x(AbstractC0413b.m1016j(AbstractC0413b.m1016j(AbstractC0413b.m1016j(AbstractC0413b.m1016j(AbstractC0413b.m1016j(AbstractC0413b.m1016j(AbstractC0413b.m1016j(sb, str, "$Zuc128", configurableProvider, "Cipher.ZUC-128"), str, "$KeyGen128", configurableProvider, "KeyGenerator.ZUC-128"), str, "$AlgParams", configurableProvider, "AlgorithmParameters.ZUC-128"), str, "$Zuc256", configurableProvider, "Cipher.ZUC-256"), str, "$KeyGen256", configurableProvider, "KeyGenerator.ZUC-256"), str, "$AlgParams", configurableProvider, "AlgorithmParameters.ZUC-256"), str, "$ZucMac128", configurableProvider, "Mac.ZUC-128"), str, "$ZucMac256", configurableProvider, "Mac.ZUC-256");
            configurableProvider.addAlgorithm("Mac.ZUC-256-32", AbstractC0413b.m1015i(configurableProvider, "Mac.ZUC-256-64", AbstractC0413b.m1015i(configurableProvider, "Alg.Alias.Mac.ZUC-256-128", "ZUC-256", str, "$ZucMac256_64"), str, "$ZucMac256_32"));
        }
    }
