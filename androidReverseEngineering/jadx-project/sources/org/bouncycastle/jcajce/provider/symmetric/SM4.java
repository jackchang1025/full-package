...
public final class SM4 {
    ...
    public static class Mappings extends SymmetricAlgorithmProvider {
        ...
        public void configure(ConfigurableProvider configurableProvider) {
            ...
            String str = PREFIX;
            addCMacAlgorithm(configurableProvider, "SM4", AbstractC0000a.m18n(AbstractC0413b.m1016j(AbstractC0413b.m1016j(AbstractC0413b.m1016j(AbstractC0413b.m1016j(sb, str, "$AlgParams", configurableProvider, "AlgorithmParameters.SM4"), str, "$AlgParamGen", configurableProvider, "AlgorithmParameterGenerator.SM4"), str, "$ECB", configurableProvider, "Cipher.SM4"), str, "$KeyGen", configurableProvider, "KeyGenerator.SM4"), str, "$CMAC"), AbstractC0000a.m30z(str, "$KeyGen"));
            addGMacAlgorithm(configurableProvider, "SM4", AbstractC0000a.m30z(str, "$GMAC"), AbstractC0000a.m30z(str, "$KeyGen"));
            addPoly1305Algorithm(configurableProvider, "SM4", AbstractC0000a.m30z(str, "$Poly1305"), AbstractC0000a.m30z(str, "$Poly1305KeyGen"));
        }
    }
