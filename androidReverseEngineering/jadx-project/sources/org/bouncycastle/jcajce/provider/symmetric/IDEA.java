...
public final class IDEA {
    ...
    public static class Mappings extends AlgorithmProvider {
        ...
        public void configure(ConfigurableProvider configurableProvider) {
            ...
            AbstractC0413b.m1030x(new StringBuilder(), str, "$ECB", configurableProvider, "Cipher.IDEA");
            ...
            AbstractC0413b.m1032z(AbstractC0413b.m1017k(AbstractC0413b.m1021o(configurableProvider, "KeyGenerator", aSN1ObjectIdentifier, AbstractC0000a.m18n(AbstractC0413b.m1016j(AbstractC0413b.m1016j(new StringBuilder(), str, "$PBEWithSHAAndIDEA", configurableProvider, "Cipher.PBEWITHSHAANDIDEA-CBC"), str, "$KeyGen", configurableProvider, "KeyGenerator.IDEA"), str, "$KeyGen"), str), "$PBEWithSHAAndIDEAKeyGen", configurableProvider, "SecretKeyFactory.PBEWITHSHAANDIDEA-CBC", str), "$Mac", configurableProvider, "Mac.IDEAMAC");
            configurableProvider.addAlgorithm("Mac.IDEAMAC/CFB8", AbstractC0413b.m1015i(configurableProvider, "Alg.Alias.Mac.IDEA", "IDEAMAC", str, "$CFB8Mac"));
