...
public final class GOST28147 {
    ...
    public static abstract class BaseAlgParams extends BaseAlgorithmParameters {
        ...
        public static ASN1ObjectIdentifier getSBoxOID(String str) {
            ...
            throw new IllegalArgumentException(AbstractC0000a.m15k("Unknown SBOX name: ", str));
        }
        ...
        public final byte[] engineGetEncoded(String str) {
            ...
            throw new IOException(AbstractC0000a.m15k("Unknown parameter format: ", str));
        }
        ...
        public final void engineInit(byte[] bArr, String str) {
            ...
            if (isASN1FormatString(str)) {
                try {
                    ...
                    throw new IOException(AbstractC0000a.m9e(e3, new StringBuilder("Parameter parsing failed: ")));
                }
            }
            throw new IOException(AbstractC0000a.m15k("Unknown parameter format: ", str));
        }
    ...
    public static class Mappings extends AlgorithmProvider {
        ...
        public void configure(ConfigurableProvider configurableProvider) {
            ...
            String str = PREFIX;
            AbstractC0413b.m1030x(sb, str, "$ECB", configurableProvider, "Cipher.GOST28147");
            ...
            sb3.append(str);
            AbstractC0413b.m1032z(sb3, "$KeyGen", configurableProvider, "KeyGenerator.GOST28147");
            ...
            sb4.append(str);
            StringBuilder m1017k = AbstractC0413b.m1017k(sb4, "$AlgParams", configurableProvider, "AlgorithmParameters.GOST28147", str);
            m1017k.append("$AlgParamGen");
            configurableProvider.addAlgorithm("AlgorithmParameterGenerator.GOST28147", m1017k.toString());
            StringBuilder m1019m = AbstractC0413b.m1019m(AbstractC0413b.m1019m(new StringBuilder("Alg.Alias.AlgorithmParameters."), aSN1ObjectIdentifier, configurableProvider, "GOST28147", "Alg.Alias.AlgorithmParameterGenerator."), aSN1ObjectIdentifier, configurableProvider, "GOST28147", "Cipher.");
            m1019m.append(CryptoProObjectIdentifiers.id_Gost28147_89_CryptoPro_KeyWrap);
            configurableProvider.addAlgorithm(m1019m.toString(), str + "$CryptoProWrap");
            StringBuilder sb5 = new StringBuilder("Cipher.");
            sb5.append(CryptoProObjectIdentifiers.id_Gost28147_89_None_KeyWrap);
            configurableProvider.addAlgorithm(sb5.toString(), str + "$GostWrap");
            StringBuilder sb6 = new StringBuilder();
            sb6.append(str);
            AbstractC0413b.m1032z(sb6, "$Mac", configurableProvider, "Mac.GOST28147MAC");
