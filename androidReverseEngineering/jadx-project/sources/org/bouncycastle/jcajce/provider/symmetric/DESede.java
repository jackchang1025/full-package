...
public final class DESede {
    ...
    public static class Mappings extends AlgorithmProvider {
        ...
        public void configure(ConfigurableProvider configurableProvider) {
            ...
            String str = PREFIX;
            AbstractC0413b.m1030x(sb, str, "$ECB", configurableProvider, "Cipher.DESEDE");
            ...
            AbstractC0413b.m1030x(new StringBuilder(), str, "$Wrap", configurableProvider, "Cipher.DESEDEWRAP");
            configurableProvider.addAlgorithm("Cipher", PKCSObjectIdentifiers.id_alg_CMS3DESwrap, str + "$Wrap");
            AbstractC0413b.m1030x(new StringBuilder(), str, "$RFC3211", configurableProvider, "Cipher.DESEDERFC3211WRAP");
            ...
            if (configurableProvider.hasAlgorithm(PKCS9Attribute.MESSAGE_DIGEST_STR, McElieceCCA2KeyGenParameterSpec.SHA1)) {
                configurableProvider.addAlgorithm("Cipher.PBEWITHSHAAND3-KEYTRIPLEDES-CBC", str + "$PBEWithSHAAndDES3Key");
                StringBuilder sb2 = new StringBuilder();
                sb2.append(str);
                AbstractC0413b.m1032z(sb2, "$PBEWithSHAAndDES2Key", configurableProvider, "Cipher.PBEWITHSHAAND2-KEYTRIPLEDES-CBC");
            ...
            configurableProvider.addAlgorithm(sb3.toString(), str + "$KeyGenerator3");
            StringBuilder sb4 = new StringBuilder();
            sb4.append(str);
            AbstractC0413b.m1032z(AbstractC0413b.m1017k(sb4, "$KeyGenerator", configurableProvider, "KeyGenerator.DESEDEWRAP", str), "$KeyFactory", configurableProvider, "SecretKeyFactory.DESEDE");
            configurableProvider.addAlgorithm("SecretKeyFactory", OIWObjectIdentifiers.desEDE, str + "$KeyFactory");
            AbstractC0413b.m1030x(AbstractC0413b.m1016j(new StringBuilder(), str, "$CMAC", configurableProvider, "Mac.DESEDECMAC"), str, "$CBCMAC", configurableProvider, "Mac.DESEDEMAC");
            configurableProvider.addAlgorithm("Mac.DESEDEMAC/CFB8", AbstractC0413b.m1015i(configurableProvider, "Alg.Alias.Mac.DESEDE", "DESEDEMAC", str, "$DESedeCFB8"));
            configurableProvider.addAlgorithm("Alg.Alias.Mac.DESEDE/CFB8", "DESEDEMAC/CFB8");
            AbstractC0413b.m1030x(new StringBuilder(), str, "$DESede64", configurableProvider, "Mac.DESEDEMAC64");
            configurableProvider.addAlgorithm("Mac.DESEDEMAC64WITHISO7816-4PADDING", AbstractC0413b.m1015i(configurableProvider, "Alg.Alias.Mac.DESEDE64", "DESEDEMAC64", str, "$DESede64with7816d4"));
