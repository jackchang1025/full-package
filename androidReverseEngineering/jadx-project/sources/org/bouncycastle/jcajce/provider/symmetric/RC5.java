...
public final class RC5 {
    ...
    public static class Mappings extends AlgorithmProvider {
        ...
        public void configure(ConfigurableProvider configurableProvider) {
            ...
            String str = PREFIX;
            AbstractC0413b.m1030x(sb, str, "$ECB32", configurableProvider, "Cipher.RC5");
            configurableProvider.addAlgorithm("KeyGenerator.RC5", AbstractC0413b.m1015i(configurableProvider, "Cipher.RC5-64", AbstractC0413b.m1015i(configurableProvider, "Alg.Alias.Cipher.RC5-32", "RC5", str, "$ECB64"), str, "$KeyGen32"));
            configurableProvider.addAlgorithm("Alg.Alias.KeyGenerator.RC5-32", "RC5");
            AbstractC0413b.m1030x(AbstractC0413b.m1016j(AbstractC0413b.m1016j(AbstractC0413b.m1016j(new StringBuilder(), str, "$KeyGen64", configurableProvider, "KeyGenerator.RC5-64"), str, "$AlgParams", configurableProvider, "AlgorithmParameters.RC5"), str, "$AlgParams", configurableProvider, "AlgorithmParameters.RC5-64"), str, "$Mac32", configurableProvider, "Mac.RC5MAC");
            configurableProvider.addAlgorithm("Mac.RC5MAC/CFB8", AbstractC0413b.m1015i(configurableProvider, "Alg.Alias.Mac.RC5", "RC5MAC", str, "$CFB8Mac32"));
