...
public final class DES {
    ...
    public static class Mappings extends AlgorithmProvider {
        ...
        public void configure(ConfigurableProvider configurableProvider) {
            ...
            String str = PREFIX;
            AbstractC0413b.m1030x(sb, str, "$ECB", configurableProvider, "Cipher.DES");
            ASN1ObjectIdentifier aSN1ObjectIdentifier = OIWObjectIdentifiers.desCBC;
            AbstractC0413b.m1029w(str, "$CBC", configurableProvider, "Cipher", aSN1ObjectIdentifier);
            ...
            sb2.append(str);
            AbstractC0413b.m1032z(AbstractC0413b.m1017k(AbstractC0413b.m1017k(AbstractC0413b.m1017k(sb2, "$KeyGenerator", configurableProvider, "KeyGenerator.DES", str), "$KeyFactory", configurableProvider, "SecretKeyFactory.DES", str), "$CMAC", configurableProvider, "Mac.DESCMAC", str), "$CBCMAC", configurableProvider, "Mac.DESMAC");
            configurableProvider.addAlgorithm("Mac.DESMAC/CFB8", AbstractC0413b.m1015i(configurableProvider, "Alg.Alias.Mac.DES", "DESMAC", str, "$DESCFB8"));
            configurableProvider.addAlgorithm("Alg.Alias.Mac.DES/CFB8", "DESMAC/CFB8");
            AbstractC0413b.m1030x(new StringBuilder(), str, "$DES64", configurableProvider, "Mac.DESMAC64");
            configurableProvider.addAlgorithm("Mac.DESMAC64WITHISO7816-4PADDING", AbstractC0413b.m1015i(configurableProvider, "Alg.Alias.Mac.DES64", "DESMAC64", str, "$DES64with7816d4"));
            ...
            AbstractC0413b.m1030x(new StringBuilder(), str, "$DES9797Alg3", configurableProvider, "Mac.DESWITHISO9797");
            configurableProvider.addAlgorithm("Mac.ISO9797ALG3MAC", AbstractC0413b.m1015i(configurableProvider, "Alg.Alias.Mac.DESISO9797MAC", "DESWITHISO9797", str, "$DES9797Alg3"));
            configurableProvider.addAlgorithm("Alg.Alias.Mac.ISO9797ALG3", "ISO9797ALG3MAC");
            AbstractC0413b.m1030x(new StringBuilder(), str, "$DES9797Alg3with7816d4", configurableProvider, "Mac.ISO9797ALG3WITHISO7816-4PADDING");
            ...
            StringBuilder m1021o = AbstractC0413b.m1021o(configurableProvider, "Alg.Alias.AlgorithmParameters", aSN1ObjectIdentifier, "DES", str);
            m1021o.append("$AlgParamGen");
            configurableProvider.addAlgorithm("AlgorithmParameterGenerator.DES", m1021o.toString());
            AbstractC0413b.m1032z(AbstractC0413b.m1017k(AbstractC0413b.m1017k(AbstractC0413b.m1005C(new StringBuilder("Alg.Alias.AlgorithmParameterGenerator."), aSN1ObjectIdentifier, configurableProvider, "DES", str), "$PBEWithMD2", configurableProvider, "Cipher.PBEWITHMD2ANDDES", str), "$PBEWithMD5", configurableProvider, "Cipher.PBEWITHMD5ANDDES", str), "$PBEWithSHA1", configurableProvider, "Cipher.PBEWITHSHA1ANDDES");
            ...
            AbstractC0413b.m1030x(AbstractC0413b.m1016j(AbstractC0413b.m1016j(new StringBuilder(), str, "$PBEWithMD2KeyFactory", configurableProvider, "SecretKeyFactory.PBEWITHMD2ANDDES"), str, "$PBEWithMD5KeyFactory", configurableProvider, "SecretKeyFactory.PBEWITHMD5ANDDES"), str, "$PBEWithSHA1KeyFactory", configurableProvider, "SecretKeyFactory.PBEWITHSHA1ANDDES");
            ...
            AbstractC0413b.m1003A(AbstractC0413b.m1019m(new StringBuilder("Alg.Alias.SecretKeyFactory."), aSN1ObjectIdentifier3, configurableProvider, "PBEWITHMD5ANDDES", "Alg.Alias.SecretKeyFactory."), aSN1ObjectIdentifier4, configurableProvider, "PBEWITHSHA1ANDDES");
        }
    }
