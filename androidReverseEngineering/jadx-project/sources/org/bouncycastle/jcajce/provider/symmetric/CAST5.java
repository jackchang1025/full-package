...
public final class CAST5 {
    ...
    public static class Mappings extends AlgorithmProvider {
        ...
        public void configure(ConfigurableProvider configurableProvider) {
            ...
            String str = PREFIX;
            AbstractC0413b.m1030x(sb, str, "$AlgParams", configurableProvider, "AlgorithmParameters.CAST5");
            configurableProvider.addAlgorithm("AlgorithmParameterGenerator.CAST5", AbstractC0413b.m1015i(configurableProvider, "Alg.Alias.AlgorithmParameters.1.2.840.113533.7.66.10", "CAST5", str, "$AlgParamGen"));
            configurableProvider.addAlgorithm("Alg.Alias.AlgorithmParameterGenerator.1.2.840.113533.7.66.10", "CAST5");
            AbstractC0413b.m1030x(new StringBuilder(), str, "$ECB", configurableProvider, "Cipher.CAST5");
            ...
            AbstractC0413b.m1030x(new StringBuilder(), str, "$KeyGen", configurableProvider, "KeyGenerator.CAST5");
