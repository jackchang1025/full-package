...
public final class RC6 {
    ...
    public static class Mappings extends SymmetricAlgorithmProvider {
        ...
        public void configure(ConfigurableProvider configurableProvider) {
            ...
            String str = PREFIX;
            addGMacAlgorithm(configurableProvider, "RC6", AbstractC0000a.m18n(AbstractC0413b.m1016j(AbstractC0413b.m1016j(AbstractC0413b.m1016j(sb, str, "$ECB", configurableProvider, "Cipher.RC6"), str, "$KeyGen", configurableProvider, "KeyGenerator.RC6"), str, "$AlgParams", configurableProvider, "AlgorithmParameters.RC6"), str, "$GMAC"), AbstractC0000a.m30z(str, "$KeyGen"));
            addPoly1305Algorithm(configurableProvider, "RC6", AbstractC0000a.m30z(str, "$Poly1305"), AbstractC0000a.m30z(str, "$Poly1305KeyGen"));
        }
    }
