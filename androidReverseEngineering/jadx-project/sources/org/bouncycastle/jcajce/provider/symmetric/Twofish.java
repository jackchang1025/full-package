...
public final class Twofish {
    ...
    public static class Mappings extends SymmetricAlgorithmProvider {
        ...
        public void configure(ConfigurableProvider configurableProvider) {
            ...
            String str = PREFIX;
            AbstractC0413b.m1030x(AbstractC0413b.m1016j(AbstractC0413b.m1016j(sb, str, "$ECB", configurableProvider, "Cipher.Twofish"), str, "$KeyGen", configurableProvider, "KeyGenerator.Twofish"), str, "$AlgParams", configurableProvider, "AlgorithmParameters.Twofish");
            ...
            addGMacAlgorithm(configurableProvider, "Twofish", AbstractC0000a.m18n(AbstractC0413b.m1016j(AbstractC0413b.m1016j(new StringBuilder(), str, "$PBEWithSHA", configurableProvider, "Cipher.PBEWITHSHAANDTWOFISH-CBC"), str, "$PBEWithSHAKeyFactory", configurableProvider, "SecretKeyFactory.PBEWITHSHAANDTWOFISH-CBC"), str, "$GMAC"), AbstractC0000a.m30z(str, "$KeyGen"));
            addPoly1305Algorithm(configurableProvider, "Twofish", AbstractC0000a.m30z(str, "$Poly1305"), AbstractC0000a.m30z(str, "$Poly1305KeyGen"));
        }
    }
