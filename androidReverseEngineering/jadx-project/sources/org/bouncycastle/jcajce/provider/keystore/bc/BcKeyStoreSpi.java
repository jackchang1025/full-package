...
public class BcKeyStoreSpi extends KeyStoreSpi implements BCKeyStore {
    ...
    public Key decodeKey(DataInputStream dataInputStream) {
        ...
        if (readUTF.equals("PKCS#8") || readUTF.equals("PKCS8")) {
            ...
            if (!readUTF.equals("X.509") && !readUTF.equals("X509")) {
                ...
                throw new IOException(AbstractC0000a.m16l("Key format ", readUTF, " not recognised!"));
            }
        ...
        try {
            ...
            throw new IOException(AbstractC0000a.m29y(e2, new StringBuilder("Exception creating key: ")));
        }
    }
    ...
    public void engineSetCertificateEntry(String str, Certificate certificate) {
        StoreEntry storeEntry = (StoreEntry) this.table.get(str);
        if (storeEntry != null && storeEntry.getType() != 1) {
            throw new KeyStoreException(AbstractC0000a.m15k("key store already has a key entry with alias ", str));
        }
    ...
    public Cipher makePBECipher(String str, int i2, char[] cArr, byte[] bArr, int i3) {
        try {
            ...
            throw new IOException(AbstractC0000a.m14j("Error initialising store of key store: ", e2));
        }
    }
