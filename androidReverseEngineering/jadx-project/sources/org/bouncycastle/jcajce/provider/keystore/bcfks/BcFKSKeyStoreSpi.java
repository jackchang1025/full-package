...
class BcFKSKeyStoreSpi extends KeyStoreSpi {
        ...
        public Key engineGetKey(String str, char[] cArr) {
            try {
                ...
                if (this.cache.containsKey(str) && !Arrays.constantTimeAreEqual(this.cache.get(str), calculateMac)) {
                    throw new UnrecoverableKeyException(AbstractC0000a.m16l("unable to recover key (", str, ")"));
                }
                ...
                StringBuilder m23s = AbstractC0000a.m23s("unable to recover key (", str, "): ");
                m23s.append(e2.getMessage());
                throw new UnrecoverableKeyException(m23s.toString());
            }
        }
    ...
    private KeyDerivationFunc generatePkbdAlgorithmIdentifier(ASN1ObjectIdentifier aSN1ObjectIdentifier, int i2) {
        ...
        throw new IllegalStateException(AbstractC0413b.m1009c("unknown derivation algorithm: ", aSN1ObjectIdentifier));
    }
    ...
    public Key engineGetKey(String str, char[] cArr) {
        ...
        if (!objectData.getType().equals(PRIVATE_KEY) && !objectData.getType().equals(PROTECTED_PRIVATE_KEY)) {
            if (!objectData.getType().equals(SECRET_KEY) && !objectData.getType().equals(PROTECTED_SECRET_KEY)) {
                throw new UnrecoverableKeyException(AbstractC0000a.m16l("BCFKS KeyStore unable to recover secret key (", str, "): type not recognized"));
            }
            ...
            try {
                ...
                throw new UnrecoverableKeyException(AbstractC0000a.m9e(e2, AbstractC0000a.m23s("BCFKS KeyStore unable to recover secret key (", str, "): ")));
            }
        }
        ...
        try {
            ...
            throw new UnrecoverableKeyException(AbstractC0000a.m9e(e3, AbstractC0000a.m23s("BCFKS KeyStore unable to recover private key (", str, "): ")));
        }
    }
        ...
        try {
            ...
            if (integrityCheck.getType() == 0) {
                ...
                try {
                    ...
                    throw new IOException(AbstractC0000a.m19o(e3, new StringBuilder("error verifying signature: ")), e3);
                }
            }
    ...
    public void engineSetCertificateEntry(String str, Certificate certificate) {
        ...
        if (objectData == null) {
            ...
            if (!objectData.getType().equals(CERTIFICATE)) {
                throw new KeyStoreException(AbstractC0000a.m15k("BCFKS KeyStore already has a key entry with alias ", str));
            }
    ...
    public void engineSetKeyEntry(String str, Key key, char[] cArr, Certificate[] certificateArr) {
        ...
        if (key instanceof PrivateKey) {
            ...
            try {
                ...
                throw new ExtKeyStoreException(AbstractC0000a.m29y(e2, new StringBuilder("BCFKS KeyStore exception storing private key: ")), e2);
            }
        } else {
            ...
            try {
                ...
                throw new ExtKeyStoreException(AbstractC0000a.m29y(e3, new StringBuilder("BCFKS KeyStore exception storing private key: ")), e3);
            }
        }
        this.lastModifiedDate = date;
    }
    ...
    public void engineStore(KeyStore.LoadStoreParameter loadStoreParameter) {
        ...
        try {
            ...
            throw new IOException(AbstractC0000a.m19o(e2, new StringBuilder("error creating signature: ")), e2);
        }
    }
        ...
        if (certificateArr != null) {
            try {
                ...
                try {
                    ...
                    throw new ExtKeyStoreException(AbstractC0000a.m29y(e2, new StringBuilder("BCFKS KeyStore exception storing protected private key: ")), e2);
                }
            } catch (Exception e3) {
            ...
            try {
                ...
                throw new ExtKeyStoreException(AbstractC0000a.m29y(e4, new StringBuilder("BCFKS KeyStore exception storing protected private key: ")), e4);
            }
        }
        this.lastModifiedDate = date;
    }
