...
public class RIPEMD256 {
    ...
    public static class Mappings extends DigestAlgorithmProvider {
        ...
        public void configure(ConfigurableProvider configurableProvider) {
            ...
            StringBuilder m1005C = AbstractC0413b.m1005C(new StringBuilder("Alg.Alias.MessageDigest."), TeleTrusTObjectIdentifiers.ripemd256, configurableProvider, "RIPEMD256", str);
            m1005C.append("$HashMac");
            addHMACAlgorithm(configurableProvider, "RIPEMD256", m1005C.toString(), AbstractC0000a.m30z(str, "$KeyGenerator"));
        }
    }
