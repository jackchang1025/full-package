...
public class GOST3411 {
    ...
    public static class Mappings extends DigestAlgorithmProvider {
        ...
        public void configure(ConfigurableProvider configurableProvider) {
            ...
            String str = PREFIX;
            AbstractC0413b.m1030x(sb, str, "$Digest", configurableProvider, "MessageDigest.GOST3411");
            ...
            StringBuilder m1005C = AbstractC0413b.m1005C(sb2, aSN1ObjectIdentifier, configurableProvider, "GOST3411", str);
            m1005C.append("$HashMac");
            addHMACAlgorithm(configurableProvider, "GOST3411", m1005C.toString(), AbstractC0000a.m30z(str, "$KeyGenerator"));
            ...
            StringBuilder m1005C2 = AbstractC0413b.m1005C(new StringBuilder("Alg.Alias.MessageDigest."), RosstandartObjectIdentifiers.id_tc26_gost_3411_12_256, configurableProvider, "GOST3411-2012-256", str);
            m1005C2.append("$HashMac2012_256");
            addHMACAlgorithm(configurableProvider, "GOST3411-2012-256", m1005C2.toString(), AbstractC0000a.m30z(str, "$KeyGenerator2012_256"));
            ...
            StringBuilder m1005C3 = AbstractC0413b.m1005C(new StringBuilder("Alg.Alias.MessageDigest."), RosstandartObjectIdentifiers.id_tc26_gost_3411_12_512, configurableProvider, "GOST3411-2012-512", str);
            m1005C3.append("$HashMac2012_512");
            addHMACAlgorithm(configurableProvider, "GOST3411-2012-512", m1005C3.toString(), AbstractC0000a.m30z(str, "$KeyGenerator2012_512"));
            ...
            AbstractC0413b.m1003A(new StringBuilder("Alg.Alias.SecretKeyFactory."), aSN1ObjectIdentifier, configurableProvider, "PBEWITHHMACGOST3411");
        }
    }
