...
public class Keccak {
    ...
    public static class Mappings extends DigestAlgorithmProvider {
        ...
        public void configure(ConfigurableProvider configurableProvider) {
            ...
            String str = PREFIX;
            addHMACAlgorithm(configurableProvider, "KECCAK224", AbstractC0000a.m18n(AbstractC0413b.m1016j(AbstractC0413b.m1016j(AbstractC0413b.m1016j(AbstractC0413b.m1016j(AbstractC0413b.m1016j(sb, str, "$Digest224", configurableProvider, "MessageDigest.KECCAK-224"), str, "$Digest288", configurableProvider, "MessageDigest.KECCAK-288"), str, "$Digest256", configurableProvider, "MessageDigest.KECCAK-256"), str, "$Digest384", configurableProvider, "MessageDigest.KECCAK-384"), str, "$Digest512", configurableProvider, "MessageDigest.KECCAK-512"), str, "$HashMac224"), AbstractC0000a.m30z(str, "$KeyGenerator224"));
            addHMACAlgorithm(configurableProvider, "KECCAK256", AbstractC0000a.m30z(str, "$HashMac256"), AbstractC0000a.m30z(str, "$KeyGenerator256"));
            addHMACAlgorithm(configurableProvider, "KECCAK288", AbstractC0000a.m30z(str, "$HashMac288"), AbstractC0000a.m30z(str, "$KeyGenerator288"));
            addHMACAlgorithm(configurableProvider, "KECCAK384", AbstractC0000a.m30z(str, "$HashMac384"), AbstractC0000a.m30z(str, "$KeyGenerator384"));
            addHMACAlgorithm(configurableProvider, "KECCAK512", AbstractC0000a.m30z(str, "$HashMac512"), AbstractC0000a.m30z(str, "$KeyGenerator512"));
        }
    }
