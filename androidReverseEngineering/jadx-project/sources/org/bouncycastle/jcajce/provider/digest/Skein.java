...
public class Skein {
    ...
    public static class Mappings extends DigestAlgorithmProvider {
        ...
        public void configure(ConfigurableProvider configurableProvider) {
            StringBuilder sb = new StringBuilder();
            String str = PREFIX;
            addHMACAlgorithm(configurableProvider, "Skein-256-128", AbstractC0000a.m18n(AbstractC0413b.m1016j(AbstractC0413b.m1016j(AbstractC0413b.m1016j(AbstractC0413b.m1016j(AbstractC0413b.m1016j(AbstractC0413b.m1016j(AbstractC0413b.m1016j(AbstractC0413b.m1016j(AbstractC0413b.m1016j(AbstractC0413b.m1016j(AbstractC0413b.m1016j(AbstractC0413b.m1016j(AbstractC0413b.m1016j(sb, str, "$Digest_256_128", configurableProvider, "MessageDigest.Skein-256-128"), str, "$Digest_256_160", configurableProvider, "MessageDigest.Skein-256-160"), str, "$Digest_256_224", configurableProvider, "MessageDigest.Skein-256-224"), str, "$Digest_256_256", configurableProvider, "MessageDigest.Skein-256-256"), str, "$Digest_512_128", configurableProvider, "MessageDigest.Skein-512-128"), str, "$Digest_512_160", configurableProvider, "MessageDigest.Skein-512-160"), str, "$Digest_512_224", configurableProvider, "MessageDigest.Skein-512-224"), str, "$Digest_512_256", configurableProvider, "MessageDigest.Skein-512-256"), str, "$Digest_512_384", configurableProvider, "MessageDigest.Skein-512-384"), str, "$Digest_512_512", configurableProvider, "MessageDigest.Skein-512-512"), str, "$Digest_1024_384", configurableProvider, "MessageDigest.Skein-1024-384"), str, "$Digest_1024_512", configurableProvider, "MessageDigest.Skein-1024-512"), str, "$Digest_1024_1024", configurableProvider, "MessageDigest.Skein-1024-1024"), str, "$HashMac_256_128"), AbstractC0000a.m30z(str, "$HMacKeyGenerator_256_128"));
            addHMACAlgorithm(configurableProvider, "Skein-256-160", AbstractC0000a.m30z(str, "$HashMac_256_160"), AbstractC0000a.m30z(str, "$HMacKeyGenerator_256_160"));
            addHMACAlgorithm(configurableProvider, "Skein-256-224", AbstractC0000a.m30z(str, "$HashMac_256_224"), AbstractC0000a.m30z(str, "$HMacKeyGenerator_256_224"));
            addHMACAlgorithm(configurableProvider, "Skein-256-256", AbstractC0000a.m30z(str, "$HashMac_256_256"), AbstractC0000a.m30z(str, "$HMacKeyGenerator_256_256"));
            addHMACAlgorithm(configurableProvider, "Skein-512-128", AbstractC0000a.m30z(str, "$HashMac_512_128"), AbstractC0000a.m30z(str, "$HMacKeyGenerator_512_128"));
            addHMACAlgorithm(configurableProvider, "Skein-512-160", AbstractC0000a.m30z(str, "$HashMac_512_160"), AbstractC0000a.m30z(str, "$HMacKeyGenerator_512_160"));
            addHMACAlgorithm(configurableProvider, "Skein-512-224", AbstractC0000a.m30z(str, "$HashMac_512_224"), AbstractC0000a.m30z(str, "$HMacKeyGenerator_512_224"));
            addHMACAlgorithm(configurableProvider, "Skein-512-256", AbstractC0000a.m30z(str, "$HashMac_512_256"), AbstractC0000a.m30z(str, "$HMacKeyGenerator_512_256"));
            addHMACAlgorithm(configurableProvider, "Skein-512-384", AbstractC0000a.m30z(str, "$HashMac_512_384"), AbstractC0000a.m30z(str, "$HMacKeyGenerator_512_384"));
            addHMACAlgorithm(configurableProvider, "Skein-512-512", AbstractC0000a.m30z(str, "$HashMac_512_512"), AbstractC0000a.m30z(str, "$HMacKeyGenerator_512_512"));
            addHMACAlgorithm(configurableProvider, "Skein-1024-384", AbstractC0000a.m30z(str, "$HashMac_1024_384"), AbstractC0000a.m30z(str, "$HMacKeyGenerator_1024_384"));
            addHMACAlgorithm(configurableProvider, "Skein-1024-512", AbstractC0000a.m30z(str, "$HashMac_1024_512"), AbstractC0000a.m30z(str, "$HMacKeyGenerator_1024_512"));
            addHMACAlgorithm(configurableProvider, "Skein-1024-1024", AbstractC0000a.m30z(str, "$HashMac_1024_1024"), AbstractC0000a.m30z(str, "$HMacKeyGenerator_1024_1024"));
