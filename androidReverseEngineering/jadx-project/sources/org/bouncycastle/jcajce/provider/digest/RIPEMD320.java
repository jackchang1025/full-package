...
public class RIPEMD320 {
    ...
    public static class Mappings extends DigestAlgorithmProvider {
        ...
        public void configure(ConfigurableProvider configurableProvider) {
            ...
            String str = PREFIX;
            addHMACAlgorithm(configurableProvider, "RIPEMD320", AbstractC0000a.m18n(AbstractC0413b.m1016j(sb, str, "$Digest", configurableProvider, "MessageDigest.RIPEMD320"), str, "$HashMac"), AbstractC0000a.m30z(str, "$KeyGenerator"));
        }
    }
