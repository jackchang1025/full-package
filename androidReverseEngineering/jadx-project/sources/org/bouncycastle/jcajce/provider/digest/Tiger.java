...
public class Tiger {
    ...
    public static class Mappings extends DigestAlgorithmProvider {
        ...
        public void configure(ConfigurableProvider configurableProvider) {
            ...
            String str = PREFIX;
            addHMACAlgorithm(configurableProvider, "TIGER", AbstractC0000a.m18n(AbstractC0413b.m1016j(AbstractC0413b.m1016j(sb, str, "$Digest", configurableProvider, "MessageDigest.TIGER"), str, "$Digest", configurableProvider, "MessageDigest.Tiger"), str, "$HashMac"), AbstractC0000a.m30z(str, "$KeyGenerator"));
