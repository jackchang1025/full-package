...
public class RSA {
    ...
    public static class Mappings extends AsymmetricAlgorithmProvider {
        private void addDigestSignature(ConfigurableProvider configurableProvider, String str, String str2, ASN1ObjectIdentifier aSN1ObjectIdentifier) {
            String m30z = AbstractC0000a.m30z(str, "WITHRSA");
            String m30z2 = AbstractC0000a.m30z(str, "withRSA");
            String m30z3 = AbstractC0000a.m30z(str, "WithRSA");
            String m30z4 = AbstractC0000a.m30z(str, "/RSA");
            String m30z5 = AbstractC0000a.m30z(str, "WITHRSAENCRYPTION");
            String m30z6 = AbstractC0000a.m30z(str, "withRSAEncryption");
            String m30z7 = AbstractC0000a.m30z(str, "WithRSAEncryption");
            configurableProvider.addAlgorithm("Signature." + m30z, str2);
            configurableProvider.addAlgorithm("Alg.Alias.Signature." + m30z2, m30z);
            configurableProvider.addAlgorithm("Alg.Alias.Signature." + m30z3, m30z);
            configurableProvider.addAlgorithm("Alg.Alias.Signature." + m30z5, m30z);
            configurableProvider.addAlgorithm("Alg.Alias.Signature." + m30z6, m30z);
            configurableProvider.addAlgorithm("Alg.Alias.Signature." + m30z7, m30z);
            configurableProvider.addAlgorithm("Alg.Alias.Signature." + m30z4, m30z);
            if (aSN1ObjectIdentifier != null) {
                configurableProvider.addAlgorithm("Alg.Alias.Signature." + aSN1ObjectIdentifier, m30z);
                AbstractC0413b.m1003A(new StringBuilder("Alg.Alias.Signature.OID."), aSN1ObjectIdentifier, configurableProvider, m30z);
            }
        }

        private void addISO9796Signature(ConfigurableProvider configurableProvider, String str, String str2) {
            configurableProvider.addAlgorithm(AbstractC0000a.m16l("Alg.Alias.Signature.", str, "withRSA/ISO9796-2"), str + "WITHRSA/ISO9796-2");
            configurableProvider.addAlgorithm(AbstractC0000a.m18n(new StringBuilder("Alg.Alias.Signature."), str, "WithRSA/ISO9796-2"), str + "WITHRSA/ISO9796-2");
        ...
        private void addPSSSignature(ConfigurableProvider configurableProvider, String str, String str2, String str3) {
            String m15k = AbstractC0000a.m15k("WITHRSAAND", str2);
            if (str2.equals("MGF1")) {
                configurableProvider.addAlgorithm(AbstractC0000a.m16l("Alg.Alias.Signature.", str, "withRSA/PSS"), str + m15k);
                configurableProvider.addAlgorithm(AbstractC0000a.m18n(new StringBuilder("Alg.Alias.Signature."), str, "WithRSA/PSS"), str + m15k);
                configurableProvider.addAlgorithm(AbstractC0000a.m18n(new StringBuilder("Alg.Alias.Signature."), str, "withRSASSA-PSS"), str + m15k);
                configurableProvider.addAlgorithm(AbstractC0000a.m18n(new StringBuilder("Alg.Alias.Signature."), str, "WithRSASSA-PSS"), str + m15k);
                configurableProvider.addAlgorithm(AbstractC0000a.m18n(new StringBuilder("Alg.Alias.Signature."), str, "WITHRSASSA-PSS"), str + m15k);
            }
            configurableProvider.addAlgorithm("Alg.Alias.Signature." + str + "withRSAand" + str2, str + m15k);
            configurableProvider.addAlgorithm("Alg.Alias.Signature." + str + "WithRSAAnd" + str2, str + m15k);
        ...
        private void addX931Signature(ConfigurableProvider configurableProvider, String str, String str2) {
            configurableProvider.addAlgorithm(AbstractC0000a.m16l("Alg.Alias.Signature.", str, "withRSA/X9.31"), str + "WITHRSA/X9.31");
            configurableProvider.addAlgorithm(AbstractC0000a.m18n(new StringBuilder("Alg.Alias.Signature."), str, "WithRSA/X9.31"), str + "WITHRSA/X9.31");
        ...
        public void configure(ConfigurableProvider configurableProvider) {
            ...
            if (configurableProvider.hasAlgorithm(PKCS9Attribute.MESSAGE_DIGEST_STR, "MD2")) {
                str2 = "SHA3-512";
                str = "SHA3-384";
            ...
            if (configurableProvider.hasAlgorithm(PKCS9Attribute.MESSAGE_DIGEST_STR, "MD4")) {
            ...
            if (configurableProvider.hasAlgorithm(PKCS9Attribute.MESSAGE_DIGEST_STR, "MD5")) {
            ...
            if (configurableProvider.hasAlgorithm(PKCS9Attribute.MESSAGE_DIGEST_STR, "SHA1")) {
                ...
                AbstractC0413b.m1003A(AbstractC0413b.m1019m(sb, aSN1ObjectIdentifier5, configurableProvider, "SHA1WITHRSA", "Alg.Alias.Signature.OID."), aSN1ObjectIdentifier5, configurableProvider, "SHA1WITHRSA");
            ...
            if (configurableProvider.hasAlgorithm(PKCS9Attribute.MESSAGE_DIGEST_STR, "RIPEMD128")) {
            ...
            if (configurableProvider.hasAlgorithm(PKCS9Attribute.MESSAGE_DIGEST_STR, "RIPEMD160")) {
            ...
            if (configurableProvider.hasAlgorithm(PKCS9Attribute.MESSAGE_DIGEST_STR, "RIPEMD256")) {
            ...
            if (configurableProvider.hasAlgorithm(PKCS9Attribute.MESSAGE_DIGEST_STR, "WHIRLPOOL")) {
        ...
        private void addPSSSignature(ConfigurableProvider configurableProvider, String str, String str2, ASN1ObjectIdentifier aSN1ObjectIdentifier) {
            configurableProvider.addAlgorithm(AbstractC0000a.m16l("Alg.Alias.Signature.", str, "withRSA/PSS"), str + "WITHRSAPSS");
            configurableProvider.addAlgorithm(AbstractC0000a.m18n(new StringBuilder("Alg.Alias.Signature."), str, "WithRSA/PSS"), str + "WITHRSAPSS");
            configurableProvider.addAlgorithm(AbstractC0000a.m18n(new StringBuilder("Alg.Alias.Signature."), str, "withRSASSA-PSS"), str + "WITHRSAPSS");
            configurableProvider.addAlgorithm(AbstractC0000a.m18n(new StringBuilder("Alg.Alias.Signature."), str, "WithRSASSA-PSS"), str + "WITHRSAPSS");
            configurableProvider.addAlgorithm(AbstractC0000a.m18n(new StringBuilder("Alg.Alias.Signature."), str, "WITHRSASSA-PSS"), str + "WITHRSAPSS");
