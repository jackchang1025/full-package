...
public class KeyFactorySpi extends BaseKeyFactorySpi {
    ...
    public KeyFactorySpi(String str, boolean z2, int i2) {
        this.algorithm = str;
        this.isXdh = z2;
            ...
            if (i2 == 0 || i2 == encoded[8]) {
                if (encoded[9] == 5 && encoded[10] == 0) {
                    ...
                    try {
                        ...
                        throw new InvalidKeySpecException(AbstractC0000a.m8d(e2, new StringBuilder("attempt to reconstruct key failed: ")));
                    }
                }
                switch (encoded[8]) {
                    case 110:
    ...
    public PrivateKey generatePrivate(PrivateKeyInfo privateKeyInfo) {
        ...
        throw new IOException(AbstractC0413b.m1010d("algorithm identifier ", algorithm, " in key not recognized"));
    }
