...
class X509CertificateObject extends X509CertificateImpl implements PKCS12BagAttributeCarrier {
    ...
    private static BasicConstraints createBasicConstraints(Certificate certificate) {
        try {
            ...
            throw new CertificateParsingException(AbstractC0000a.m14j("cannot construct BasicConstraints: ", e2));
        }
    }
    ...
    private static String createSigAlgName(Certificate certificate) {
        try {
            ...
            throw new CertificateParsingException(AbstractC0000a.m14j("cannot construct SigAlgName: ", e2));
        }
    }
    ...
    private static byte[] createSigAlgParams(Certificate certificate) {
        try {
            ...
            throw new CertificateParsingException(AbstractC0000a.m14j("cannot construct SigAlgParams: ", e2));
        }
    }
    ...
    private X509CertificateInternal getInternalCertificate() {
        ...
        synchronized (this.cacheLock) {
            ...
            try {
                ...
                bArr = this.f1369c.getEncoded(ASN1Encoding.DER);
            } catch (IOException e2) {
                bArr = null;
                x509CertificateEncodingException = new X509CertificateEncodingException(e2);
            }
            X509CertificateInternal x509CertificateInternal3 = new X509CertificateInternal(this.bcHelper, this.f1369c, this.basicConstraints, this.keyUsage, this.sigAlgName, this.sigAlgParams, bArr, x509CertificateEncodingException);
            synchronized (this.cacheLock) {
    ...
    public boolean equals(Object obj) {
        ...
        if (obj instanceof X509CertificateObject) {
            ...
            } else if ((this.internalCertificateValue == null || x509CertificateObject.internalCertificateValue == null) && (signature = this.f1369c.getSignature()) != null && !signature.equals((ASN1Primitive) x509CertificateObject.f1369c.getSignature())) {
                return false;
            }
