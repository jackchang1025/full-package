...
public class BCDSAPublicKey implements DSAPublicKey {
    ...
    /* renamed from: y */
    private BigInteger f1357y;

    public BCDSAPublicKey(DSAPublicKey dSAPublicKey) {
        this.f1357y = dSAPublicKey.getY();
        this.dsaSpec = dSAPublicKey.getParams();
        this.lwKeyParams = new DSAPublicKeyParameters(this.f1357y, DSAUtil.toDSAParameters(this.dsaSpec));
    }
    ...
    public byte[] getEncoded() {
        DSAParams dSAParams = this.dsaSpec;
        return dSAParams == null ? KeyUtil.getEncodedSubjectPublicKeyInfo(new AlgorithmIdentifier(X9ObjectIdentifiers.id_dsa), new ASN1Integer(this.f1357y)) : KeyUtil.getEncodedSubjectPublicKeyInfo(new AlgorithmIdentifier(X9ObjectIdentifiers.id_dsa, new DSAParameter(dSAParams.getP(), this.dsaSpec.getQ(), this.dsaSpec.getG()).toASN1Primitive()), new ASN1Integer(this.f1357y));
    }
    ...
    public String toString() {
        ...
        stringBuffer.append(DSAUtil.generateKeyFingerprint(this.f1357y, getParams()));
        stringBuffer.append("]");
    ...
    public BCDSAPublicKey(DSAPublicKeySpec dSAPublicKeySpec) {
        this.f1357y = dSAPublicKeySpec.getY();
    ...
    public BCDSAPublicKey(SubjectPublicKeyInfo subjectPublicKeyInfo) {
        try {
            this.f1357y = ((ASN1Integer) subjectPublicKeyInfo.parsePublicKey()).getValue();
    ...
    public BCDSAPublicKey(DSAPublicKeyParameters dSAPublicKeyParameters) {
        this.f1357y = dSAPublicKeyParameters.getY();
