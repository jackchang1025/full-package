...
class X509CRLEntryObject extends X509CRLEntry {
    ...
    public boolean equals(Object obj) {
        ...
        return this.f1367c.equals(x509CRLEntryObject.f1367c);
    }
    ...
    public byte[] getEncoded() {
        try {
            return this.f1367c.getEncoded(ASN1Encoding.DER);
    ...
    public byte[] getExtensionValue(String str) {
        ...
        try {
            ...
            throw new IllegalStateException(AbstractC0000a.m29y(e2, new StringBuilder("Exception encoding: ")));
        }
    }
    ...
    public Date getRevocationDate() {
        return this.f1367c.getRevocationDate().getDate();
    }

    @Override // java.security.cert.X509CRLEntry
    public BigInteger getSerialNumber() {
        return this.f1367c.getUserCertificate().getValue();
    }

    @Override // java.security.cert.X509CRLEntry
    public boolean hasExtensions() {
        return this.f1367c.getExtensions() != null;
    }
