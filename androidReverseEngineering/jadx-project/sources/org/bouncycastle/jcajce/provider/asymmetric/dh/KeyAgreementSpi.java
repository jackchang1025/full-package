...
public class KeyAgreementSpi extends BaseAgreementSpi {
    ...
    public byte[] bigIntToBytes(BigInteger bigInteger) {
        int bitLength = (this.f1354p.bitLength() + 7) / 8;
    ...
    public Key engineDoPhase(Key key, boolean z2) {
        ...
        if (!dHPublicKey.getParams().getG().equals(this.f1353g) || !dHPublicKey.getParams().getP().equals(this.f1354p)) {
            throw new InvalidKeyException("DHPublicKey not for this KeyAgreement!");
        }
        BigInteger y2 = dHPublicKey.getY();
        if (y2 != null && y2.compareTo(TWO) >= 0) {
            BigInteger bigInteger = this.f1354p;
            ...
            if (y2.compareTo(bigInteger.subtract(bigInteger2)) < 0) {
                ...
                BigInteger modPow = y2.modPow(this.f1355x, this.f1354p);
    ...
    public void engineInit(Key key, SecureRandom secureRandom) {
        ...
        this.f1354p = dHPrivateKey.getParams().getP();
        this.f1353g = dHPrivateKey.getParams().getG();
    ...
    public void engineInit(Key key, AlgorithmParameterSpec algorithmParameterSpec, SecureRandom secureRandom) {
        ...
        if (algorithmParameterSpec == null) {
            ...
            this.f1354p = dHParameterSpec.getP();
            this.f1353g = dHParameterSpec.getG();
