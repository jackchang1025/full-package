...
public class KeyAgreementSpi extends BaseAgreementSpi {
    ...
    private void initFromKey(Key key, AlgorithmParameterSpec algorithmParameterSpec) {
        ...
        if (obj instanceof ECMQVBasicAgreement) {
            ...
            if (!z2 && !(algorithmParameterSpec instanceof MQVParameterSpec)) {
                ...
                throw new InvalidAlgorithmParameterException(AbstractC0000a.m18n(sb, getSimpleName(MQVParameterSpec.class), " for initialisation"));
            }
            if (z2) {
        ...
        if (!(algorithmParameterSpec instanceof DHUParameterSpec)) {
            if (!(key instanceof PrivateKey)) {
                ...
                throw new InvalidKeyException(AbstractC0000a.m18n(sb2, getSimpleName(ECPrivateKey.class), " for initialisation"));
            }
    ...
    public Key engineDoPhase(Key key, boolean z2) {
        ...
        try {
            ...
            throw new InvalidKeyException(AbstractC0000a.m9e(e2, new StringBuilder("calculation failed: "))) { // from class: org.bouncycastle.jcajce.provider.asymmetric.ec.KeyAgreementSpi.1
