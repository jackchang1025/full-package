...
public class AlgorithmParametersSpi extends java.security.AlgorithmParametersSpi {
    ...
    public byte[] engineGetEncoded(String str) {
        ...
        if (!isASN1FormatString(str)) {
            throw new IOException(AbstractC0000a.m15k("Unknown parameters format in AlgorithmParameters object: ", str));
        }
    ...
    public void engineInit(byte[] bArr, String str) {
        if (!isASN1FormatString(str)) {
            throw new IOException(AbstractC0000a.m15k("Unknown encoded parameters format in AlgorithmParameters object: ", str));
        }
