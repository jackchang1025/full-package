...
public class KeyAgreementSpi extends BaseAgreementSpi {
    ...
    public Key engineDoPhase(Key key, boolean z2) {
        ...
        try {
            ...
            throw new InvalidKeyException(AbstractC0000a.m9e(e2, new StringBuilder("calculation failed: "))) { // from class: org.bouncycastle.jcajce.provider.asymmetric.ecgost12.KeyAgreementSpi.1
