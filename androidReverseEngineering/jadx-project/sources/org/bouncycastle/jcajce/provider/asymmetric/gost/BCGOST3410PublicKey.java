...
public class BCGOST3410PublicKey implements GOST3410PublicKey {
    ...
    public boolean equals(Object obj) {
        ...
        return this.f1366y.equals(bCGOST3410PublicKey.f1366y) && this.gost3410Spec.equals(bCGOST3410PublicKey.gost3410Spec);
    }
    ...
    public int hashCode() {
        return this.f1366y.hashCode() ^ this.gost3410Spec.hashCode();
    }

    public String toString() {
        try {
            return GOSTUtil.publicKeyToString("GOST3410", this.f1366y, ((GOST3410PublicKeyParameters) GOST3410Util.generatePublicKeyParameter(this)).getParameters());
    ...
    public BCGOST3410PublicKey(SubjectPublicKeyInfo subjectPublicKeyInfo) {
        ...
        try {
            ...
            this.f1366y = new BigInteger(1, bArr);
    ...
    public BCGOST3410PublicKey(GOST3410PublicKeyParameters gOST3410PublicKeyParameters, GOST3410ParameterSpec gOST3410ParameterSpec) {
        this.f1366y = gOST3410PublicKeyParameters.getY();
        this.gost3410Spec = gOST3410ParameterSpec;
    }

    public BCGOST3410PublicKey(GOST3410PublicKey gOST3410PublicKey) {
        this.f1366y = gOST3410PublicKey.getY();
        this.gost3410Spec = gOST3410PublicKey.getParameters();
    }

    public BCGOST3410PublicKey(GOST3410PublicKeySpec gOST3410PublicKeySpec) {
        this.f1366y = gOST3410PublicKeySpec.getY();
