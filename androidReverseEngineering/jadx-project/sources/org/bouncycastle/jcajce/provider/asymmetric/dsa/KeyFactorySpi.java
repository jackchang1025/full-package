...
public class KeyFactorySpi extends BaseKeyFactorySpi {
    ...
    public PublicKey engineGeneratePublic(KeySpec keySpec) {
        if (keySpec instanceof DSAPublicKeySpec) {
            try {
                ...
                throw new InvalidKeySpecException(AbstractC0000a.m9e(e2, new StringBuilder("invalid KeySpec: "))) { // from class: org.bouncycastle.jcajce.provider.asymmetric.dsa.KeyFactorySpi.1
    ...
    public KeySpec engineGetKeySpec(Key key, Class cls) {
        ...
        try {
            ...
            throw new IllegalArgumentException(AbstractC0000a.m8d(e3, new StringBuilder("unable to produce encoding: ")));
        }
    }
