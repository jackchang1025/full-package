...
class ProvOcspRevocationChecker implements PKIXCertRevocationChecker {
    ...
    private Certificate extractCert() {
        try {
            ...
            throw new CertPathValidatorException(AbstractC0000a.m9e(e2, new StringBuilder("cannot process signing cert: ")), e2, this.parameters.getCertPath(), this.parameters.getIndex());
        }
    }
    ...
    private static String getSignatureName(AlgorithmIdentifier algorithmIdentifier) {
        ...
        if (parameters != null && !DERNull.INSTANCE.equals(parameters) && algorithmIdentifier.getAlgorithm().equals((ASN1Primitive) PKCSObjectIdentifiers.id_RSASSA_PSS)) {
            return AbstractC0000a.m18n(new StringBuilder(), getDigestName(RSASSAPSSparams.getInstance(parameters).getHashAlgorithm().getAlgorithm()), "WITHRSAANDMGF1");
        }
        Map map = oids;
    ...
    public static boolean validatedOcspResponse(BasicOCSPResponse basicOCSPResponse, PKIXCertRevocationCheckerParameters pKIXCertRevocationCheckerParameters, byte[] bArr, X509Certificate x509Certificate, JcaJceHelper jcaJceHelper) {
        try {
            ...
            throw new CertPathValidatorException(AbstractC0000a.m8d(e2, new StringBuilder("OCSP response failure: ")), e2, pKIXCertRevocationCheckerParameters.getCertPath(), pKIXCertRevocationCheckerParameters.getIndex());
        } catch (CertPathValidatorException e3) {
            throw e3;
        } catch (GeneralSecurityException e4) {
            throw new CertPathValidatorException(AbstractC0000a.m19o(e4, new StringBuilder("OCSP response failure: ")), e4, pKIXCertRevocationCheckerParameters.getCertPath(), pKIXCertRevocationCheckerParameters.getIndex());
        }
    }
    ...
    */
    public void check(java.security.cert.Certificate certificate) {
        ...
        if (responseBytes.getResponseType().equals((ASN1Primitive) OCSPObjectIdentifiers.id_pkix_ocsp_basic)) {
            try {
                ...
                if (z2 || validatedOcspResponse(basicOCSPResponse, this.parameters, bArr, this.parent.getOcspResponderCert(), this.helper)) {
    ...
    private CertID createCertID(AlgorithmIdentifier algorithmIdentifier, Certificate certificate, ASN1Integer aSN1Integer) {
        try {
            ...
            throw new CertPathValidatorException(AbstractC0000a.m14j("problem creating ID: ", e2), e2);
        }
    }
}
