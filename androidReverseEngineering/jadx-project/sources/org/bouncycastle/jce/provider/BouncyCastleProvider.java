...
public final class BouncyCastleProvider extends Provider implements ConfigurableProvider {
    ...
    private void loadAlgorithms(String str, String[] strArr) {
        for (int i2 = 0; i2 != strArr.length; i2++) {
            ...
            m20p.append(strArr[i2]);
            m20p.append("$Mappings");
            Class loadClass = ClassUtil.loadClass(BouncyCastleProvider.class, m20p.toString());
            if (loadClass != null) {
                try {
    ...
    public void addAttributes(String str, Map<String, String> map) {
        for (String str2 : map.keySet()) {
            ...
            if (containsKey(str3)) {
                throw new IllegalStateException(AbstractC0000a.m16l("duplicate provider attribute key (", str3, ") found"));
            }
