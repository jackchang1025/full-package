...
public class X509CRLEntryObject extends X509CRLEntry {
    ...
    public boolean equals(Object obj) {
        ...
        return obj instanceof X509CRLEntryObject ? this.f1383c.equals(((X509CRLEntryObject) obj).f1383c) : super.equals(this);
    }
    ...
    public byte[] getEncoded() {
        try {
            return this.f1383c.getEncoded(ASN1Encoding.DER);
    ...
    public byte[] getExtensionValue(String str) {
        ...
        try {
            ...
            throw new RuntimeException(AbstractC0000a.m29y(e2, new StringBuilder("error encoding ")));
        }
    }
    ...
    public Date getRevocationDate() {
        return this.f1383c.getRevocationDate().getDate();
    }

    @Override // java.security.cert.X509CRLEntry
    public BigInteger getSerialNumber() {
        return this.f1383c.getUserCertificate().getValue();
    }

    @Override // java.security.cert.X509CRLEntry
    public boolean hasExtensions() {
        return this.f1383c.getExtensions() != null;
    }
