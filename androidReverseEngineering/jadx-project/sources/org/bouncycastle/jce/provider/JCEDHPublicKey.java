...
public class JCEDHPublicKey implements DHPublicKey {
    ...
    /* renamed from: y */
    private BigInteger f1374y;

    public JCEDHPublicKey(BigInteger bigInteger, DHParameterSpec dHParameterSpec) {
        this.f1374y = bigInteger;
    ...
    private void readObject(ObjectInputStream objectInputStream) {
        this.f1374y = (BigInteger) objectInputStream.readObject();
    ...
    public byte[] getEncoded() {
        ...
        return subjectPublicKeyInfo != null ? KeyUtil.getEncodedSubjectPublicKeyInfo(subjectPublicKeyInfo) : KeyUtil.getEncodedSubjectPublicKeyInfo(new AlgorithmIdentifier(PKCSObjectIdentifiers.dhKeyAgreement, new DHParameter(this.dhSpec.getP(), this.dhSpec.getG(), this.dhSpec.getL())), new ASN1Integer(this.f1374y));
    }
    ...
    public JCEDHPublicKey(DHPublicKey dHPublicKey) {
        this.f1374y = dHPublicKey.getY();
        this.dhSpec = dHPublicKey.getParams();
    }

    public JCEDHPublicKey(DHPublicKeySpec dHPublicKeySpec) {
        this.f1374y = dHPublicKeySpec.getY();
    ...
    public JCEDHPublicKey(SubjectPublicKeyInfo subjectPublicKeyInfo) {
        ...
        try {
            this.f1374y = ((ASN1Integer) subjectPublicKeyInfo.parsePublicKey()).getValue();
    ...
    public JCEDHPublicKey(DHPublicKeyParameters dHPublicKeyParameters) {
        this.f1374y = dHPublicKeyParameters.getY();
