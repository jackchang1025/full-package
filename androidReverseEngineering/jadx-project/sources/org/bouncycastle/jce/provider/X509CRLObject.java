...
public class X509CRLObject extends X509CRL {
    ...
    /* renamed from: c */
    private CertificateList f1384c;
    ...
    private void doVerify(PublicKey publicKey, Signature signature) {
        if (!this.f1384c.getSignatureAlgorithm().equals(this.f1384c.getTBSCertList().getSignature())) {
    ...
    private Set getExtensionOIDs(boolean z2) {
        ...
        if (getVersion() != 2 || (extensions = this.f1384c.getTBSCertList().getExtensions()) == null) {
            return null;
        }
    ...
    private Set loadCRLEntries() {
        Extension extension;
        HashSet hashSet = new HashSet();
        Enumeration revokedCertificateEnumeration = this.f1384c.getRevokedCertificateEnumeration();
    ...
    public boolean equals(Object obj) {
        ...
        return this.f1384c.equals(x509CRLObject.f1384c);
    }
    ...
    public byte[] getEncoded() {
        try {
            return this.f1384c.getEncoded(ASN1Encoding.DER);
    ...
    public byte[] getExtensionValue(String str) {
        Extension extension;
        Extensions extensions = this.f1384c.getTBSCertList().getExtensions();
    ...
    public Principal getIssuerDN() {
        return new X509Principal(X500Name.getInstance(this.f1384c.getIssuer().toASN1Primitive()));
    }

    @Override // java.security.cert.X509CRL
    public X500Principal getIssuerX500Principal() {
        try {
            return new X500Principal(this.f1384c.getIssuer().getEncoded());
    ...
    public Date getNextUpdate() {
        if (this.f1384c.getNextUpdate() != null) {
            return this.f1384c.getNextUpdate().getDate();
        }
        return null;
    }
    ...
    public String getSigAlgOID() {
        return this.f1384c.getSignatureAlgorithm().getAlgorithm().getId();
    }
    ...
    public byte[] getSignature() {
        return this.f1384c.getSignature().getOctets();
    }

    @Override // java.security.cert.X509CRL
    public byte[] getTBSCertList() {
        try {
            return this.f1384c.getTBSCertList().getEncoded(ASN1Encoding.DER);
        } catch (IOException e2) {
            throw new CRLException(e2.toString());
        }
    }
    ...
    public Date getThisUpdate() {
        return this.f1384c.getThisUpdate().getDate();
    }

    @Override // java.security.cert.X509CRL
    public int getVersion() {
        return this.f1384c.getVersionNumber();
    }
    ...
    public boolean isRevoked(Certificate certificate) {
        ...
        Enumeration revokedCertificateEnumeration = this.f1384c.getRevokedCertificateEnumeration();
        X500Name issuer2 = this.f1384c.getIssuer();
    ...
    /*  JADX ERROR: JadxRuntimeException in pass: RegionMakerVisitor
        jadx.core.utils.exceptions.JadxRuntimeException: Can't find top splitter block for handler:B:50:0x017f
