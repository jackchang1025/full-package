...
public class JDKDSAPrivateKey implements DSAPrivateKey, PKCS12BagAttributeCarrier {
    ...
    private void readObject(ObjectInputStream objectInputStream) {
        this.f1379x = (BigInteger) objectInputStream.readObject();
    ...
    private void writeObject(ObjectOutputStream objectOutputStream) {
        objectOutputStream.writeObject(this.f1379x);
    ...
    public JDKDSAPrivateKey(DSAPrivateKey dSAPrivateKey) {
        this.f1379x = dSAPrivateKey.getX();
        this.dsaSpec = dSAPrivateKey.getParams();
    }

    public JDKDSAPrivateKey(DSAPrivateKeySpec dSAPrivateKeySpec) {
        this.f1379x = dSAPrivateKeySpec.getX();
    ...
    public JDKDSAPrivateKey(PrivateKeyInfo privateKeyInfo) {
        ...
        this.f1379x = ASN1Integer.getInstance(privateKeyInfo.parsePrivateKey()).getValue();
    ...
    public JDKDSAPrivateKey(DSAPrivateKeyParameters dSAPrivateKeyParameters) {
        this.f1379x = dSAPrivateKeyParameters.getX();
