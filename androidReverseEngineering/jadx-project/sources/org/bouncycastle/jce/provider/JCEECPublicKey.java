...
public class JCEECPublicKey implements ECPublicKey, org.bouncycastle.jce.interfaces.ECPublicKey, ECPointEncoder {
    ...
    public JCEECPublicKey(String str, ECPublicKeySpec eCPublicKeySpec) {
        ...
        this.ecSpec = params;
        this.f1376q = EC5Util.convertPoint(params, eCPublicKeySpec.getW());
    }
    ...
    private void populateFromPubKeyInfo(SubjectPublicKeyInfo subjectPublicKeyInfo) {
        ...
        if (algorithm.getAlgorithm().equals((ASN1Primitive) CryptoProObjectIdentifiers.gostR3410_2001)) {
            ...
            try {
                ...
                this.f1376q = curve2.decodePoint(bArr);
        ...
        if (x962Parameters.isNamedCurve()) {
            ...
            if (x962Parameters.isImplicitlyCA()) {
                ...
                this.f1376q = new X9ECPoint(curve, dEROctetString).getPoint();
            }
    ...
    public byte[] getEncoded() {
        ...
        if (this.algorithm.equals("ECGOST3410")) {
            ...
            BigInteger bigInteger = this.f1376q.getAffineXCoord().toBigInteger();
            BigInteger bigInteger2 = this.f1376q.getAffineYCoord().toBigInteger();
    ...
    public ECPoint getQ() {
        return this.ecSpec == null ? this.f1376q.getDetachedPoint() : this.f1376q;
    }

    @Override // java.security.interfaces.ECPublicKey
    public java.security.spec.ECPoint getW() {
        return EC5Util.convertPoint(this.f1376q);
    }
    ...
    public String toString() {
        ...
        stringBuffer.append(this.f1376q.getAffineXCoord().toBigInteger().toString(16));
        stringBuffer.append(lineSeparator);
        stringBuffer.append("            Y: ");
        stringBuffer.append(this.f1376q.getAffineYCoord().toBigInteger().toString(16));
        stringBuffer.append(lineSeparator);
    ...
    public JCEECPublicKey(String str, ECPublicKeyParameters eCPublicKeyParameters) {
        this.algorithm = str;
        this.f1376q = eCPublicKeyParameters.getQ();
        this.ecSpec = null;
    }
    ...
    public JCEECPublicKey(String str, JCEECPublicKey jCEECPublicKey) {
        this.algorithm = str;
        this.f1376q = jCEECPublicKey.f1376q;
    ...
    public JCEECPublicKey(String str, org.bouncycastle.jce.spec.ECPublicKeySpec eCPublicKeySpec) {
        ECParameterSpec eCParameterSpec;
        this.algorithm = str;
        this.f1376q = eCPublicKeySpec.getQ();
        if (eCPublicKeySpec.getParams() != null) {
            ...
            if (this.f1376q.getCurve() == null) {
                this.f1376q = BouncyCastleProvider.CONFIGURATION.getEcImplicitlyCa().getCurve().createPoint(this.f1376q.getAffineXCoord().toBigInteger(), this.f1376q.getAffineYCoord().toBigInteger());
            }
    ...
    public JCEECPublicKey(ECPublicKey eCPublicKey) {
        ...
        this.ecSpec = params;
        this.f1376q = EC5Util.convertPoint(params, eCPublicKey.getW());
    }
