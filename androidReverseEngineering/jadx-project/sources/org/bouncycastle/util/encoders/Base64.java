...
public class Base64 {
    ...
    public static int decode(byte[] bArr, int i2, int i3, OutputStream outputStream) {
        try {
            ...
            throw new DecoderException(AbstractC0000a.m9e(e2, new StringBuilder("unable to decode base64 data: ")), e2);
        }
    }
    ...
    public static byte[] encode(byte[] bArr, int i2, int i3) {
        ...
        try {
            ...
            throw new EncoderException(AbstractC0000a.m9e(e2, new StringBuilder("exception encoding base64 string: ")), e2);
        }
    }
    ...
    public static byte[] decode(String str) {
        ...
        try {
            ...
            throw new DecoderException(AbstractC0000a.m9e(e2, new StringBuilder("unable to decode base64 string: ")), e2);
        }
    }
