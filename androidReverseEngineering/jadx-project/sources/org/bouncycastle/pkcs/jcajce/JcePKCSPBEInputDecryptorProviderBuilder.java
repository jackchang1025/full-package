                ...
                try {
                    ...
                    return new InputDecryptor() { // from class: org.bouncycastle.pkcs.jcajce.JcePKCSPBEInputDecryptorProviderBuilder.1.1
                        ...
                        public AlgorithmIdentifier getAlgorithmIdentifier() {
                            return C07801.this.encryptionAlg;
                        }

                        @Override // org.bouncycastle.operator.InputDecryptor
                        public InputStream getInputStream(InputStream inputStream) {
                            return new CipherInputStream(inputStream, C07801.this.cipher);
                        }
                    };
                } catch (Exception e2) {
                    throw new OperatorCreationException(AbstractC0000a.m9e(e2, new StringBuilder("unable to create InputDecryptor: ")), e2);
                }
            }
        };
    }
