    ...
    */
            ...
            if (x509AttributeCertStoreSelector.getHolder().getEntityNames() != null) {
                ...
                if (str != null) {
                    for (String str2 : strArr3) {
                        arrayList.addAll(search(strArr2, AbstractC0000a.m16l("*", parseDN(str, str2), "*"), strArr));
                    }
                }
    ...
    private List certSubjectSerialSearch(X509CertStoreSelector x509CertStoreSelector, String[] strArr, String[] strArr2, String[] strArr3) {
        ...
        if (subjectAsString != null) {
            for (String str : strArr3) {
                arrayList.addAll(search(strArr2, AbstractC0000a.m16l("*", parseDN(subjectAsString, str), "*"), strArr));
            }
        }
    ...
    private String getSubjectAsString(X509CertStoreSelector x509CertStoreSelector) {
        try {
            ...
            throw new StoreException(AbstractC0000a.m8d(e2, new StringBuilder("exception processing name: ")), e2);
        }
    }
    ...
    private List search(String[] strArr, String str, String[] strArr2) {
        ...
        if (strArr == null) {
            ...
            for (String str3 : strArr) {
                StringBuilder m22r = AbstractC0000a.m22r(str2, "(");
                m22r.append(str3);
                m22r.append("=");
                m22r.append(str);
                m22r.append(")");
            ...
            m16l = AbstractC0000a.m16l("(|", str2, ")");
        }
        String str4 = BuildConfig.FLAVOR;
        for (String str5 : strArr2) {
            str4 = AbstractC0000a.m18n(AbstractC0000a.m22r(str4, "("), str5, "=*)");
        }
        String m16l2 = AbstractC0000a.m16l("(|", str4, ")");
        String str6 = "(&" + m16l + BuildConfig.FLAVOR + m16l2 + ")";
        if (m16l != null) {
            m16l2 = str6;
        }
        List fromCache = getFromCache(m16l2);
        if (fromCache != null) {
            return fromCache;
        }
        ArrayList arrayList = new ArrayList();
        try {
            ...
            NamingEnumeration search = dirContext.search(this.params.getBaseDN(), m16l2, searchControls);
