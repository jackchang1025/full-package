...
public class X509V3CertificateGenerator {
    ...
    public void copyAndAddExtension(String str, boolean z2, X509Certificate x509Certificate) {
        ...
        if (extensionValue == null) {
            throw new CertificateParsingException(AbstractC0000a.m16l("extension ", str, " not present"));
        }
        try {
    ...
    public void setIssuerDN(X500Principal x500Principal) {
        try {
            ...
            throw new IllegalArgumentException(AbstractC0000a.m13i("can't process principal: ", e2));
        }
    }
    ...
    public void setPublicKey(PublicKey publicKey) {
        try {
            ...
            throw new IllegalArgumentException(AbstractC0000a.m29y(e2, new StringBuilder("unable to process key - ")));
        }
    }
    ...
    public void setSignatureAlgorithm(String str) {
        ...
        try {
            ...
            throw new IllegalArgumentException(AbstractC0000a.m15k("Unknown signature type requested: ", str));
        }
    }
    ...
    public void copyAndAddExtension(ASN1ObjectIdentifier aSN1ObjectIdentifier, boolean z2, X509Certificate x509Certificate) {
