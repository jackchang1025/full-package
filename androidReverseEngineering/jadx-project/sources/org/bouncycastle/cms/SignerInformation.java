...
public class SignerInformation {
    ...
    private ASN1Primitive getSingleValuedSignedAttribute(ASN1ObjectIdentifier aSN1ObjectIdentifier, String str) {
        ...
        if (unsignedAttributes != null && unsignedAttributes.getAll(aSN1ObjectIdentifier).size() > 0) {
            throw new CMSException(AbstractC0000a.m16l("The ", str, " attribute MUST NOT be an unsigned attribute"));
        }
        AttributeTable signedAttributes = getSignedAttributes();
        ...
        if (size != 1) {
            throw new CMSException(AbstractC0000a.m16l("The SignedAttributes in a signerInfo MUST NOT include multiple instances of the ", str, " attribute"));
        }
        ASN1Set attrValues = ((Attribute) all.get(0)).getAttrValues();
        if (attrValues.size() == 1) {
            return attrValues.getObjectAt(0).toASN1Primitive();
        }
        throw new CMSException(AbstractC0000a.m16l("A ", str, " attribute MUST have a single attribute value"));
    }
    ...
    public byte[] getDigestAlgParams() {
        try {
            ...
            throw new RuntimeException(AbstractC0000a.m14j("exception getting digest parameters ", e2));
        }
    }
