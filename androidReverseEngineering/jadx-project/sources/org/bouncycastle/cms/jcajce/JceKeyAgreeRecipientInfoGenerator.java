...
public class JceKeyAgreeRecipientInfoGenerator extends KeyAgreeRecipientInfoGenerator {
    ...
    private void init(ASN1ObjectIdentifier aSN1ObjectIdentifier) {
        ...
        if (CMSUtils.isMQV(aSN1ObjectIdentifier) && this.ephemeralKP == null) {
            try {
                ...
                throw new CMSException(AbstractC0000a.m14j("cannot determine MQV ephemeral key pair parameters from public key: ", e2), e2);
            }
        }
    }
    ...
    public ASN1Sequence generateRecipientEncryptedKeys(AlgorithmIdentifier algorithmIdentifier, AlgorithmIdentifier algorithmIdentifier2, GenericKey genericKey) {
        ...
        for (int i2 = 0; i2 != this.recipientIDs.size(); i2++) {
            ...
            try {
                ...
                throw new CMSException(AbstractC0000a.m8d(e2, new StringBuilder("unable to encode wrapped key: ")), e2);
            } catch (GeneralSecurityException e3) {
                throw new CMSException(AbstractC0000a.m19o(e3, new StringBuilder("cannot perform agreement step: ")), e3);
            }
        }
    ...
    public byte[] getUserKeyingMaterial(AlgorithmIdentifier algorithmIdentifier) {
        ...
        try {
            ...
            throw new CMSException(AbstractC0000a.m8d(e2, new StringBuilder("unable to encode user keying material: ")), e2);
        }
    }
