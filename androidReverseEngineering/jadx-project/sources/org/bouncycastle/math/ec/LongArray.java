...
class LongArray implements Cloneable {
    ...
    private static int bitLength(long j2) {
        ...
        if (i5 == 0) {
            ...
            int i7 = i5 >>> 8;
            i2 = i7 == 0 ? bitLengths[i5] + Tnaf.POW_2_WIDTH : bitLengths[i7] + DerValue.tag_GeneralizedTime;
        }
        return i3 + i2;
    }
    ...
    private static long interleave2_32to64(int i2) {
        ...
        return ((sArr[i2 & 255] | (sArr[(i2 >>> 8) & 255] << 16)) & BodyPartID.bodyIdMax) | ((((sArr[i2 >>> 24] << 16) | sArr[(i2 >>> 16) & 255]) & BodyPartID.bodyIdMax) << 32);
    }
    ...
    private static long interleave3_13to65(int i2) {
        return (INTERLEAVE5_TABLE[i2 & CertificateBody.profileType] & BodyPartID.bodyIdMax) | ((r0[i2 >>> 7] & BodyPartID.bodyIdMax) << 35);
    }

    private static long interleave3_21to63(int i2) {
        return (INTERLEAVE3_TABLE[i2 & CertificateBody.profileType] & BodyPartID.bodyIdMax) | ((r0[i2 >>> 14] & BodyPartID.bodyIdMax) << 42) | ((r0[(i2 >>> 7) & CertificateBody.profileType] & BodyPartID.bodyIdMax) << 21);
    }

    private static long interleave4_16to64(int i2) {
        return (INTERLEAVE4_TABLE[i2 & 255] & BodyPartID.bodyIdMax) | ((r0[i2 >>> 8] & BodyPartID.bodyIdMax) << 32);
    }
    ...
    private static int reduceInPlace(long[] jArr, int i2, int i3, int i4, int[] iArr) {
        ...
        int min2 = (Math.min(min - max, i4 - i10) + i7) >> 6;
        if (min2 > 1) {
            int i11 = i8 - min2;
    ...
    public LongArray modInverse(int i2, int[] iArr) {
        ...
        while (true) {
            ...
            int i11 = 1 - i3;
            longArrayArr[i3].addShiftedByBitsSafe(longArrayArr[i11], iArr2[i11], i7);
            int degreeFrom = longArrayArr[i3].degreeFrom(i5);
            if (degreeFrom == 0) {
                return longArrayArr2[i11];
            }
            int i12 = iArr3[i11];
            longArrayArr2[i3].addShiftedByBitsSafe(longArrayArr2[i11], i12, i7);
            int i13 = i12 + i7;
            if (i13 > i6) {
                i6 = i13;
            } else if (i13 == i6) {
    ...
    public LongArray modMultiply(LongArray longArray, int i2, int[] iArr) {
        ...
        while (i17 < i7) {
            ...
            while (true) {
                ...
                long j4 = j3 >>> 4;
                i5 = i17;
                addBoth(jArr7, i18, jArr4, iArr2[i19], jArr5, iArr2[((int) j4) & 15], i10);
                j3 = j4 >>> 4;
                if (j3 == 0) {
                    break;
                }
    ...
    public LongArray modMultiplyAlt(LongArray longArray, int i2, int[] iArr) {
        ...
        if (i5 == 1) {
            ...
            multiplyWord(j2, longArray3.m_ints, i6, jArr, 0);
            return reduceResult(jArr, 0, i7, i2, iArr);
        }
        int i8 = 15;
        int i9 = ((i4 + 15) + 63) >>> 6;
        int i10 = i9 * 8;
        ...
        while (i15 < 8) {
            int i16 = i14 + i9;
            shiftUp(jArr2, i5, jArr2, i16, i9, i15);
            i15++;
            i14 = i16;
        }
        int i17 = 0;
        while (true) {
            ...
            do {
                int i19 = i5;
                long j3 = jArr2[i18] >>> i17;
                int i20 = 0;
                while (true) {
                    int i21 = ((int) j3) & i8;
                    if (i21 != 0) {
                        add(jArr2, iArr2[i21] + i18, jArr2, i19, i9);
                    }
                    i20++;
                    if (i20 == 8) {
                        break;
        ...
        while (true) {
            int i24 = i23 - 1;
            if (i24 <= 1) {
                return reduceResult(jArr2, iArr2[1], i7, i2, iArr);
            }
            if ((i24 & 1) == 0) {
                addShiftedUp(jArr2, iArr2[i24 >>> 1], jArr2, iArr2[i24], i7, 16);
            } else {
                distribute(jArr2, iArr2[i24], iArr2[i24 - 1], iArr2[1], i7);
            }
            i23 = i24;
        }
    }
