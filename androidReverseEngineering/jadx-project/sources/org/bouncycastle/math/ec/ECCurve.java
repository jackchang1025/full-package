...
public abstract class ECCurve {
    ...
    /* renamed from: a */
    protected ECFieldElement f1409a;

    /* renamed from: b */
    protected ECFieldElement f1410b;
    ...
    public static abstract class AbstractF2m extends ECCurve {
        ...
        public boolean isKoblitz() {
            return this.order != null && this.cofactor != null && this.f1410b.isOne() && (this.f1409a.isZero() || this.f1409a.isOne());
        }
    ...
    public static abstract class AbstractFp extends ECCurve {
        ...
        public ECPoint decompressPoint(int i2, BigInteger bigInteger) {
            ECFieldElement fromBigInteger = fromBigInteger(bigInteger);
            ECFieldElement sqrt = fromBigInteger.square().add(this.f1409a).multiply(fromBigInteger).add(this.f1410b).sqrt();
            if (sqrt == null) {
                throw new IllegalArgumentException("Invalid point compression");
            }
    ...
    public static class F2m extends AbstractF2m {
        ...
        public ECCurve cloneCurve() {
            return new F2m(this.f1411m, this.f2348k1, this.k2, this.k3, this.f1409a, this.f1410b, this.order, this.cofactor);
        }

        @Override // org.bouncycastle.math.ec.ECCurve
        public ECLookupTable createCacheSafeLookupTable(ECPoint[] eCPointArr, int i2, final int i3) {
            final int i4 = (this.f1411m + 63) >>> 6;
            final int[] iArr = isTrinomial() ? new int[]{this.f2348k1} : new int[]{this.f2348k1, this.k2, this.k3};
            final long[] jArr = new long[i3 * i4 * 2];
            int i5 = 0;
            for (int i6 = 0; i6 < i3; i6++) {
                ECPoint eCPoint = eCPointArr[i2 + i6];
                ((ECFieldElement.F2m) eCPoint.getRawXCoord()).f1415x.copyTo(jArr, i5);
                int i7 = i5 + i4;
                ((ECFieldElement.F2m) eCPoint.getRawYCoord()).f1415x.copyTo(jArr, i7);
                i5 = i7 + i4;
            }
            return new AbstractECLookupTable() { // from class: org.bouncycastle.math.ec.ECCurve.F2m.1
                private ECPoint createPoint(long[] jArr2, long[] jArr3) {
                    return F2m.this.createRawPoint(new ECFieldElement.F2m(F2m.this.f1411m, iArr, new LongArray(jArr2)), new ECFieldElement.F2m(F2m.this.f1411m, iArr, new LongArray(jArr3)));
                }
        ...
        public ECFieldElement fromBigInteger(BigInteger bigInteger) {
            return new ECFieldElement.F2m(this.f1411m, this.f2348k1, this.k2, this.k3, bigInteger);
        }
        ...
        public F2m(int i2, int i3, int i4, int i5, BigInteger bigInteger, BigInteger bigInteger2, BigInteger bigInteger3, BigInteger bigInteger4) {
            ...
            this.f1409a = fromBigInteger(bigInteger);
            this.f1410b = fromBigInteger(bigInteger2);
            this.coord = 6;
        }
        ...
        public F2m(int i2, int i3, int i4, int i5, ECFieldElement eCFieldElement, ECFieldElement eCFieldElement2, BigInteger bigInteger, BigInteger bigInteger2) {
            ...
            this.infinity = new ECPoint.F2m(this, null, null);
            this.f1409a = eCFieldElement;
            this.f1410b = eCFieldElement2;
            this.coord = 6;
        }
    ...
    public static class Fp extends AbstractFp {
        ...
        @Override // org.bouncycastle.math.ec.ECCurve
        public ECCurve cloneCurve() {
            return new Fp(this.f1412q, this.f1413r, this.f1409a, this.f1410b, this.order, this.cofactor);
        }
        ...
        @Override // org.bouncycastle.math.ec.ECCurve
        public ECFieldElement fromBigInteger(BigInteger bigInteger) {
            return new ECFieldElement.Fp(this.f1412q, this.f1413r, bigInteger);
        }

        @Override // org.bouncycastle.math.ec.ECCurve
        public int getFieldSize() {
            return this.f1412q.bitLength();
        }
        ...
        public ECPoint importPoint(ECPoint eCPoint) {
            ...
            return (this == eCPoint.getCurve() || getCoordinateSystem() != 2 || eCPoint.isInfinity() || !((coordinateSystem = eCPoint.getCurve().getCoordinateSystem()) == 2 || coordinateSystem == 3 || coordinateSystem == 4)) ? super.importPoint(eCPoint) : new ECPoint.Fp(this, fromBigInteger(eCPoint.f1419x.toBigInteger()), fromBigInteger(eCPoint.f1420y.toBigInteger()), new ECFieldElement[]{fromBigInteger(eCPoint.zs[0].toBigInteger())});
        }
        ...
        public Fp(BigInteger bigInteger, BigInteger bigInteger2, BigInteger bigInteger3, BigInteger bigInteger4, BigInteger bigInteger5) {
            super(bigInteger);
            this.f1412q = bigInteger;
            this.f1413r = ECFieldElement.Fp.calculateResidue(bigInteger);
            this.infinity = new ECPoint.Fp(this, null, null);
            this.f1409a = fromBigInteger(bigInteger2);
            this.f1410b = fromBigInteger(bigInteger3);
