...
public class ScalarSplitParameters {
    ...
    protected final BigInteger f2349g1;
    ...
    private static void checkVector(BigInteger[] bigIntegerArr, String str) {
        if (bigIntegerArr == null || bigIntegerArr.length != 2 || bigIntegerArr[0] == null || bigIntegerArr[1] == null) {
            throw new IllegalArgumentException(AbstractC0000a.m16l("'", str, "' must consist of exactly 2 (non-null) values"));
        }
    }
