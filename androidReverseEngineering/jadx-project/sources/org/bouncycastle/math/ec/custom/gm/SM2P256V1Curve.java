...
public class SM2P256V1Curve extends ECCurve.AbstractFp {
    ...
    /* renamed from: q */
    public static final BigInteger f1428q = SM2P256V1FieldElement.f1431Q;
    ...
    public SM2P256V1Curve() {
        ...
        this.f1409a = fromBigInteger(new BigInteger(1, Hex.decodeStrict("FFFFFFFEFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFF00000000FFFFFFFFFFFFFFFC")));
        this.f1410b = fromBigInteger(new BigInteger(1, Hex.decodeStrict("28E9FA9E9D9F5E344D5A9E4BCF6509A7F39789F515AB8F92DDBCBD414D940E93")));
    ...
    public ECLookupTable createCacheSafeLookupTable(ECPoint[] eCPointArr, int i2, final int i3) {
        ...
        for (int i5 = 0; i5 < i3; i5++) {
            ...
            Nat256.copy(((SM2P256V1FieldElement) eCPoint.getRawXCoord()).f1432x, 0, iArr, i4);
            int i6 = i4 + 8;
            Nat256.copy(((SM2P256V1FieldElement) eCPoint.getRawYCoord()).f1432x, 0, iArr, i6);
            i4 = i6 + 8;
        }
