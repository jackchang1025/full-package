...
public class SecT131R2Point extends ECPoint.AbstractF2m {
    ...
    public ECPoint twice() {
        ...
        if (m1026t.isZero()) {
            return new SecT131R2Point(curve, m1026t, curve.getB().sqrt());
        }
        ...
        return new SecT131R2Point(curve, square2, eCFieldElement.squarePlusProduct(m1026t, multiply).add(square2).add(multiply2), new ECFieldElement[]{multiply2});
    }
