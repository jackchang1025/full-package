...
public class SecP160R1Field {
    ...
    /* renamed from: M */
    private static final long f1440M = 4294967295L;
    private static final int P4 = -1;
    private static final int PExt9 = -1;
    private static final int PInv = -2147483647;

    /* renamed from: P */
    static final int[] f1441P = {Integer.MAX_VALUE, -1, -1, -1, -1};
    ...
    public static void add(int[] iArr, int[] iArr2, int[] iArr3) {
        if (Nat160.add(iArr, iArr2, iArr3) != 0 || (iArr3[4] == -1 && Nat160.gte(iArr3, f1441P))) {
    ...
    public static void addOne(int[] iArr, int[] iArr2) {
        if (Nat.inc(5, iArr, iArr2) != 0 || (iArr2[4] == -1 && Nat160.gte(iArr2, f1441P))) {
    ...
    public static void half(int[] iArr, int[] iArr2) {
        if ((iArr[0] & 1) == 0) {
            ...
            Nat.shiftDownBit(5, iArr2, Nat160.add(iArr, f1441P, iArr2));
        }
    }

    public static void inv(int[] iArr, int[] iArr2) {
        Mod.checkedModOddInverse(f1441P, iArr, iArr2);
    }
    ...
    public static void random(SecureRandom secureRandom, int[] iArr) {
        ...
        } while (Nat.lessThan(5, iArr, f1441P) == 0);
    }
    ...
    public static void reduce(int[] iArr, int[] iArr2) {
        ...
        iArr2[0] = (int) j7;
        long j8 = (iArr[1] & 4294967295L) + j3 + (j3 << 31) + (j7 >>> 32);
        iArr2[1] = (int) j8;
        long j9 = (iArr[2] & 4294967295L) + j4 + (j4 << 31) + (j8 >>> 32);
        iArr2[2] = (int) j9;
        long j10 = (iArr[3] & 4294967295L) + j5 + (j5 << 31) + (j9 >>> 32);
        iArr2[3] = (int) j10;
        long j11 = (4294967295L & iArr[4]) + j6 + (j6 << 31) + (j10 >>> 32);
        iArr2[4] = (int) j11;
        reduce32((int) (j11 >>> 32), iArr2);
    }

    public static void reduce32(int i2, int[] iArr) {
        if ((i2 == 0 || Nat160.mulWordsAdd(PInv, i2, iArr, 0) == 0) && !(iArr[4] == -1 && Nat160.gte(iArr, f1441P))) {
            return;
        }
    ...
    public static void twice(int[] iArr, int[] iArr2) {
        if (Nat.shiftUpBit(5, iArr, 0, iArr2) != 0 || (iArr2[4] == -1 && Nat160.gte(iArr2, f1441P))) {
            Nat.addWordTo(5, PInv, iArr2);
        }
    }
}
