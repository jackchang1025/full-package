...
public class SecP128R1Field {
    ...
    public static void addOne(int[] iArr, int[] iArr2) {
        if (Nat.inc(4, iArr, iArr2) != 0 || ((iArr2[3] >>> 1) >= 2147483646 && Nat128.gte(iArr2, f1435P))) {
            addPInvTo(iArr2);
        }
    }
    ...
    public static void half(int[] iArr, int[] iArr2) {
        if ((iArr[0] & 1) == 0) {
            ...
            Nat.shiftDownBit(4, iArr2, Nat128.add(iArr, f1435P, iArr2));
        }
    }

    public static void inv(int[] iArr, int[] iArr2) {
        Mod.checkedModOddInverse(f1435P, iArr, iArr2);
    }
    ...
    public static void random(SecureRandom secureRandom, int[] iArr) {
        ...
        } while (Nat.lessThan(4, iArr, f1435P) == 0);
    }
    ...
    public static void reduce32(int i2, int[] iArr) {
        while (i2 != 0) {
            ...
            long j7 = (4294967295L & iArr[3]) + (j2 << 1) + j4;
            iArr[3] = (int) j7;
            i2 = (int) (j7 >> 32);
        }
        if ((iArr[3] >>> 1) < 2147483646 || !Nat128.gte(iArr, f1435P)) {
            return;
        }
        addPInvTo(iArr);
    }
    ...
    public static void twice(int[] iArr, int[] iArr2) {
        if (Nat.shiftUpBit(4, iArr, 0, iArr2) != 0 || ((iArr2[3] >>> 1) >= 2147483646 && Nat128.gte(iArr2, f1435P))) {
            addPInvTo(iArr2);
        }
    }
}
