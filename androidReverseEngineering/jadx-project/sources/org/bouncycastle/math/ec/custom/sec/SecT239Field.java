...
public class SecT239Field {
    ...
    public static void implMulwAcc(long[] jArr, long j2, long j3, long[] jArr2, int i2) {
        ...
        jArr2[i2] = jArr2[i2] ^ (M60 & j8);
        int i6 = i2 + 1;
        jArr2[i6] = ((((((j2 & 585610922974906400L) & ((j3 << 4) >> 63)) >>> 5) ^ j9) << 4) ^ (j8 >>> 60)) ^ jArr2[i6];
    }
    ...
    public static void sqrt(long[] jArr, long[] jArr2) {
        ...
        while (i2 < i3) {
            ...
            int i5 = i4 >>> 6;
            int i6 = i4 & 63;
            createExt64[i5] = createExt64[i5] ^ (j3 << i6);
            int i7 = i5 + 1;
            int[] iArr2 = iArr;
            int i8 = -i6;
            createExt64[i7] = createExt64[i7] ^ ((j8 << i6) | (j3 >>> i8));
            int i9 = i5 + 2;
            createExt64[i9] = createExt64[i9] ^ ((j7 << i6) | (j8 >>> i8));
            int i10 = i5 + 3;
            createExt64[i10] = createExt64[i10] ^ ((j6 << i6) | (j7 >>> i8));
            int i11 = i5 + 4;
            createExt64[i11] = createExt64[i11] ^ (j6 >>> i8);
            i2++;
            i3 = 2;
            iArr = iArr2;
        }
