...
public class SecT233R1Point extends ECPoint.AbstractF2m {
    ...
    public ECPoint twice() {
        ...
        ECFieldElement m1026t = AbstractC0413b.m1026t(eCFieldElement2, multiply, square);
        if (m1026t.isZero()) {
            return new SecT233R1Point(curve, m1026t, curve.getB().sqrt());
        }
        ...
        return new SecT233R1Point(curve, square2, eCFieldElement.squarePlusProduct(m1026t, multiply).add(square2).add(multiply2), new ECFieldElement[]{multiply2});
    }
