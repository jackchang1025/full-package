...
public class SecT233R1Curve extends ECCurve.AbstractF2m {
    ...
    public SecT233R1Curve() {
        ...
        this.f1410b = fromBigInteger(new BigInteger(1, Hex.decodeStrict("0066647EDE6C332C7F8C0923BB58213B333B20E9CE4281FE115F7D8F90AD")));
    ...
    public ECLookupTable createCacheSafeLookupTable(ECPoint[] eCPointArr, int i2, final int i3) {
        ...
        for (int i5 = 0; i5 < i3; i5++) {
            ...
            Nat256.copy64(((SecT233FieldElement) eCPoint.getRawXCoord()).f1488x, 0, jArr, i4);
            int i6 = i4 + 4;
            Nat256.copy64(((SecT233FieldElement) eCPoint.getRawYCoord()).f1488x, 0, jArr, i6);
            i4 = i6 + 4;
        }
