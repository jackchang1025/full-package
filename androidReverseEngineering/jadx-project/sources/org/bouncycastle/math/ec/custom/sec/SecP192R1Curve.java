...
public class SecP192R1Curve extends ECCurve.AbstractFp {
    ...
    /* renamed from: q */
    public static final BigInteger f1452q = SecP192R1FieldElement.f1455Q;
    ...
    public SecP192R1Curve() {
        ...
        this.f1409a = fromBigInteger(new BigInteger(1, Hex.decodeStrict("FFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFEFFFFFFFFFFFFFFFC")));
        this.f1410b = fromBigInteger(new BigInteger(1, Hex.decodeStrict("64210519E59C80E70FA7E9AB72243049FEB8DEECC146B9B1")));
    ...
    public ECLookupTable createCacheSafeLookupTable(ECPoint[] eCPointArr, int i2, final int i3) {
        ...
        for (int i5 = 0; i5 < i3; i5++) {
            ...
            Nat192.copy(((SecP192R1FieldElement) eCPoint.getRawXCoord()).f1456x, 0, iArr, i4);
            int i6 = i4 + 6;
            Nat192.copy(((SecP192R1FieldElement) eCPoint.getRawYCoord()).f1456x, 0, iArr, i6);
            i4 = i6 + 6;
        }
