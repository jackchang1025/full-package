...
public class SecP256R1Curve extends ECCurve.AbstractFp {
    ...
    /* renamed from: q */
    public static final BigInteger f1470q = SecP256R1FieldElement.f1473Q;
    ...
    public SecP256R1Curve() {
        ...
        this.f1409a = fromBigInteger(new BigInteger(1, Hex.decodeStrict("FFFFFFFF00000001000000000000000000000000FFFFFFFFFFFFFFFFFFFFFFFC")));
        this.f1410b = fromBigInteger(new BigInteger(1, Hex.decodeStrict("5AC635D8AA3A93E7B3EBBD55769886BC651D06B0CC53B0F63BCE3C3E27D2604B")));
    ...
    public ECLookupTable createCacheSafeLookupTable(ECPoint[] eCPointArr, int i2, final int i3) {
        ...
        for (int i5 = 0; i5 < i3; i5++) {
            ...
            Nat256.copy(((SecP256R1FieldElement) eCPoint.getRawXCoord()).f1474x, 0, iArr, i4);
            int i6 = i4 + 8;
            Nat256.copy(((SecP256R1FieldElement) eCPoint.getRawYCoord()).f1474x, 0, iArr, i6);
            i4 = i6 + 8;
        }
