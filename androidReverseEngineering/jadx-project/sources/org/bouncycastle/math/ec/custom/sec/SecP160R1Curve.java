...
public class SecP160R1Curve extends ECCurve.AbstractFp {
    ...
    /* renamed from: q */
    public static final BigInteger f1439q = SecP160R1FieldElement.f1442Q;
    ...
    public SecP160R1Curve() {
        ...
        this.f1409a = fromBigInteger(new BigInteger(1, Hex.decodeStrict("FFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFF7FFFFFFC")));
        this.f1410b = fromBigInteger(new BigInteger(1, Hex.decodeStrict("1C97BEFC54BD7A8B65ACF89F81D4D4ADC565FA45")));
    ...
    public ECLookupTable createCacheSafeLookupTable(ECPoint[] eCPointArr, int i2, final int i3) {
        ...
        for (int i5 = 0; i5 < i3; i5++) {
            ...
            Nat160.copy(((SecP160R1FieldElement) eCPoint.getRawXCoord()).f1443x, 0, iArr, i4);
            int i6 = i4 + 5;
            Nat160.copy(((SecP160R1FieldElement) eCPoint.getRawYCoord()).f1443x, 0, iArr, i6);
            i4 = i6 + 5;
        }
