...
public class SecP160R2Curve extends ECCurve.AbstractFp {
    ...
    /* renamed from: q */
    public static final BigInteger f1444q = SecP160R2FieldElement.f1446Q;
    ...
    public SecP160R2Curve() {
        ...
        this.f1409a = fromBigInteger(new BigInteger(1, Hex.decodeStrict("FFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFEFFFFAC70")));
        this.f1410b = fromBigInteger(new BigInteger(1, Hex.decodeStrict("B4E134D3FB59EB8BAB57274904664D5AF50388BA")));
    ...
    public ECLookupTable createCacheSafeLookupTable(ECPoint[] eCPointArr, int i2, final int i3) {
        ...
        for (int i5 = 0; i5 < i3; i5++) {
            ...
            Nat160.copy(((SecP160R2FieldElement) eCPoint.getRawXCoord()).f1447x, 0, iArr, i4);
            int i6 = i4 + 5;
            Nat160.copy(((SecP160R2FieldElement) eCPoint.getRawYCoord()).f1447x, 0, iArr, i6);
            i4 = i6 + 5;
        }
