...
public class SecP256K1Curve extends ECCurve.AbstractFp {
    ...
    /* renamed from: q */
    public static final BigInteger f1466q = SecP256K1FieldElement.f1468Q;
    ...
    public ECLookupTable createCacheSafeLookupTable(ECPoint[] eCPointArr, int i2, final int i3) {
        ...
        for (int i5 = 0; i5 < i3; i5++) {
            ...
            Nat256.copy(((SecP256K1FieldElement) eCPoint.getRawXCoord()).f1469x, 0, iArr, i4);
            int i6 = i4 + 8;
            Nat256.copy(((SecP256K1FieldElement) eCPoint.getRawYCoord()).f1469x, 0, iArr, i6);
            i4 = i6 + 8;
        }
