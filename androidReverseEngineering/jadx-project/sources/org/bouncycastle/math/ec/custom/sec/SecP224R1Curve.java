...
public class SecP224R1Curve extends ECCurve.AbstractFp {
    ...
    /* renamed from: q */
    public static final BigInteger f1461q = SecP224R1FieldElement.f1464Q;
    ...
    public SecP224R1Curve() {
        ...
        this.f1409a = fromBigInteger(new BigInteger(1, Hex.decodeStrict("FFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFEFFFFFFFFFFFFFFFFFFFFFFFE")));
        this.f1410b = fromBigInteger(new BigInteger(1, Hex.decodeStrict("B4050A850C04B3ABF54132565044B0B7D7BFD8BA270B39432355FFB4")));
    ...
    public ECLookupTable createCacheSafeLookupTable(ECPoint[] eCPointArr, int i2, final int i3) {
        ...
        for (int i5 = 0; i5 < i3; i5++) {
            ...
            Nat224.copy(((SecP224R1FieldElement) eCPoint.getRawXCoord()).f1465x, 0, iArr, i4);
            int i6 = i4 + 7;
            Nat224.copy(((SecP224R1FieldElement) eCPoint.getRawYCoord()).f1465x, 0, iArr, i6);
            i4 = i6 + 7;
        }
