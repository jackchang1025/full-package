...
public class SecT163K1Point extends ECPoint.AbstractF2m {
    ...
    public ECPoint twice() {
        ...
        ECFieldElement m1026t = AbstractC0413b.m1026t(eCFieldElement2, multiply, eCFieldElement3);
        if (m1026t.isZero()) {
            return new SecT163K1Point(curve, m1026t, curve.getB());
        }
        ECFieldElement square = m1026t.square();
        ECFieldElement multiply2 = isOne ? m1026t : m1026t.multiply(eCFieldElement3);
        ECFieldElement square2 = eCFieldElement2.add(eCFieldElement).square();
        return new SecT163K1Point(curve, square, square2.add(m1026t).add(eCFieldElement3).multiply(square2).add(square), new ECFieldElement[]{multiply2});
    }
