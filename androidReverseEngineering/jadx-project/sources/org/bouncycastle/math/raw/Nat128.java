...
public abstract class Nat128 {
    ...
    /* renamed from: M */
    private static final long f1517M = 4294967295L;
    ...
    public static int mulAddTo(int[] iArr, int i2, int[] iArr2, int i3, int[] iArr3, int i4) {
        ...
        while (i5 < 4) {
            ...
            iArr3[i6 + 3] = (int) j14;
            long j15 = (j14 >>> 32) + (iArr3[r10] & 4294967295L) + j7;
            iArr3[i6 + 4] = (int) j15;
            j7 = j15 >>> 32;
            i5++;
            i6 = i7;
    ...
    public static void square(int[] iArr, int i2, int[] iArr2, int i3) {
        ...
        while (true) {
            ...
            if (i7 <= 0) {
                ...
                long j13 = (iArr2[r24] & 4294967295L) + (j11 >>> 32);
                long j14 = (j2 * j12) + (m1007a & 4294967295L);
                int i12 = (int) j14;
                iArr2[i3 + 3] = (i12 << 1) | (i11 >>> 31);
                long m1007a2 = AbstractC0413b.m1007a(j7, j12, j14 >>> 32, j11 & 4294967295L);
                long m1007a3 = AbstractC0413b.m1007a(j12, j9, m1007a2 >>> 32, j13 & 4294967295L);
                long j15 = (iArr2[r25] & 4294967295L) + (j13 >>> 32) + (m1007a3 >>> 32);
                int i13 = (int) m1007a2;
                ...
                int i17 = i16 >>> 31;
                int i18 = i3 + 7;
                iArr2[i18] = i17 | ((iArr2[i18] + ((int) (j15 >>> 32))) << 1);
                return;
            }
            i6 = i7;
        }
    ...
    public static void mul(int[] iArr, int[] iArr2, int[] iArr3) {
        ...
        for (int i3 = 4; i2 < i3; i3 = 4) {
            ...
            int i4 = i2;
            long j12 = (j11 * j2) + (iArr3[r3] & 4294967295L) + 0;
            iArr3[i2 + 0] = (int) j12;
            int i5 = i4 + 1;
            long j13 = (j11 * j3) + (iArr3[i5] & 4294967295L) + (j12 >>> c);
            iArr3[i5] = (int) j13;
            long j14 = (j11 * j4) + (iArr3[r8] & 4294967295L) + (j13 >>> 32);
            iArr3[i4 + 2] = (int) j14;
            c = ' ';
            long j15 = (j11 * j5) + (iArr3[r5] & 4294967295L) + (j14 >>> 32);
            iArr3[i4 + 3] = (int) j15;
    ...
    public static void square(int[] iArr, int[] iArr2) {
        ...
        while (true) {
            ...
            if (i5 <= 0) {
                ...
                long j15 = (j2 * j12) + (m1007a & 4294967295L);
                int i10 = (int) j15;
                iArr2[3] = (i10 << 1) | (i9 >>> 31);
                long m1007a2 = AbstractC0413b.m1007a(j7, j12, j15 >>> 32, j14);
                long m1007a3 = AbstractC0413b.m1007a(j12, j9, m1007a2 >>> 32, j13 & 4294967295L);
                long j16 = (iArr2[6] & 4294967295L) + (j13 >>> 32) + (m1007a3 >>> 32);
                int i11 = (int) m1007a2;
                iArr2[4] = (i10 >>> 31) | (i11 << 1);
                int i12 = i11 >>> 31;
                int i13 = (int) (4294967295L & m1007a3);
                iArr2[5] = i12 | (i13 << 1);
                int i14 = i13 >>> 31;
                int i15 = (int) j16;
                iArr2[6] = i14 | (i15 << 1);
                iArr2[7] = ((iArr2[7] + ((int) (j16 >>> 32))) << 1) | (i15 >>> 31);
                return;
            }
            i4 = i5;
            i3 = i7;
