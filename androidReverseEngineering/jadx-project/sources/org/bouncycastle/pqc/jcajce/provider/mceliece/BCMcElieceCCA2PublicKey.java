...
public class BCMcElieceCCA2PublicKey implements CipherParameters, PublicKey {
    ...
    public String toString() {
        StringBuilder m22r = AbstractC0000a.m22r("McEliecePublicKey:\n length of the code         : " + this.params.getN() + "\n", " error correction capability: ");
        m22r.append(this.params.getT());
        m22r.append("\n");
        StringBuilder m22r2 = AbstractC0000a.m22r(m22r.toString(), " generator matrix           : ");
        m22r2.append(this.params.getG().toString());
