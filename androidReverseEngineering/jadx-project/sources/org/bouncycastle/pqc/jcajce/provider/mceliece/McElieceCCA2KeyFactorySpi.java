...
public class McElieceCCA2KeyFactorySpi extends KeyFactorySpi implements AsymmetricKeyInfoConverter {
    ...
    public PrivateKey engineGeneratePrivate(KeySpec keySpec) {
        ...
        try {
            ...
            throw new InvalidKeySpecException(AbstractC0000a.m13i("Unable to decode PKCS8EncodedKeySpec: ", e2));
        }
    }
    ...
    public PublicKey engineGeneratePublic(KeySpec keySpec) {
        ...
        try {
            ...
            try {
                ...
                throw new InvalidKeySpecException(AbstractC0000a.m8d(e2, new StringBuilder("Unable to decode X509EncodedKeySpec: ")));
            }
