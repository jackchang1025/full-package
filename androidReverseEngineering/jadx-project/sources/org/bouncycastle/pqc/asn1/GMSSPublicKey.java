...
public class GMSSPublicKey extends ASN1Object {
    ...
    private GMSSPublicKey(ASN1Sequence aSN1Sequence) {
        if (aSN1Sequence.size() != 2) {
            throw new IllegalArgumentException(AbstractC0413b.m1012f(aSN1Sequence, new StringBuilder("size of seq = ")));
        }
        this.version = ASN1Integer.getInstance(aSN1Sequence.getObjectAt(0));
        this.publicKey = AbstractC0413b.m1006D(aSN1Sequence, 1);
    }
