...
public class RainbowPrivateKey extends ASN1Object {
    ...
    private RainbowPrivateKey(ASN1Sequence aSN1Sequence) {
        ...
        this.f2350b1 = ((ASN1OctetString) ((ASN1Sequence) aSN1Sequence.getObjectAt(2)).getObjectAt(0)).getOctets();
    ...
    public short[] getB1() {
        return RainbowUtil.convertArray(this.f2350b1);
    }
    ...
    public ASN1Primitive toASN1Primitive() {
        ...
        m25u.add(new DEROctetString(this.f2350b1));
        aSN1EncodableVector.add(new DERSequence(m25u));
        ASN1EncodableVector aSN1EncodableVector3 = new ASN1EncodableVector();
        for (int i3 = 0; i3 < this.invA2.length; i3++) {
            aSN1EncodableVector3.add(new DEROctetString(this.invA2[i3]));
        }
        ASN1EncodableVector m25u2 = AbstractC0000a.m25u(aSN1EncodableVector3, aSN1EncodableVector);
        m25u2.add(new DEROctetString(this.b2));
        ...
        for (int i4 = 0; i4 < this.layers.length; i4++) {
            ...
            for (int i5 = 0; i5 < convertArray.length; i5++) {
                ...
                for (int i6 = 0; i6 < convertArray[i5].length; i6++) {
                    aSN1EncodableVector8.add(new DEROctetString(convertArray[i5][i6]));
                }
            ...
            for (int i7 = 0; i7 < convertArray2.length; i7++) {
                ...
                for (int i8 = 0; i8 < convertArray2[i7].length; i8++) {
                    aSN1EncodableVector10.add(new DEROctetString(convertArray2[i7][i8]));
                }
            ...
            aSN1EncodableVector6.add(new DEROctetString(RainbowUtil.convertArray(this.layers[i4].getCoeffEta())));
    ...
    public RainbowPrivateKey(short[][] sArr, short[] sArr2, short[][] sArr3, short[] sArr4, int[] iArr, Layer[] layerArr) {
        ...
        this.f2350b1 = RainbowUtil.convertArray(sArr2);
