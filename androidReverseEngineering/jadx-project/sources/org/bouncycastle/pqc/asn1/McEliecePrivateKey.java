...
public class McEliecePrivateKey extends ASN1Object {
    ...
    public ASN1Primitive toASN1Primitive() {
        ...
        aSN1EncodableVector.add(new ASN1Integer(this.f1528n));
        aSN1EncodableVector.add(new ASN1Integer(this.f1527k));
    ...
    private McEliecePrivateKey(ASN1Sequence aSN1Sequence) {
        this.f1528n = ((ASN1Integer) aSN1Sequence.getObjectAt(0)).intValueExact();
        this.f1527k = ((ASN1Integer) aSN1Sequence.getObjectAt(1)).intValueExact();
