...
public class Treehash {
    ...
    public void initialize() {
        if (!this.seedInitialized) {
            throw new IllegalStateException(AbstractC0000a.m17m(new StringBuilder("Seed "), this.maxHeight, " not initialized"));
        }
    ...
    public String toString() {
        ...
        for (int i3 = 0; i3 < this.tailLength + 3; i3++) {
            if (getStatByte()[i3] != null) {
                m22r = AbstractC0000a.m20p(str);
                m22r.append(new String(Hex.encode(getStatByte()[i3])));
                m22r.append(" ");
            } else {
                m22r = AbstractC0000a.m22r(str, "null ");
            }
            str = m22r.toString();
        }
        StringBuilder m22r2 = AbstractC0000a.m22r(str, "  ");
        m22r2.append(this.messDigestTree.getDigestSize());
        return m22r2.toString();
    }
