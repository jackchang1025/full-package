...
class LMOtsSignature implements Encodable {
    ...
    /* renamed from: C */
    private final byte[] f1558C;
    private final LMOtsParameters type;

    /* renamed from: y */
    private final byte[] f1559y;
    ...
    public boolean equals(Object obj) {
        ...
        if (Arrays.equals(this.f1558C, lMOtsSignature.f1558C)) {
            return Arrays.equals(this.f1559y, lMOtsSignature.f1559y);
        }
        return false;
    }
    ...
    public byte[] getEncoded() {
        return Composer.compose().u32str(this.type.getType()).bytes(this.f1558C).bytes(this.f1559y).build();
    }
    ...
    public int hashCode() {
        LMOtsParameters lMOtsParameters = this.type;
        return Arrays.hashCode(this.f1559y) + ((Arrays.hashCode(this.f1558C) + ((lMOtsParameters != null ? lMOtsParameters.hashCode() : 0) * 31)) * 31);
    }
}
