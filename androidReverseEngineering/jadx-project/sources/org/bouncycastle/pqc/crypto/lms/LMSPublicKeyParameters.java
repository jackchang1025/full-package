...
public class LMSPublicKeyParameters extends LMSKeyParameters implements LMSContextBasedVerifier {
    ...
    public LMSPublicKeyParameters(LMSigParameters lMSigParameters, LMOtsParameters lMOtsParameters, byte[] bArr, byte[] bArr2) {
        ...
        this.f1563I = Arrays.clone(bArr2);
    ...
    public boolean equals(Object obj) {
        ...
        if (this.parameterSet.equals(lMSPublicKeyParameters.parameterSet) && this.lmOtsType.equals(lMSPublicKeyParameters.lmOtsType) && Arrays.areEqual(this.f1563I, lMSPublicKeyParameters.f1563I)) {
    ...
    public LMSContext generateOtsContext(LMSSignature lMSSignature) {
        ...
        if (lMSSignature.getOtsSignature().getType().getType() == type) {
            return new LMOtsPublicKey(LMOtsParameters.getParametersForType(type), this.f1563I, lMSSignature.getQ(), null).createOtsContext(lMSSignature);
        }
    ...
    public byte[] getI() {
        return Arrays.clone(this.f1563I);
    }
    ...
    public int hashCode() {
        return Arrays.hashCode(this.T1) + ((Arrays.hashCode(this.f1563I) + ((this.lmOtsType.hashCode() + (this.parameterSet.hashCode() * 31)) * 31)) * 31);
    }
    ...
    public byte[] toByteArray() {
        return Composer.compose().u32str(this.parameterSet.getType()).u32str(this.lmOtsType.getType()).bytes(this.f1563I).bytes(this.T1).build();
    }
