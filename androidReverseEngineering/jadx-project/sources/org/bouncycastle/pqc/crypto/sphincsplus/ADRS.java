...
class ADRS {
    ...
    public void setChainAddress(int i2) {
        Pack.intToBigEndian(i2, this.value, 24);
    }

    public void setHashAddress(int i2) {
        Pack.intToBigEndian(i2, this.value, 28);
    }

    public void setKeyPairAddress(int i2) {
        Pack.intToBigEndian(i2, this.value, 20);
    }

    public void setLayerAddress(int i2) {
        Pack.intToBigEndian(i2, this.value, 0);
    }

    public void setTreeAddress(long j2) {
        Pack.longToBigEndian(j2, this.value, 8);
    }
    ...
    public void setType(int i2) {
        Pack.intToBigEndian(i2, this.value, 16);
