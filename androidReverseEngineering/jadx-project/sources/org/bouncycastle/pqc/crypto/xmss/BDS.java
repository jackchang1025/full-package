    ...
    private void initialize(byte[] bArr, byte[] bArr2, OTSHashAddress oTSHashAddress) {
        ...
        for (int i2 = 0; i2 < (1 << this.treeHeight); i2++) {
            ...
            while (!this.stack.isEmpty() && this.stack.peek().getHeight() == lTree.getHeight()) {
                ...
                if (height == 3 && lTree.getHeight() < this.treeHeight - this.f1618k) {
                    this.treeHashInstances.get(lTree.getHeight()).setNode(lTree);
                }
                if (height >= 3 && (height & 1) == 1 && lTree.getHeight() >= this.treeHeight - this.f1618k && lTree.getHeight() <= this.treeHeight - 2) {
    ...
    private void nextAuthenticationPath(byte[] bArr, byte[] bArr2, OTSHashAddress oTSHashAddress) {
        ...
        if (calculateTau == 0) {
            ...
            for (int i4 = 0; i4 < calculateTau; i4++) {
                if (i4 < this.treeHeight - this.f1618k) {
            ...
            int min = Math.min(calculateTau, this.treeHeight - this.f1618k);
        ...
        for (int i7 = 0; i7 < ((this.treeHeight - this.f1618k) >> 1); i7++) {
