...
class ProvX509TrustManager extends BCX509ExtendedTrustManager {
    ...
    public ProvX509TrustManager(boolean z2, JcaJceHelper jcaJceHelper, PKIXParameters pKIXParameters) {
    ...
    private static void addKeyUsageServer(Map<String, Integer> map, int i2, int... iArr) {
        for (int i3 : iArr) {
            if (map.put(JsseUtils.getAuthTypeServer(i3), Integer.valueOf(i2)) != null) {
    ...
    public static void checkEndpointID(String str, X509Certificate x509Certificate, String str2) {
        boolean z2;
        ...
        HostnameUtil.checkHostname(stripSquareBrackets, x509Certificate, z2);
    }

    public static void checkExtendedTrust(X509Certificate[] x509CertificateArr, TransportData transportData, boolean z2) {
        if (transportData != null) {
            ...
            if (JsseUtils.isNameSpecified(endpointIdentificationAlgorithm)) {
                ...
                checkEndpointID(x509CertificateArr[0], endpointIdentificationAlgorithm, z2, handshakeSession);
            }
        }
    }

    private void checkTrusted(X509Certificate[] x509CertificateArr, String str, TransportData transportData, boolean z2) {
        ...
        checkExtendedTrust(validateChain(x509CertificateArr, str, transportData, z2), transportData, z2);
    }
    ...
    public static int getRequiredKeyUsage(boolean z2, String str) {
        if (!z2) {
            return 0;
        }
        ...
        throw new CertificateException(AbstractC0000a.m15k("Unsupported server authType: ", str));
    }
    ...
    private X509Certificate[] validateChain(X509Certificate[] x509CertificateArr, String str, TransportData transportData, boolean z2) {
        try {
            ...
            ProvAlgorithmChecker.checkCertPathExtras(this.helper, algorithmConstraints, buildCertPath, getRequiredExtendedKeyUsage(z2), getRequiredKeyUsage(z2, str));
    ...
    public ProvX509TrustManager(boolean z2, JcaJceHelper jcaJceHelper, Set<TrustAnchor> set) {
        this.isInFipsMode = z2;
        this.helper = jcaJceHelper;
    ...
    private static void checkEndpointID(X509Certificate x509Certificate, String str, boolean z2, BCExtendedSSLSession bCExtendedSSLSession) {
        BCSNIHostName sNIHostName;
        String peerHost = bCExtendedSSLSession.getPeerHost();
        if (z2 && (sNIHostName = JsseUtils.getSNIHostName(bCExtendedSSLSession.getRequestedServerNames())) != null) {
            ...
            if (!asciiName.equalsIgnoreCase(peerHost)) {
                try {
                    ...
                    LOG.log(Level.FINE, "Server's endpoint ID did not match the SNI host_name: ".concat(asciiName), (Throwable) e2);
                }
            }
        }
