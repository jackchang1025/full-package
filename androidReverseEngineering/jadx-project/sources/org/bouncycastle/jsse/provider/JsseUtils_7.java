...
abstract class JsseUtils_7 extends JsseUtils {
    ...
    public static AlgorithmConstraints exportAlgorithmConstraints(BCAlgorithmConstraints bCAlgorithmConstraints) {
    ...
    public static CryptoPrimitive exportCryptoPrimitive(BCCryptoPrimitive bCCryptoPrimitive) {
        switch (C06761.$SwitchMap$org$bouncycastle$jsse$java$security$BCCryptoPrimitive[bCCryptoPrimitive.ordinal()]) {
            case 1:
    ...
    public static Set<CryptoPrimitive> exportCryptoPrimitives(Set<BCCryptoPrimitive> set) {
        if (JsseUtils.SIGNATURE_CRYPTO_PRIMITIVES_BC == set) {
            return SIGNATURE_CRYPTO_PRIMITIVES;
        }
        if (JsseUtils.KEY_AGREEMENT_CRYPTO_PRIMITIVES_BC == set) {
            return KEY_AGREEMENT_CRYPTO_PRIMITIVES;
        }
        if (JsseUtils.KEY_ENCAPSULATION_CRYPTO_PRIMITIVES_BC == set) {
    ...
    public static BCAlgorithmConstraints importAlgorithmConstraints(AlgorithmConstraints algorithmConstraints) {
    ...
    public static BCCryptoPrimitive importCryptoPrimitive(CryptoPrimitive cryptoPrimitive) {
        switch (C06761.$SwitchMap$java$security$CryptoPrimitive[cryptoPrimitive.ordinal()]) {
            case 1:
