...
public final class SqlTypesSupport {
    ...
    static {
        ...
        if (z2) {
            DATE_DATE_TYPE = new DefaultDateTypeAdapter.DateType<java.sql.Date>(java.sql.Date.class) { // from class: com.google.json.internal.sql.SqlTypesSupport.1
            ...
            TIMESTAMP_DATE_TYPE = new DefaultDateTypeAdapter.DateType<Timestamp>(Timestamp.class) { // from class: com.google.json.internal.sql.SqlTypesSupport.2
                /* JADX WARN: Can't rename method to resolve collision */
                @Override // com.google.json.internal.bind.DefaultDateTypeAdapter.DateType
