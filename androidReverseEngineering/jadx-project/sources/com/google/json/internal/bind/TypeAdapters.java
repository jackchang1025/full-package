...
public final class TypeAdapters {
    ...
    /* renamed from: com.google.json.internal.bind.TypeAdapters$35, reason: invalid class name */
    public static /* synthetic */ class AnonymousClass35 {
        ...
        static {
            ...
            try {
                $SwitchMap$com$google$json$stream$JsonToken[JsonToken.STRING.ordinal()] = 2;
            } catch (NoSuchFieldError unused2) {
            }
            try {
                $SwitchMap$com$google$json$stream$JsonToken[JsonToken.BOOLEAN.ordinal()] = 3;
            } catch (NoSuchFieldError unused3) {
            }
            try {
                $SwitchMap$com$google$json$stream$JsonToken[JsonToken.BEGIN_ARRAY.ordinal()] = 4;
            } catch (NoSuchFieldError unused4) {
            }
            try {
                $SwitchMap$com$google$json$stream$JsonToken[JsonToken.BEGIN_OBJECT.ordinal()] = 5;
    ...
    public static final class EnumTypeAdapter<T extends Enum<T>> extends TypeAdapter<T> {
        ...
        public EnumTypeAdapter(final Class<T> cls) {
            try {
                for (Field field : (Field[]) AccessController.doPrivileged(new PrivilegedAction<Field[]>() { // from class: com.google.json.internal.bind.TypeAdapters.EnumTypeAdapter.1
    ...
    static {
        TypeAdapter<Class> nullSafe = new TypeAdapter<Class>() { // from class: com.google.json.internal.bind.TypeAdapters.1
        ...
        TypeAdapter<BitSet> nullSafe2 = new TypeAdapter<BitSet>() { // from class: com.google.json.internal.bind.TypeAdapters.2
            @Override // com.google.json.TypeAdapter
            public BitSet read(JsonReader jsonReader) {
                ...
                while (peek != JsonToken.END_ARRAY) {
                    int i3 = AnonymousClass35.$SwitchMap$com$google$json$stream$JsonToken[peek.ordinal()];
                    boolean z2 = true;
                    if (i3 == 1 || i3 == 2) {
                        ...
                        if (nextInt == 0) {
                            ...
                            StringBuilder m21q = AbstractC0000a.m21q("Invalid bitset value ", nextInt, ", expected 0 or 1; at path ");
                            m21q.append(jsonReader.getPreviousPath());
                            throw new JsonSyntaxException(m21q.toString());
                        }
                    } else {
                        if (i3 != 3) {
        ...
        TypeAdapter<Boolean> typeAdapter = new TypeAdapter<Boolean>() { // from class: com.google.json.internal.bind.TypeAdapters.3
            /* JADX WARN: Can't rename method to resolve collision */
            @Override // com.google.json.TypeAdapter
        ...
        BOOLEAN = typeAdapter;
        BOOLEAN_AS_STRING = new TypeAdapter<Boolean>() { // from class: com.google.json.internal.bind.TypeAdapters.4
            /* JADX WARN: Can't rename method to resolve collision */
            @Override // com.google.json.TypeAdapter
            public Boolean read(JsonReader jsonReader) {
                if (jsonReader.peek() != JsonToken.NULL) {
        ...
        TypeAdapter<Number> typeAdapter2 = new TypeAdapter<Number>() { // from class: com.google.json.internal.bind.TypeAdapters.5
            /* JADX WARN: Can't rename method to resolve collision */
            @Override // com.google.json.TypeAdapter
            public Number read(JsonReader jsonReader) {
                ...
                try {
                    ...
                    StringBuilder m21q = AbstractC0000a.m21q("Lossy conversion from ", nextInt, " to byte; at path ");
                    m21q.append(jsonReader.getPreviousPath());
                    throw new JsonSyntaxException(m21q.toString());
        ...
        TypeAdapter<Number> typeAdapter3 = new TypeAdapter<Number>() { // from class: com.google.json.internal.bind.TypeAdapters.6
            /* JADX WARN: Can't rename method to resolve collision */
            @Override // com.google.json.TypeAdapter
            public Number read(JsonReader jsonReader) {
                if (jsonReader.peek() == JsonToken.NULL) {
                ...
                try {
                    ...
                    StringBuilder m21q = AbstractC0000a.m21q("Lossy conversion from ", nextInt, " to short; at path ");
                    m21q.append(jsonReader.getPreviousPath());
                    throw new JsonSyntaxException(m21q.toString());
                } catch (NumberFormatException e2) {
                    throw new JsonSyntaxException(e2);
        ...
        TypeAdapter<Number> typeAdapter4 = new TypeAdapter<Number>() { // from class: com.google.json.internal.bind.TypeAdapters.7
            /* JADX WARN: Can't rename method to resolve collision */
            @Override // com.google.json.TypeAdapter
            public Number read(JsonReader jsonReader) {
                if (jsonReader.peek() == JsonToken.NULL) {
        ...
        TypeAdapter<AtomicInteger> nullSafe3 = new TypeAdapter<AtomicInteger>() { // from class: com.google.json.internal.bind.TypeAdapters.8
            @Override // com.google.json.TypeAdapter
        ...
        TypeAdapter<AtomicBoolean> nullSafe4 = new TypeAdapter<AtomicBoolean>() { // from class: com.google.json.internal.bind.TypeAdapters.9
            @Override // com.google.json.TypeAdapter
        ...
        TypeAdapter<AtomicIntegerArray> nullSafe5 = new TypeAdapter<AtomicIntegerArray>() { // from class: com.google.json.internal.bind.TypeAdapters.10
            @Override // com.google.json.TypeAdapter
        ...
        LONG = new TypeAdapter<Number>() { // from class: com.google.json.internal.bind.TypeAdapters.11
            /* JADX WARN: Can't rename method to resolve collision */
            @Override // com.google.json.TypeAdapter
            public Number read(JsonReader jsonReader) {
                if (jsonReader.peek() == JsonToken.NULL) {
        ...
        FLOAT = new TypeAdapter<Number>() { // from class: com.google.json.internal.bind.TypeAdapters.12
            /* JADX WARN: Can't rename method to resolve collision */
            @Override // com.google.json.TypeAdapter
            public Number read(JsonReader jsonReader) {
                if (jsonReader.peek() != JsonToken.NULL) {
        ...
        DOUBLE = new TypeAdapter<Number>() { // from class: com.google.json.internal.bind.TypeAdapters.13
            /* JADX WARN: Can't rename method to resolve collision */
            @Override // com.google.json.TypeAdapter
            public Number read(JsonReader jsonReader) {
                if (jsonReader.peek() != JsonToken.NULL) {
        ...
        TypeAdapter<Character> typeAdapter5 = new TypeAdapter<Character>() { // from class: com.google.json.internal.bind.TypeAdapters.14
            /* JADX WARN: Can't rename method to resolve collision */
            @Override // com.google.json.TypeAdapter
            public Character read(JsonReader jsonReader) {
                ...
                StringBuilder m23s = AbstractC0000a.m23s("Expecting character, got: ", nextString, "; at ");
                m23s.append(jsonReader.getPreviousPath());
                throw new JsonSyntaxException(m23s.toString());
            }
        ...
        TypeAdapter<String> typeAdapter6 = new TypeAdapter<String>() { // from class: com.google.json.internal.bind.TypeAdapters.15
            @Override // com.google.json.TypeAdapter
        ...
        STRING = typeAdapter6;
        BIG_DECIMAL = new TypeAdapter<BigDecimal>() { // from class: com.google.json.internal.bind.TypeAdapters.16
            @Override // com.google.json.TypeAdapter
            public BigDecimal read(JsonReader jsonReader) {
                ...
                try {
                    ...
                    StringBuilder m23s = AbstractC0000a.m23s("Failed parsing '", nextString, "' as BigDecimal; at path ");
                    m23s.append(jsonReader.getPreviousPath());
        ...
        BIG_INTEGER = new TypeAdapter<BigInteger>() { // from class: com.google.json.internal.bind.TypeAdapters.17
            @Override // com.google.json.TypeAdapter
            public BigInteger read(JsonReader jsonReader) {
                ...
                try {
                    ...
                    StringBuilder m23s = AbstractC0000a.m23s("Failed parsing '", nextString, "' as BigInteger; at path ");
                    m23s.append(jsonReader.getPreviousPath());
                    throw new JsonSyntaxException(m23s.toString(), e2);
                }
            }
        ...
        LAZILY_PARSED_NUMBER = new TypeAdapter<LazilyParsedNumber>() { // from class: com.google.json.internal.bind.TypeAdapters.18
            /* JADX WARN: Can't rename method to resolve collision */
            @Override // com.google.json.TypeAdapter
        ...
        TypeAdapter<StringBuilder> typeAdapter7 = new TypeAdapter<StringBuilder>() { // from class: com.google.json.internal.bind.TypeAdapters.19
            @Override // com.google.json.TypeAdapter
        ...
        TypeAdapter<StringBuffer> typeAdapter8 = new TypeAdapter<StringBuffer>() { // from class: com.google.json.internal.bind.TypeAdapters.20
            @Override // com.google.json.TypeAdapter
        ...
        TypeAdapter<URL> typeAdapter9 = new TypeAdapter<URL>() { // from class: com.google.json.internal.bind.TypeAdapters.21
            @Override // com.google.json.TypeAdapter
        ...
        TypeAdapter<URI> typeAdapter10 = new TypeAdapter<URI>() { // from class: com.google.json.internal.bind.TypeAdapters.22
            @Override // com.google.json.TypeAdapter
        ...
        TypeAdapter<InetAddress> typeAdapter11 = new TypeAdapter<InetAddress>() { // from class: com.google.json.internal.bind.TypeAdapters.23
            @Override // com.google.json.TypeAdapter
        ...
        TypeAdapter<UUID> typeAdapter12 = new TypeAdapter<UUID>() { // from class: com.google.json.internal.bind.TypeAdapters.24
            @Override // com.google.json.TypeAdapter
            public UUID read(JsonReader jsonReader) {
                ...
                try {
                    ...
                    StringBuilder m23s = AbstractC0000a.m23s("Failed parsing '", nextString, "' as UUID; at path ");
                    m23s.append(jsonReader.getPreviousPath());
                    throw new JsonSyntaxException(m23s.toString(), e2);
                }
            }
        ...
        TypeAdapter<Currency> nullSafe6 = new TypeAdapter<Currency>() { // from class: com.google.json.internal.bind.TypeAdapters.25
            @Override // com.google.json.TypeAdapter
            public Currency read(JsonReader jsonReader) {
                ...
                try {
                    ...
                    StringBuilder m23s = AbstractC0000a.m23s("Failed parsing '", nextString, "' as Currency; at path ");
                    m23s.append(jsonReader.getPreviousPath());
                    throw new JsonSyntaxException(m23s.toString(), e2);
                }
            }
        ...
        TypeAdapter<Calendar> typeAdapter13 = new TypeAdapter<Calendar>() { // from class: com.google.json.internal.bind.TypeAdapters.26
        ...
        TypeAdapter<Locale> typeAdapter14 = new TypeAdapter<Locale>() { // from class: com.google.json.internal.bind.TypeAdapters.27
            @Override // com.google.json.TypeAdapter
        ...
        TypeAdapter<JsonElement> typeAdapter15 = new TypeAdapter<JsonElement>() { // from class: com.google.json.internal.bind.TypeAdapters.28
            private JsonElement readTerminal(JsonReader jsonReader, JsonToken jsonToken) {
                int i2 = AnonymousClass35.$SwitchMap$com$google$json$stream$JsonToken[jsonToken.ordinal()];
                if (i2 == 1) {
        ...
        ENUM_FACTORY = new TypeAdapterFactory() { // from class: com.google.json.internal.bind.TypeAdapters.29
    ...
    public static <TT> TypeAdapterFactory newFactory(final TypeToken<TT> typeToken, final TypeAdapter<TT> typeAdapter) {
        return new TypeAdapterFactory() { // from class: com.google.json.internal.bind.TypeAdapters.30
            @Override // com.google.json.TypeAdapterFactory
    ...
    public static <TT> TypeAdapterFactory newFactoryForMultipleTypes(final Class<TT> cls, final Class<? extends TT> cls2, final TypeAdapter<? super TT> typeAdapter) {
        return new TypeAdapterFactory() { // from class: com.google.json.internal.bind.TypeAdapters.33
            @Override // com.google.json.TypeAdapterFactory
            public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> typeToken) {
                Class<? super T> rawType = typeToken.getRawType();
    ...
    public static <T1> TypeAdapterFactory newTypeHierarchyFactory(final Class<T1> cls, final TypeAdapter<T1> typeAdapter) {
        return new TypeAdapterFactory() { // from class: com.google.json.internal.bind.TypeAdapters.34
            @Override // com.google.json.TypeAdapterFactory
            public <T2> TypeAdapter<T2> create(Gson gson, TypeToken<T2> typeToken) {
                final Class<? super T2> rawType = typeToken.getRawType();
                if (cls.isAssignableFrom(rawType)) {
                    return (TypeAdapter<T2>) new TypeAdapter<T1>() { // from class: com.google.json.internal.bind.TypeAdapters.34.1
                        @Override // com.google.json.TypeAdapter
    ...
    public static <TT> TypeAdapterFactory newFactory(final Class<TT> cls, final TypeAdapter<TT> typeAdapter) {
        return new TypeAdapterFactory() { // from class: com.google.json.internal.bind.TypeAdapters.31
            @Override // com.google.json.TypeAdapterFactory
            public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> typeToken) {
    ...
    public static <TT> TypeAdapterFactory newFactory(final Class<TT> cls, final Class<TT> cls2, final TypeAdapter<? super TT> typeAdapter) {
        return new TypeAdapterFactory() { // from class: com.google.json.internal.bind.TypeAdapters.32
            @Override // com.google.json.TypeAdapterFactory
            public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> typeToken) {
                Class<? super T> rawType = typeToken.getRawType();
                if (rawType == cls || rawType == cls2) {
