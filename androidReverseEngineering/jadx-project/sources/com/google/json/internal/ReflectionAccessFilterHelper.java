        ...
        static {
            ...
            if (JavaVersion.isJava9OrLater()) {
                try {
                    ...
                    accessChecker = new AccessChecker() { // from class: com.google.json.internal.ReflectionAccessFilterHelper.AccessChecker.1
                        /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
                        {
                            super();
                        }

                        @Override // com.google.json.internal.ReflectionAccessFilterHelper.AccessChecker
                ...
                if (accessChecker == null) {
                    accessChecker = new AccessChecker() { // from class: com.google.json.internal.ReflectionAccessFilterHelper.AccessChecker.2
                        @Override // com.google.json.internal.ReflectionAccessFilterHelper.AccessChecker
                        public boolean canAccess(AccessibleObject accessibleObject, Object obj) {
                            return true;
                        }
