...
public abstract class UnsafeAllocator {
    ...
    private static UnsafeAllocator create() {
        try {
            ...
            return new UnsafeAllocator() { // from class: com.google.json.internal.UnsafeAllocator.1
                @Override // com.google.json.internal.UnsafeAllocator
            ...
            try {
                try {
                    ...
                    return new UnsafeAllocator() { // from class: com.google.json.internal.UnsafeAllocator.2
                        @Override // com.google.json.internal.UnsafeAllocator
                        public <T> T newInstance(Class<T> cls2) {
                            UnsafeAllocator.assertInstantiable(cls2);
                    ...
                    return new UnsafeAllocator() { // from class: com.google.json.internal.UnsafeAllocator.3
                        @Override // com.google.json.internal.UnsafeAllocator
                        public <T> T newInstance(Class<T> cls2) {
                            UnsafeAllocator.assertInstantiable(cls2);
                ...
                return new UnsafeAllocator() { // from class: com.google.json.internal.UnsafeAllocator.4
                    @Override // com.google.json.internal.UnsafeAllocator
                    public <T> T newInstance(Class<T> cls2) {
