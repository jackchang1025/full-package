...
public class StringStartsWithFilter implements Filter {
    ...
    public StringStartsWithFilter(InterfaceC0911b interfaceC0911b, String str) {
        this.prefix = str;
    ...
    public Boolean filter(UiObject uiObject) {
        ...
        return Boolean.valueOf(m886f != null && m886f.toLowerCase().startsWith(this.prefix.toLowerCase()));
    }
    ...
    public String toString() {
        ...
        return AbstractC0000a.m18n(sb, this.prefix, "\")");
    }
}
