...
public final class b0 implements InterfaceC0863e {
    @Override // p0.InterfaceC0863e
    /* renamed from: b */
    public final void mo389b(p0.e0 e0Var, IOException iOException) {
        AbstractC0026q.m186s("UploadAppIconCallback", iOException);
    ...
    public final void mo390d(p0.e0 e0Var, j0 j0Var) {
        ...
        if (l0Var != null) {
            try {
                ApiResult apiResult = (ApiResult) AbstractC0252h.m699c(l0Var.m1269z(), new TypeToken<ApiResult<Boolean>>() { // from class: com.guard.wallet.http.UploadAppIconCallback$1
                });
                ...
                AbstractC0026q.m186s("UploadAppIconCallback", e2);
            }
        }
        j0Var.close();
    }
