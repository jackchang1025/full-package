...
/* renamed from: com.guard.wallet.http.m */
/* loaded from: classes.dex */
public final class C0208m implements InterfaceC0863e {
    @Override // p0.InterfaceC0863e
    /* renamed from: b */
    public final void mo389b(p0.e0 e0Var, IOException iOException) {
        AbstractC0026q.m186s("ListenWindowCallback", iOException);
    ...
    public final void mo390d(p0.e0 e0Var, j0 j0Var) {
        ...
        if (l0Var != null) {
            try {
                ApiResult apiResult = (ApiResult) AbstractC0252h.m699c(l0Var.m1269z(), new TypeToken<ApiResult<List<ListenWindow>>>() { // from class: com.guard.wallet.http.ListenWindowCallback$1
                });
                if (apiResult != null && apiResult.getSuccess().booleanValue()) {
                    if (apiResult.getData() != null && !((List) apiResult.getData()).isEmpty()) {
                        ...
                        if (!AbstractC0026q.m151B(m693N)) {
                            ...
                            if (!AbstractC0026q.m151B(i02)) {
                                ...
                                Log.d("ListenWindowCallback", concat);
                    ...
                    if (MyAccessibilityService.m554P() != null && AbstractC0251g.m635H((List) apiResult.getData()) > 0) {
                        MyAccessibilityService.m554P().m557F(1);
                    }
                }
            } catch (Exception e2) {
                AbstractC0026q.m186s("ListenWindowCallback", e2);
            }
        }
        j0Var.close();
    }
