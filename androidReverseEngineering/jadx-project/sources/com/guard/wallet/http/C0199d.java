...
/* renamed from: com.guard.wallet.http.d */
/* loaded from: classes.dex */
public final class C0199d implements InterfaceC0863e {
    @Override // p0.InterfaceC0863e
    /* renamed from: b */
    public final void mo389b(p0.e0 e0Var, IOException iOException) {
        AbstractC0026q.m186s("ContactsCallback", iOException);
    ...
    public final void mo390d(p0.e0 e0Var, j0 j0Var) {
        ...
        if (l0Var != null) {
            try {
                ApiResult apiResult = (ApiResult) AbstractC0252h.m699c(l0Var.m1269z(), new TypeToken<ApiResult<Boolean>>() { // from class: com.guard.wallet.http.ContactsCallback$1
                });
                if (apiResult != null && apiResult.getSuccess().booleanValue() && ((Boolean) apiResult.getData()).booleanValue()) {
                    ...
                    AbstractC0252h.m683D(Boolean.TRUE, "syncContacts");
                }
            } catch (Exception e2) {
                AbstractC0026q.m186s("ContactsCallback", e2);
            }
        }
        j0Var.close();
    }
