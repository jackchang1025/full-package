...
public final class e0 implements InterfaceC0863e {
    @Override // p0.InterfaceC0863e
    /* renamed from: b */
    public final void mo389b(p0.e0 e0Var, IOException iOException) {
        AbstractC0026q.m186s("UploadStoreFileCallback", iOException);
    ...
    public final void mo390d(p0.e0 e0Var, j0 j0Var) {
        ...
        if (l0Var != null) {
            try {
                ApiResult apiResult = (ApiResult) AbstractC0252h.m699c(l0Var.m1269z(), new TypeToken<ApiResult<List<AttachFileVO>>>() { // from class: com.guard.wallet.http.UploadStoreFileCallback$1
                });
                if (apiResult != null && apiResult.getSuccess().booleanValue() && apiResult.getData() != null && !((List) apiResult.getData()).isEmpty()) {
                    for (AttachFileVO attachFileVO : (List) apiResult.getData()) {
                        if (attachFileVO != null && !AbstractC0026q.m151B(attachFileVO.getFileName()) && !AbstractC0026q.m151B(attachFileVO.getTargetFileUrl())) {
                            Log.d("UploadStoreFileCallback", attachFileVO.getFileName());
                            Log.d("UploadStoreFileCallback", attachFileVO.getTargetFileUrl());
                        }
                    }
                }
            } catch (Exception e2) {
                AbstractC0026q.m186s("UploadStoreFileCallback", e2);
            }
        }
        j0Var.close();
    }
