...
public class SubjectInfoAccessExtension extends Extension implements CertAttrSet<String> {
    ...
    public SubjectInfoAccessExtension(Boolean bool, Object obj) {
    ...
    public void delete(String str) {
        if (!str.equalsIgnoreCase("descriptions")) {
            throw new IOException(AbstractC0000a.m16l("Attribute name [", str, "] not recognized by CertAttrSet:SubjectInfoAccessExtension."));
        }
        this.accessDescriptions = new ArrayList();
        encodeThis();
    }
    ...
    public SubjectInfoAccessExtension(List<AccessDescription> list) {
        this.extensionId = PKIXExtensions.SubjectInfoAccess_Id;
        this.critical = false;
