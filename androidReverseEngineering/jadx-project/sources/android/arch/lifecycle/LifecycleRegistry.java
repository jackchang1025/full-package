...
public class LifecycleRegistry extends Lifecycle {
    ...
    public static /* synthetic */ class C00351 {
    ...
    private static Lifecycle.Event downEvent(Lifecycle.State state) {
        int i2 = C00351.$SwitchMap$android$arch$lifecycle$Lifecycle$State[state.ordinal()];
        if (i2 == 1) {
    ...
    public static Lifecycle.State getStateAfter(Lifecycle.Event event) {
        switch (C00351.$SwitchMap$android$arch$lifecycle$Lifecycle$Event[event.ordinal()]) {
            case 1:
            case 2:
