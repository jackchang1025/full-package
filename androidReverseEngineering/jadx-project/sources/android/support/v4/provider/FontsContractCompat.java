...
public class FontsContractCompat {
    ...
    @RestrictTo({RestrictTo.Scope.LIBRARY_GROUP})
    public static Typeface getFontSync(final Context context, final FontRequest fontRequest, @Nullable final ResourcesCompat.FontCallback fontCallback, @Nullable final Handler handler, boolean z2, int i2, final int i3) {
        ...
        SelfDestructiveThread.ReplyCallback<TypefaceResult> replyCallback = fontCallback == null ? null : new SelfDestructiveThread.ReplyCallback<TypefaceResult>() { // from class: android.support.v4.provider.FontsContractCompat.2
            ...
            public void onReply(TypefaceResult typefaceResult) {
                ...
                fontCallback2.callbackFailAsync(i5, handler);
            }
        };
        synchronized (sLock) {
    ...
    public static ProviderInfo getProvider(@NonNull PackageManager packageManager, @NonNull FontRequest fontRequest, @Nullable Resources resources) {
        ...
        if (resolveContentProvider == null) {
            throw new PackageManager.NameNotFoundException(AbstractC0000a.m15k("No package found for authority: ", providerAuthority));
        }
        if (!resolveContentProvider.packageName.equals(fontRequest.getProviderPackage())) {
            StringBuilder m23s = AbstractC0000a.m23s("Found content provider ", providerAuthority, ", but package was not ");
            m23s.append(fontRequest.getProviderPackage());
            throw new PackageManager.NameNotFoundException(m23s.toString());
        }
