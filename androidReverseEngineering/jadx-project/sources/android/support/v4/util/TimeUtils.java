...
public final class TimeUtils {
    ...
    private static int formatDurationLocked(long j2, int i2) {
        ...
        if (i2 != 0) {
            ...
            i7 = 0;
            for (int accumField5 = accumField(i9, 2, true, accumField4 > 0 ? 3 : 0) + 1 + accumField4; accumField5 < i2; accumField5++) {
                cArr[i7] = ' ';
                i7++;
            }
        } else {
        ...
        int printField2 = printField(cArr, i4, 'h', printField, printField != i11, z2 ? 2 : 0);
        int printField3 = printField(cArr, i6, 'm', printField2, printField2 != i11, z2 ? 2 : 0);
        int printField4 = printField(cArr, i5, 's', printField3, printField3 != i11, z2 ? 2 : 0);
        int printField5 = printField(cArr, i9, 'm', printField4, true, (!z2 || printField4 == i11) ? 0 : 3);
        cArr[printField5] = 's';
