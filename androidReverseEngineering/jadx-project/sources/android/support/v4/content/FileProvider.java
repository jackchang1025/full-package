...
public class FileProvider extends ContentProvider {
    ...
    public static class SimplePathStrategy implements PathStrategy {
        ...
        public Uri getUriForFile(File file) {
            try {
                ...
                if (entry == null) {
                    throw new IllegalArgumentException(AbstractC0000a.m15k("Failed to find configured root that contains ", canonicalPath));
                }
    ...
    private static int modeToMode(String str) {
        ...
        throw new IllegalArgumentException(AbstractC0000a.m15k("Invalid mode: ", str));
    }
