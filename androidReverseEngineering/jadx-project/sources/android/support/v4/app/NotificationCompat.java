...
public class NotificationCompat {
    ...
    public static class Action {
        ...
        public static final class WearableExtender implements Extender {
            ...
            public WearableExtender m1478clone() {
        ...
        public Action(int i2, CharSequence charSequence, PendingIntent pendingIntent, Bundle bundle, RemoteInput[] remoteInputArr, RemoteInput[] remoteInputArr2, boolean z2, int i3, boolean z3) {
            this.mShowsUserInterface = true;
            this.icon = i2;
    ...
    public static class Builder {
        ...
        private Bitmap reduceLargeIconSize(Bitmap bitmap) {
            ...
            int dimensionPixelSize = resources.getDimensionPixelSize(C0041R.dimen.compat_notification_large_icon_max_width);
            int dimensionPixelSize2 = resources.getDimensionPixelSize(C0041R.dimen.compat_notification_large_icon_max_height);
    ...
    public static class DecoratedCustomViewStyle extends Style {
        ...
        private RemoteViews createRemoteViews(RemoteViews remoteViews, boolean z2) {
            ...
            int min;
            boolean z3 = true;
            RemoteViews applyStandardTemplate = applyStandardTemplate(true, C0041R.layout.notification_template_custom_big, false);
            applyStandardTemplate.removeAllViews(C0041R.id.actions);
            if (!z2 || (arrayList = this.mBuilder.mActions) == null || (min = Math.min(arrayList.size(), 3)) <= 0) {
                z3 = false;
            } else {
                for (int i2 = 0; i2 < min; i2++) {
                    applyStandardTemplate.addView(C0041R.id.actions, generateActionButton(this.mBuilder.mActions.get(i2)));
                }
            }
            int i3 = z3 ? 0 : 8;
            applyStandardTemplate.setViewVisibility(C0041R.id.actions, i3);
            applyStandardTemplate.setViewVisibility(C0041R.id.action_divider, i3);
        ...
        private RemoteViews generateActionButton(Action action) {
            ...
            RemoteViews remoteViews = new RemoteViews(this.mBuilder.mContext.getPackageName(), z2 ? C0041R.layout.notification_action_tombstone : C0041R.layout.notification_action);
            remoteViews.setImageViewBitmap(C0041R.id.action_image, createColoredBitmap(action.getIcon(), this.mBuilder.mContext.getResources().getColor(C0041R.color.notification_action_color_filter)));
            remoteViews.setTextViewText(C0041R.id.action_text, action.title);
            if (!z2) {
                remoteViews.setOnClickPendingIntent(C0041R.id.action_container, action.actionIntent);
            }
            remoteViews.setContentDescription(C0041R.id.action_container, action.title);
            return remoteViews;
        }
    ...
    public static class MessagingStyle extends Style {
        ...
        public void apply(NotificationBuilderWithBuilderAccessor notificationBuilderWithBuilderAccessor) {
            ...
            if (i2 >= 28) {
                AbstractC0000a.m0A();
                messagingStyle = AbstractC0049a.m210f(this.mUser.toAndroidPerson());
            } else {
            ...
            for (Message message2 : this.mMessages) {
                if (Build.VERSION.SDK_INT >= 28) {
                    ...
                    AbstractC0000a.m1B();
                    message = AbstractC0049a.m209e(message2.getText(), message2.getTimestamp(), person != null ? person.toAndroidPerson() : null);
                } else {
    ...
    public static abstract class Style {
        ...
        private int calculateTopPadding() {
            ...
            int dimensionPixelSize = resources.getDimensionPixelSize(C0041R.dimen.notification_top_pad);
            int dimensionPixelSize2 = resources.getDimensionPixelSize(C0041R.dimen.notification_top_pad_large_text);
        ...
        private Bitmap createIconWithBackground(int i2, int i3, int i4, int i5) {
            int i6 = C0041R.drawable.notification_icon_background;
            if (i5 == 0) {
                i5 = 0;
            }
        ...
        private void hideNormalContent(RemoteViews remoteViews) {
            remoteViews.setViewVisibility(C0041R.id.title, 8);
            remoteViews.setViewVisibility(C0041R.id.text2, 8);
            remoteViews.setViewVisibility(C0041R.id.text, 8);
        }
        ...
        */
        public RemoteViews applyStandardTemplate(boolean z2, int i2, boolean z3) {
            ...
            if (builder.mLargeIcon != null) {
                remoteViews.setViewVisibility(C0041R.id.icon, 0);
                remoteViews.setImageViewBitmap(C0041R.id.icon, this.mBuilder.mLargeIcon);
                if (z2 && this.mBuilder.mNotification.icon != 0) {
                    int dimensionPixelSize = resources.getDimensionPixelSize(C0041R.dimen.notification_right_icon_size);
                    int dimensionPixelSize2 = dimensionPixelSize - (resources.getDimensionPixelSize(C0041R.dimen.notification_small_icon_background_padding) * 2);
                    Builder builder2 = this.mBuilder;
                    remoteViews.setImageViewBitmap(C0041R.id.right_icon, createIconWithBackground(builder2.mNotification.icon, dimensionPixelSize, dimensionPixelSize2, builder2.getColor()));
                    remoteViews.setViewVisibility(C0041R.id.right_icon, 0);
                }
            } else if (z2 && builder.mNotification.icon != 0) {
                remoteViews.setViewVisibility(C0041R.id.icon, 0);
                int dimensionPixelSize3 = resources.getDimensionPixelSize(C0041R.dimen.notification_large_icon_width) - resources.getDimensionPixelSize(C0041R.dimen.notification_big_circle_margin);
                int dimensionPixelSize4 = resources.getDimensionPixelSize(C0041R.dimen.notification_small_icon_size_as_large);
                Builder builder3 = this.mBuilder;
                remoteViews.setImageViewBitmap(C0041R.id.icon, createIconWithBackground(builder3.mNotification.icon, dimensionPixelSize3, dimensionPixelSize4, builder3.getColor()));
            }
            CharSequence charSequence2 = this.mBuilder.mContentTitle;
            if (charSequence2 != null) {
                remoteViews.setTextViewText(C0041R.id.title, charSequence2);
            }
            CharSequence charSequence3 = this.mBuilder.mContentText;
            boolean z7 = true;
            if (charSequence3 != null) {
                remoteViews.setTextViewText(C0041R.id.text, charSequence3);
                z4 = true;
            } else {
                z4 = false;
            }
            ...
            if (charSequence4 != null) {
                remoteViews.setTextViewText(C0041R.id.info, charSequence4);
            } else {
                if (builder4.mNumber <= 0) {
                    remoteViews.setViewVisibility(C0041R.id.info, 8);
                    z5 = false;
                    charSequence = this.mBuilder.mSubText;
                    if (charSequence != null) {
                        remoteViews.setTextViewText(C0041R.id.text, charSequence);
                        CharSequence charSequence5 = this.mBuilder.mContentText;
                        if (charSequence5 != null) {
                            remoteViews.setTextViewText(C0041R.id.text2, charSequence5);
                            remoteViews.setViewVisibility(C0041R.id.text2, 0);
                            z6 = true;
                            if (z6) {
                                if (z3) {
                                    remoteViews.setTextViewTextSize(C0041R.id.text, 0, resources.getDimensionPixelSize(C0041R.dimen.notification_subtext_size));
                                }
                                remoteViews.setViewPadding(C0041R.id.line1, 0, 0, 0, 0);
                            }
                            if (this.mBuilder.getWhenIfShowing() == 0) {
                                z7 = z5;
                            } else if (this.mBuilder.mUseChronometer) {
                                remoteViews.setViewVisibility(C0041R.id.chronometer, 0);
                                remoteViews.setLong(C0041R.id.chronometer, "setBase", (SystemClock.elapsedRealtime() - System.currentTimeMillis()) + this.mBuilder.getWhenIfShowing());
                                remoteViews.setBoolean(C0041R.id.chronometer, "setStarted", true);
                            } else {
                                remoteViews.setViewVisibility(C0041R.id.time, 0);
                                remoteViews.setLong(C0041R.id.time, "setTime", this.mBuilder.getWhenIfShowing());
                            }
                            remoteViews.setViewVisibility(C0041R.id.right_side, z7 ? 0 : 8);
                            remoteViews.setViewVisibility(C0041R.id.line3, z4 ? 0 : 8);
                            return remoteViews;
                        }
                        remoteViews.setViewVisibility(C0041R.id.text2, 8);
                    }
                ...
                if (this.mBuilder.mNumber > resources.getInteger(C0041R.integer.status_bar_notification_info_maxnum)) {
                    remoteViews.setTextViewText(C0041R.id.info, resources.getString(C0041R.string.status_bar_notification_info_overflow));
                } else {
                    remoteViews.setTextViewText(C0041R.id.info, NumberFormat.getIntegerInstance().format(this.mBuilder.mNumber));
                }
            }
            remoteViews.setViewVisibility(C0041R.id.info, 0);
            z4 = true;
            z5 = true;
            charSequence = this.mBuilder.mSubText;
            if (charSequence != null) {
        ...
        public void buildIntoRemoteViews(RemoteViews remoteViews, RemoteViews remoteViews2) {
            ...
            remoteViews.removeAllViews(C0041R.id.notification_main_column);
            remoteViews.addView(C0041R.id.notification_main_column, remoteViews2.clone());
            remoteViews.setViewVisibility(C0041R.id.notification_main_column, 0);
            remoteViews.setViewPadding(C0041R.id.notification_main_column_container, 0, calculateTopPadding(), 0, 0);
        }
    ...
    public static final class WearableExtender implements Extender {
        ...
        /* renamed from: clone, reason: merged with bridge method [inline-methods] */
        public WearableExtender m1479clone() {
            WearableExtender wearableExtender = new WearableExtender();
    ...
    public static Action getActionCompatFromAction(Notification.Action action) {
        ...
        return new Action(action.icon, action.title, action.actionIntent, action.getExtras(), remoteInputArr, null, action.getExtras().getBoolean("android.support.allowGeneratedReplies") || action.getAllowGeneratedReplies(), i3 >= 28 ? action.getSemanticAction() : action.getExtras().getInt("android.support.action.semanticAction", 0), action.getExtras().getBoolean("android.support.action.showsUserInterface", true));
    }
