...
public final class ShareCompat {
    ...
    public static void configureMenuItem(Menu menu, int i2, IntentBuilder intentBuilder) {
        ...
        if (findItem == null) {
            throw new IllegalArgumentException(AbstractC0000a.m12h("Could not find menu item with id ", i2, " in the supplied menu"));
        }
    ...
    public static void configureMenuItem(MenuItem menuItem, IntentBuilder intentBuilder) {
        ...
        shareActionProvider.setShareHistoryFileName(HISTORY_FILENAME_PREFIX.concat(intentBuilder.getActivity().getClass().getName()));
